...
grails {
    plugins {
        taglib {
            include = ['org.codehaus.groovy.grails.plugins.web.taglib.FormTagLib']
        }
    }
}
...
openboxes.logo.url = "/openboxestest/images/logo/openboxes_logo_40x40.jpg"
...
openboxes.anonymize.enabled = true
...
openboxes.locale.supportedLocales = ['ar','ach','de','en','es','fr', 'ht', 'it','pt','fi','zh']
