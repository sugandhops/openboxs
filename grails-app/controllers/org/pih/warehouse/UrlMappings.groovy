...
class UrlMappings {
    static mappings = {
        ...
        "/createShipmentWorkflow/createShipment"(controller: 'shipment', action: 'create', type: 'INCOMING')
        "/shipper/list"(controller: 'shipper', action: 'list')
        ...
        "/api/dashboard/defaultBin/$location"(parseRequest: true) {
            controller = { "dashboardApi" }
        ...
        */
        ...
        // "/role/show/$id"(parseRequest: false) {
        //     controller = "role"
        //     action = [GET: "show"]
        // }
