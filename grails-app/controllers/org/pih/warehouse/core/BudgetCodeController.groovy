...
class BudgetCodeController {
    ...
    def save() {
        ...
        if (budgetCode.save(flush: true)) {
            flash.message = "${g.message(code: 'default.created.message', args: [g.message(code: 'budgetCode.label', default: 'Budget Code'), budgetCode.id])}"
    ...
    def update() {
        ...
        if (budgetCode) {
            ...
            if (!budgetCode.hasErrors() && budgetCode.save(flush: true)) {
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'budgetCode.label', default: 'Budget Code'), budgetCode.id])}"
            ...
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'budgetCode.label', default: 'Budget Code'), params.id])}"
            redirect(action: "list")
        }
    }
    ...
    def delete() {
        ...
        if (budgetCode) {
            try {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'budgetCode.label', default: 'Budget Code'), params.id])}"
                redirect(action: "list")
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'budgetCode.label', default: 'Budget Code'), params.id])}"
                redirect(action: "list", id: params.id)
            }
        } else {
            flash.message = "${g.message(code: 'default.not.found.message', args: [warehouse.message(code: 'budgetCode.label', default: 'Budget Code'), params.id])}"
            redirect(action: "list")
        }
    }
}
