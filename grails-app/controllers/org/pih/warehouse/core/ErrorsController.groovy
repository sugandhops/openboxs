...
class ErrorsController {
    ...
    def processError() {
        ...
        if (enabled) {
            ...
            def subject = "${params.summary ?: g.message(code: 'email.errorReportSubject.message')}"
            ...
            flash.message = "${g.message(code: 'email.errorReportSuccess.message', args: [recipients])}"
        } else {
            flash.message = "${g.message(code: 'email.errorReportDisabled.message')}"
        }
