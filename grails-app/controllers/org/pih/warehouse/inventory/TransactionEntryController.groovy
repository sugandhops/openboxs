...
class TransactionEntryController {
    ...
    def delete() {
        ...
        if (!transactionEntryInstance) {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'transactionEntry.label'), params.id])}"
        } else {
            flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'transactionEntry.label'), params.id])}"
