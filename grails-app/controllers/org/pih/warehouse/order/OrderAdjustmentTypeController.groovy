...
class OrderAdjustmentTypeController {
    ...
    def save() {
        ...
        if (orderAdjustmentType.save(flush: true)) {
            flash.message = "${g.message(code: 'default.created.message', args: [g.message(code: 'orderAdjustmentType.label', default: 'Order Adjustment Type'), orderAdjustmentType.id])}"
    ...
    def update() {
        ...
        if (orderAdjustmentType) {
            ...
            if (!orderAdjustmentType.hasErrors() && orderAdjustmentType.save(flush: true)) {
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'orderAdjustmentType.label', default: 'Order Adjustment Type'), orderAdjustmentType.id])}"
            ...
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'orderAdjustmentType.label', default: 'Order Adjustment Type'), params.id])}"
            redirect(action: "list")
        }
    }
    ...
    def delete() {
        ...
        if (orderAdjustmentType) {
            try {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'orderAdjustmentType.label', default: 'Order Adjustment Type'), params.id])}"
                redirect(action: "list")
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'orderAdjustmentType.label', default: 'Order Adjustment Type'), params.id])}"
