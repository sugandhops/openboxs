...
class AttributeController {
    ...
    def show() {
        ...
        if (!attributeInstance) {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'attribute.label', default: 'Attribute'), params.id])}"
    ...
    def save() {
        ...
        if (params.version) {
            ...
            if (attributeInstance.version > version) {
                attributeInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [g.message(code: 'attribute.label', default: 'Attribute')] as Object[], "Another user has updated this Attribute while you were editing")
                render(view: "edit", model: [attributeInstance: attributeInstance])
                return
            }
        }
        ...
        if (!attributeInstance.hasErrors() && attributeInstance.save(flush:true)) {
            flash.message = "${g.message(code: 'default.saved.message', args: [g.message(code: 'attribute.label', default: 'Attribute'), attributeInstance.id])}"
    ...
    def delete() {
        ...
        if (attributeInstance) {
            try {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'attribute.label', default: 'Attribute'), params.id])}"
                redirect(action: "list")
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'attribute.label', default: 'Attribute'), params.id])}"
