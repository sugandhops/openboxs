...
class ProductCatalogController {
    ...
    def save() {
        ...
        if (productCatalogInstance.save(flush: true)) {
            flash.message = "${g.message(code: 'default.created.message', args: [g.message(code: 'productCatalog.label', default: 'ProductCatalog'), productCatalogInstance.id])}"
    ...
    def show() {
        ...
        if (!productCatalogInstance) {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'productCatalog.label', default: 'ProductCatalog'), params.id])}"
        ...
        if (productCatalogInstance) {
            if (params.version) {
                ...
                if (productCatalogInstance.version > version) {
                    ...
                    productCatalogInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [g.message(code: 'productCatalog.label', default: 'ProductCatalog')] as Object[], "Another user has updated this ProductCatalog while you were editing")
            ...
            if (!productCatalogInstance.hasErrors() && productCatalogInstance.save(flush: true)) {
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'productCatalog.label', default: 'ProductCatalog'), productCatalogInstance.id])}"
    ...
    def delete() {
        ...
        if (productCatalogInstance) {
            try {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'productCatalog.label', default: 'ProductCatalog'), params.id])}"
                redirect(action: "list")
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'productCatalog.label', default: 'ProductCatalog'), params.id])}"
    ...
    def addProductCatalogItem(ProductCatalogCommand command) {
        ...
        flash.message = "${g.message(code: 'default.added.message', args: [g.message(code: 'productCatalogItem.label', default: 'Product Catalog Item'), params.id])}"
    ...
    def removeProductCatalogItem() {
        ...
        if (productCatalogItem) {
            try {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'productCatalogItem.label', default: 'Product Catalog Item'), params.id])}"
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'productCatalogItem.label', default: 'Product Catalog Item'), params.id])}"
            }
        } else {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'productCatalogItem.label', default: 'Product Catalog Item'), params.id])}"
        }
    ...
    def importProductCatalog(ImportDataCommand command) {
        ...
        if (request.method == "POST") {
            ...
            if (uploadFile && !uploadFile?.empty) {
                ...
                String errorMessage = "${g.message(code: 'import.emptyFile.message', default: 'File is empty')}"
