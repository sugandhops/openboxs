...
class ProductGroupController {
    ...
    def save() {
        ...
        try {
            ...
            flash.message = "${g.message(code: 'default.created.message', args: [g.message(code: 'productGroup.label', default: 'ProductGroup'), productGroupInstance.id])}"
    ...
    def show() {
        ProductGroup productGroupInstance = productGroupDataService.get(params.id)
        if (!productGroupInstance) {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'productGroup.label', default: 'ProductGroup'), params.id])}"
        ...
        if (productGroupInstance) {
            if (params.version) {
                ...
                if (productGroupInstance.version > version) {
                    ...
                    productGroupInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [g.message(code: 'productGroup.label', default: 'ProductGroup')] as Object[], "Another user has updated this ProductGroup while you were editing")
            ...
            if (!productGroupInstance.hasErrors() && productGroupDataService.save(productGroupInstance)) {
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'productGroup.label', default: 'ProductGroup'), productGroupInstance.id])}"
                redirect(action: "edit", id: productGroupInstance.id)
            } else {
                render(view: "edit", model: [productGroupInstance: productGroupInstance])
            }
    ...
    def delete() {
        ...
        if (productGroupInstance) {
            try {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'productGroup.label', default: 'ProductGroup'), params.id])}"
                redirect(action: "list")
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'productGroup.label', default: 'ProductGroup'), params.id])}"
