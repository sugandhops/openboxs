...
class ProductSupplierController {
    ...
    def save() {
        ...
        if (productSupplierGormService.save(productSupplierInstance)) {
            flash.message = "${g.message(code: 'default.created.message', args: [g.message(code: 'productSupplier.label', default: 'ProductSupplier'), productSupplierInstance.id])}"
    ...
    def show() {
        ...
        if (!productSupplierInstance) {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'productSupplier.label', default: 'ProductSupplier'), params.id])}"
        ...
        if (productSupplierInstance) {
            if (params.version) {
                ...
                if (productSupplierInstance.version > version) {
                    ...
                    productSupplierInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [g.message(code: 'productSupplier.label', default: 'ProductSupplier')] as Object[], "Another user has updated this ProductSupplier while you were editing")
                    render(view: "edit", model: [productSupplierInstance: productSupplierInstance])
                    return
                }
            }
            ...
            if (productSupplierGormService.save(productSupplierInstance)) {
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'productSupplier.label', default: 'ProductSupplier'), productSupplierInstance.id])}"
    ...
    def delete() {
        ...
        if (productSupplierInstance) {
            ...
            try {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'productSupplier.label', default: 'ProductSupplier'), params.id])}"
            }
            catch (Exception e) {
                log.error("Unable to delete product supplier: " + e.message, e)
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'productSupplier.label', default: 'ProductSupplier'), params.id])}"
            }
        ...
        switch(params.format) {
            case "xls":
                ...
                response.setHeader 'Content-disposition',
                        "attachment; filename=\"ProductSuppliers-${formattedDate
}.xls\""
