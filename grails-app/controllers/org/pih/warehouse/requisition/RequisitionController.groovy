...
class RequisitionController {
    ...
    def review() {
        ...
        if (!requisition) {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'request.label', default: 'Request'), params.id])}"
            redirect(action: "list")
        } else {
    ...
    def pick() {
        ...
        if (requisition) {
            ...
            if (!requisition.verifiedBy) {
                flash.message = "${g.message(code: 'requisition.verifiedBy.invalid.message')}"
    ...
    def cancel() {
        ...
        if (requisition) {
            ...
            flash.message = "${g.message(code: 'default.cancelled.message', args: [g.message(code: 'requisition.label', default: 'Requisition'), params.id])}"
        }
        redirect(action: "list")
    }
    ...
    def rollback() {
        ...
        if (requisition) {
            ...
            flash.message = "${g.message(code: 'default.rollback.message', args: [g.message(code: 'requisition.label', default: 'Requisition'), params.id])}"
    ...
    def undoCancel() {
        ...
        if (requisition) {
            ...
            flash.message = "${g.message(code: 'default.undone.message', args: [g.message(code: 'requisition.label', default: 'Requisition'), params.id])}"
        }
        redirect(action: "list")
    }
    ...
    def delete() {
        ...
        if (requisition) {
            try {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'requisition.label', default: 'Requisition'), params.id])}"
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'requisition.label', default: 'Requisition'), params.id])}"
            }
        } else {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'requisition.label', default: 'Requisition'), params.id])}"
        }
    ...
    def cancelQuantity() {
        ...
        if (requisitionItem) {
            ...
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'requisitionItem.label', default: 'RequisitionItem'), params.id])}"
     ...
     *  Allow user to approve the given requisition item.
     ...
     redirect(controller: "requisition", action: redirectAction, id: requisitionItem?.requisition?.id, params: ['requisitionItem.id':requisitionItem.id])}else {flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'requisitionItem.label', default: 'RequisitionItem'), params.id])}"
     redirect(controller: "requisition", action: "list")}}*/
    /**
     * Allow user to undo changes made during the review process.
     ...
     id: requisitionItem?.requisition?.id, params: ['requisitionItem.id':requisitionItem.id])}else {flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'requisitionItem.label', default: 'RequisitionItem'), params.id])}"
     redirect(controller: "requisition", action: "list")}}*/
    ...
    private def getName(requisition) {
        def commodityClass = (requisition.commodityClass) ? "${g.message(code: 'enum.CommodityClass.' + requisition.commodityClass)}" : null
        def requisitionType = (requisition.type) ? "${g.message(code: 'enum.RequisitionType.' + requisition.type)}" : null
        def requisitionName =
                [
                        requisitionType,
