...
class RequisitionItemController {
    ...
    def save() {
        ...
        if (requisitionItemInstance.save(flush: true)) {
            flash.message = "${g.message(code: 'default.created.message', args: [g.message(code: 'requisitionItem.label', default: 'RequisitionItem'), requisitionItemInstance.id])}"
        ...
        if (requisitionItemInstance) {
            if (params.version) {
                ...
                if (requisitionItemInstance.version > version) {
                    ...
                    requisitionItemInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [g.message(code: 'requisitionItem.label', default: 'RequisitionItem')] as Object[], "Another user has updated this RequisitionItem while you were editing")
            ...
            if (!requisitionItemInstance.hasErrors() && requisitionItemInstance.save(flush: true)) {
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'requisitionItem.label', default: 'RequisitionItem'), requisitionItemInstance.id])}"
    ...
    def delete() {
        ...
        if (requisitionItemInstance) {
            try {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'requisitionItem.label', default: 'RequisitionItem'), params.id])}"
                redirect(controller: "requisition", action: "review", id: requisition?.id)
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'requisitionItem.label', default: 'RequisitionItem'), params.id])}"
