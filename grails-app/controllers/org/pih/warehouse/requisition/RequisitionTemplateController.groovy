...
class RequisitionTemplateController {
    ...
    def sendMail() {
        ...
        if (!requisition) {
            ...
            flash.error = "${g.message(code: 'stockList.noManagerAssociated.label')}"
    ...
    def publish() {
        ...
        if (requisition) {
            ...
            if (!requisition.hasErrors() && requisition.save(flush: true)) {
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'requisition.label', default: 'Requisition'), params.id])}"
            ...
            if (params.version) {
                ...
                if (requisition.version > version) {
                    requisition.errors.rejectValue("version", "default.optimistic.locking.failure", [
                            g.message(code: 'requisition.label', default: 'Requisition')] as Object[],
    ...
    def clear() {
        ...
        if (requisition) {
            try {
                ...
                flash.message = "${g.message(code: 'default.cleared.message', default: '{0} cleared', args: [g.message(code: 'requisition.label', default: 'Requisition'), params.id])}"
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'requisition.label', default: 'Requisition'), params.id])}"
            }
    ...
    def clone() {
        ...
        if (requisition) {
            try {
                ...
                flash.message = "${g.message(code: 'default.cloned.message', default: '{0} cloned', args: [g.message(code: 'requisition.label', default: 'Requisition'), params.id])}"
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'requisition.label', default: 'Requisition'), params.id])}"
            }
