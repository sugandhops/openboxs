...
class ShipmentController {
    ...
    def save() {
        ...
        if (shipmentInstance.save(flush: true)) {
            ...
            flash.message = "${g.message(code: 'default.created.message', args: [g.message(code: 'shipment.label', default: 'Shipment'), shipmentInstance.id])}"
        ...
        if (shipmentInstance) {
            if (params.version) {
                ...
                if (shipmentInstance.version > version) {
                    shipmentInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [g.message(code: 'shipment.label', default: 'Shipment')] as Object[], "Another user has updated this Shipment while you were editing")
            ...
            if (!shipmentInstance.hasErrors() && shipmentInstance.save(flush: true)) {
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'shipment.label', default: 'Shipment'), shipmentInstance.id])}"
                redirect(action: "showDetails", id: shipmentInstance.id)
            } else {
                render(view: "editDetails", model: [shipmentInstance: shipmentInstance])
            }
        } else {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'shipment.label', default: 'Shipment'), params.id])}"
        ...
        if (!shipmentInstance) {
            ...
            if ("POST".equalsIgnoreCase(request.getMethod())) {
                ...
                if (!params.actualShippingDate || Date.parse("MM/dd/yyyy HH:mm XXX", params.actualShippingDate) > new Date()) {
                    flash.message = "${g.message(code: 'shipping.specifyValidShipmentDate.message')}"
    ...
    def deleteShipment() {
        ...
        if (!shipmentInstance) {
            ...
            if ("POST".equalsIgnoreCase(request.getMethod())) {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'shipment.label', default: 'Shipment'), shipmentInstance.id])}"
                redirect(controller: "dashboard", action: "index")
                return
            }
        }
    ...
    def splitReceiptItem() {
        ...
        flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'shipment.label', default: 'Shipment'), shipment.id])}"
    ...
    def deleteReceiptItem() {
        ...
        if (receiptItem) {
            ...
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'receiptItem.label', default: 'Receipt Item'), params.id])}"
        }
            ...
            if (params.saveButton == 'receiveShipment') {
                ...
                try {
                    ...
                    if (!shipmentInstance.hasErrors()) {
                        ...
                        flash.message = "${g.message(code: 'default.received.message', args: [g.message(code: 'shipment.label', default: 'Shipment'), shipmentInstance.shipmentNumber ?: shipmentInstance?.id])}"
                        redirect(action: "showDetails", id: shipmentInstance?.id)
                        return
                    }
                ...
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'shipment.label', default: 'Shipment'), shipmentInstance.shipmentNumber ?: shipmentInstance?.id])}"
    ...
    def editContainer() {
        ...
        if (containerInstance) {
            ...
            if (!containerInstance.hasErrors() && containerInstance.save(flush: true)) {
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'container.label', default: 'Container'), containerInstance.id])}"
                redirect(action: "editContents", id: shipmentInstance.id, params: ["container.id": params.containerId])
            } else {
                flash.message = "${g.message(code: 'shipping.couldNotEditContainer.message')}"
            ...
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'container.label', default: 'Container'), params.containerId])}"
            redirect(action: "showDetails", id: shipmentInstance.id, params: ["containerId": params.containerId])
        }
    }
    ...
    def copyContainer() {
        ...
        if (container && shipment) {
            ...
            flash.message = "${g.message(code: 'shipping.copiedContainerSuccessfully.message')}"
        } else {
            flash.message = "${g.message(code: 'shipping.unableToCopyPackage.message')}"
        }
    ...
    def editDocument() {
        ...
        if (!shipmentInstance) {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'shipment.label', default: 'Shipment'), params.shipmentId])}"
            redirect(action: "list")
        }
        if (!documentInstance) {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'document.label', default: 'Document'), params.documentId])}"
            redirect(action: "showDetails", id: shipmentInstance?.id)
        }
        render(view: "addDocument", model: [shipmentInstance: shipmentInstance, documentInstance: documentInstance])
    }
    ...
    def saveComment() {
        ...
        if (shipmentInstance) {
            ...
            flash.message = "${g.message(code: 'shipping.addedCommentToShipment.message', args: [params.comment, shipmentInstance.name])}"
        }
        redirect(action: 'showDetails', id: params.shipmentId)
    }
    ...
    def editItem() {
        ...
        if (item) {
            ...
            item.save()
            flash.message = "${g.message(code: 'shipping.addedCommentToShipment.message', args: [params.id, container.name])}"
            redirect(action: 'editContents', id: shipmentId)
        } else {
            flash.message = "${g.message(code: 'shipping.couldNotEditItemFromContainer.message', args: [params.id])}"
    ...
    def deleteDocument() {
        ...
        if (shipment && document) {
            ...
            flash.message = "${g.message(code: 'shipping.deletedDocumentFromShipment.message', args: [params.id])}"
        } else {
            flash.message = "${g.message(code: 'shipping.couldNotRemoveDocumentFromShipment.message', args: [params.id])}"
        }
    ...
    def deleteEvent() {
        ...
        if (shipment && event) {   // not allowed to delete a "created" event
            ...
            event.delete()
            shipment.save()
            flash.message = "${g.message(code: 'shipping.deletedEventFromShipment.message', args: [params.id])}"
        } else {
            flash.message = "${g.message(code: 'shipping.couldNotRemoveEventFromShipment.message', args: [params.id])}"
        }
        redirect(action: 'showDetails', id: params.shipmentId)
    }
    ...
    def deleteContainer() {
        ...
        if (shipment && container) {
            container.delete()
            flash.message = "${g.message(code: 'shipping.deletedContainerFromShipment.message', args: [params.id])}"
        } else {
            flash.message = "${g.message(code: 'shipping.couldNotRemoveContainerFromShipment.message', args: [params.id])}"
        }
    ...
    def deleteItem() {
        ...
        if (item) {
            ...
            flash.message = "${g.message(code: 'shipping.deletedShipmentItemFromContainer.message', args: [params.id, container.name])}"
            redirect(action: 'showDetails', id: shipmentId)
        } else {
            flash.message = "${g.message(code: 'shipping.couldNotRemoveItemFromContainer.message', args: [params.id])}"
            redirect(action: 'showDetails', id: shipmentId)
        }
    }
    ...
    def deleteComment() {
        ...
        if (shipment && comment) {
            ...
            comment.delete()
            flash.message = "${g.message(code: 'shipping.deletedCommentFromShipment.message', args: [comment, params.shipmentId])}"
            redirect(action: 'showDetails', id: params.shipmentId)
        } else {
            flash.message = "${g.message(code: 'shipping.couldNotRemoveCommentFromShipment.message', args: [params.id])}"
            redirect(action: 'showDetails', id: params.shipmentId)
        }
    }
    ...
    def editEvent() {
        ...
        if (!eventInstance) {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'shipmentEvent.label', default: 'ShipmentEvent'), params.id])}"
            redirect(action: "showDetails", id: params.shipmentId)
        }
    ...
    def saveEvent() {
        ...
        if (eventInstance.hasErrors()) {
            flash.message = "${g.message(code: 'shipping.unableToEditEvent.message', args: [format.metadata(obj: eventInstance?.eventType)])}"
    ...
    def addReferenceNumber() {
        ...
        flash.message = "${g.message(code: 'shipping.addedReferenceNumber.message')}"
    ...
    def addToShipmentPost(ItemListCommand command) {
        ...
        if (shipmentContainer) {
            ...
            try {
                ...
                if (atLeastOneUpdate) {
                    flash.message = "${g.message(code: 'shipping.shipmentItemsHaveBeenAdded.message')}"
                    ...
                    flash.message = "${g.message(code: 'shipping.noShipmentItemsHaveBeenUpdated.message')}"
                }
