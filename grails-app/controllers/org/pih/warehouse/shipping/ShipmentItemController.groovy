...
class ShipmentItemController {
    ...
    def save() {
        ...
        if (shipmentItemInstance.save(flush: true)) {
            flash.message = "${g.message(code: 'default.created.message', args: [g.message(code: 'shipmentItem.label', default: 'ShipmentItem'), shipmentItemInstance.id])}"
    ...
    def show() {
        ...
        if (!shipmentItemInstance) {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'shipmentItem.label', default: 'ShipmentItem'), params.id])}"
        ...
        if (shipmentItemInstance) {
            if (params.version) {
                ...
                if (shipmentItemInstance.version > version) {
                    ...
                    shipmentItemInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [g.message(code: 'shipmentItem.label', default: 'ShipmentItem')] as Object[], "Another user has updated this ShipmentItem while you were editing")
            ...
            if (!shipmentItemInstance.hasErrors() && shipmentItemInstance.save(flush: true)) {
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'shipmentItem.label', default: 'ShipmentItem'), shipmentItemInstance.id])}"
                redirect(action: "list", id: shipmentItemInstance.id)
            } else {
                render(view: "edit", model: [shipmentItemInstance: shipmentItemInstance])
            }
    ...
    def delete() {
        ...
        if (shipmentItemInstance) {
            try {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'shipmentItem.label', default: 'ShipmentItem'), params.id])}"
                redirect(action: "list")
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'shipmentItem.label', default: 'ShipmentItem'), params.id])}"
