...
class ShipmentWorkflowController {
    ...
    def save() {
        ...
        if (shipmentWorkflowInstance.save(flush: true)) {
            flash.message = "${g.message(code: 'default.created.message', args: [g.message(code: 'shipmentWorkflow.label', default: 'ShipmentWorkflow'), shipmentWorkflowInstance.id])}"
    ...
    def show() {
        ...
        if (!shipmentWorkflowInstance) {
            flash.message = "${g.message(code: 'default.not.found.message', args: [g.message(code: 'shipmentWorkflow.label', default: 'ShipmentWorkflow'), params.id])}"
        ...
        if (shipmentWorkflowInstance) {
            if (params.version) {
                ...
                if (shipmentWorkflowInstance.version > version) {
                    ...
                    shipmentWorkflowInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [g.message(code: 'shipmentWorkflow.label', default: 'ShipmentWorkflow')] as Object[], "Another user has updated this ShipmentWorkflow while you were editing")
            ...
            if (!shipmentWorkflowInstance.hasErrors() && shipmentWorkflowInstance.save(flush: true)) {
                flash.message = "${g.message(code: 'default.updated.message', args: [g.message(code: 'shipmentWorkflow.label', default: 'ShipmentWorkflow'), shipmentWorkflowInstance.id])}"
                redirect(action: "list", id: shipmentWorkflowInstance.id)
            } else {
                render(view: "edit", model: [shipmentWorkflowInstance: shipmentWorkflowInstance, documentTemplates: documentTemplates])
            }
    ...
    def delete() {
        ...
        if (shipmentWorkflowInstance) {
            try {
                ...
                flash.message = "${g.message(code: 'default.deleted.message', args: [g.message(code: 'shipmentWorkflow.label', default: 'ShipmentWorkflow'), params.id])}"
                redirect(action: "list")
            }
            catch (org.springframework.dao.DataIntegrityViolationException e) {
                flash.message = "${g.message(code: 'default.not.deleted.message', args: [g.message(code: 'shipmentWorkflow.label', default: 'ShipmentWorkflow'), params.id])}"
