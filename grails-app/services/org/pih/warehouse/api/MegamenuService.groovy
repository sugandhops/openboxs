...
class MegamenuService {
    ...
    List buildAndTranslateSubsections(List subsections, User user, Location location) {
        ...
        subsections.each { it ->
            ...
            println 'subsections menuItems:: '+ it.menuItems[0]  
             it.menuItems.each { item ->
                println "Menu Item Label: ${item.label}"
              }  
             //println 'subsections menuItems :: '+ it.menuItems 
