...
class ProductAvailabilityService {
    ...
    def triggerRefreshProductAvailability(String locationId, List<String> productIds, Boolean forceRefresh) {
        ...
        Boolean delayStart = grailsApplication.config.getProperty('openboxes.jobs.refreshProductAvailabilityJob.delayStart', Boolean, false)
        //def delayInMilliseconds = delayStart ?
         ...
         Integer delayInMilliseconds = grailsConfig.getProperty('openboxes.jobs.refreshProductAvailabilityJob.delayInMilliseconds', Integer, 0)
