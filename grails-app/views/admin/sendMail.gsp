...
<div id="settings" role="main" class="yui-ga">
    ...
    <div class="yui-u first">
        <div class="tabs">
            <ul>
                <li>
                    <a href="#tabs-1" id="send-text-tab"><g:message code="mail.header"/></a>
                </li>
            </ul>
            <div id="tabs-1">
                <g:form controller="admin" action="sendMail" method="POST" enctype="multipart/form-data" useToken="true">
                    <table class="table table-bordered">
                        <tbody>
                            <tr class="prop">
                                <td class="name">
                                    <label><g:message code="mail.to.label" default="To"/></label>
                                </td>
                                <td class="value">
                            ...
                            <tr class="prop">
                                <td class="name">
                                    <label><g:message code="mail.from.label" default="From"/></label>
                                </td>
                                <td class="value">
                            ...
                            <tr class="prop">
                                <td class="name">
                                    <label><g:message code="mail.subject.label" default="Subject"/></label>
                                </td>
                                <td class="value">
                            ...
                            <tr class="prop">
                                <td class="name">
                                    <label><g:message code="mail.includesHtml.label" default="Includes HTML?"/></label>
                                </td>
                                <td class="value">
                            ...
                            <tr class="prop">
                                <td class="name">
                                    <label><g:message code="mail.message.label" default="Message"/></label>
                                </td>
                                <td class="value">
                            ...
                            <tr class="prop">
                                <td class="name">
                                    <label><g:message code="mail.file.label" default="File"/></label>
                                </td>
                                <td class="value">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="2" class="center">
                                    ...
                                    <g:link controller="admin" action="sendMail" class="button icon reload"><g:message code="default.button.cancel.label"/></g:link>
                                </td>
                            </tr>
                        </tfoot>
