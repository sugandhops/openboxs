<html>
    <head>
        ...
        <title><g:message code="admin.upgrade.title" /></title>
        <style>
				...
				<g:form>
					<fieldset>
						<table>
							<tr class="">
								<td colspan="2">
									<h1><g:message code="upgrade.step1.label"/></h1>
								</td>
							</tr>
							<tr class="prop">
								<td class="name">					
									<label>
										<g:message code="upgrade.remoteWebArchiveUrl.label"/>
									</label>
								</td>
								<td class="value">						
							...
							<tr class="prop">
								<td class="name">					
									<label>
										<g:message code="upgrade.progress.label"/>
									</label>
								</td>
								<td class="value">
									<div>
							...
							<tr class="">
								<td colspan="2">
									<h1><g:message code="upgrade.step2.label"/></h1>
								</td>
							</tr>						
							<tr class="prop">
								<td class="name">					
									<label>
										<g:message code="upgrade.localWebArchive.label"/>
									</label>
								</td>
								<td class="value">
							...
							<tr class="prop">
								<td class="name">					
									<label>
										<g:message code="upgrade.localWebArchivePath.label"/>
									</label>
								</td>
								<td class="value">						
