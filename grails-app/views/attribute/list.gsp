...
<html>
    <head>
        ...
        <title><g:message code="default.add.label" args="[warehouse.message(code:'attribute.label').toLowerCase()]"/></title>
    </head>
    <body>
        <div class="body">
            ...
            <div class="list">
                ...
                <div class="buttonBar">
                    <g:link class="button icon log" action="list"><g:message code="default.list.label" args="[warehouse.message(code:'attribute.label').toLowerCase()]"/></g:link>
                    <g:isUserAdmin>
                        <g:link class="button icon add" action="create"><g:message code="default.add.label" args="[warehouse.message(code:'attribute.label').toLowerCase()]"/></g:link>
                    </g:isUserAdmin>
                </div>
                ...
                <div class="yui-gf">
                    <div class="yui-u first">
                        <div class="box">
                            <h2><g:message code="default.search.label" default="Search"/></h2>
                    ...
                    <div class="yui-u">
                        ...
                        <div class="box">
                            <h2><g:message code="attributes.label" default="Attributes"/></h2>
                            <table>
                                <thead>
                                <tr>
                                    ...
                                    <g:sortableColumn property="entityTypeCode" title="${g.message(code: 'attribute.entityTypeCode.label', default: 'Entity Type')}" />
                                    <g:sortableColumn property="options" title="${g.message(code: 'attribute.options.label')}" />
                                    <g:sortableColumn property="active" title="${g.message(code: 'default.active.label')}" />
                                    <g:sortableColumn property="required" title="${g.message(code: 'default.required.label')}" />
                                    <g:sortableColumn property="allowOther" title="${g.message(code: 'attribute.allowOther.label')}" />
                                </tr>
                                </thead>
                                <tbody>
