...
<body>
							...
							<tbody>
                                ...
                                <tr class="">
                                    <td class="middle left" colspan="2">
                                        <g:message code="auth.newuser.text"/>
                                        <g:link class="list" controller="auth" action="signup">
	...
	<script type="text/javascript">
		$(document).ready(function() {
            ...
            $("#username").watermark("${message(code:'login.username.label')}");
		    $("#password").watermark("${message(code:'login.password.label')}");
			$("#username").focus();
