					...
					<div id="loginBox" class="box">
                        ...
                        <table>
							<tbody>
                                ...
                                <tr class="prop">
									<td class="name">
                                        <label for="additionalQuestions.comments">
                                        <g:message code="default.comments.label"/></label>
                                    </td>
									<td valign="top">
								...
								<tr class="prop">
									...
									<td class="value">
										<g:message code="auth.alreadyHaveAccount.text"/>
										<g:message code="auth.alreadyHaveAccount.text"/>
										<g:link class="list" controller="auth" action="login">
											<g:message code="auth.login.label" default="Login"/>
