...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'budgetCode.label', default: 'Budget Code')}" />
        ...
        <div class="body">
			...
			<div class="button-bar">
				<g:link class="button" action="list">
					...
					<g:message code="default.list.label" args="['Budget Code']"/>
				</g:link>
				<g:link class="button" action="create">
                	<img src="${resource(dir: 'images/icons/silk', file: 'add.png')}" />&nbsp;
					<g:message code="default.add.label" args="['Budget Code']"/>
				</g:link>
			</div>
						...
						<tbody>
							...
							<tr class="prop">
								<td valign="middle" class="name">
									<label for="code"><g:message code="budgetCode.code.label" default="Code" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="middle" class="name">
									<label for="name"><g:message code="budgetCode.name.label" default="Name" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="middle" class="name">
									<label for="description"><g:message code="budgetCode.description.label" default="Description" /></label>
								</td>
								<td valign="middle" class="value">
							...
							<tr class="prop">
								<td valign="middle" class="name">
									<label for="organization"><g:message code="budgetCode.organization.label" default="Organization" /></label>
								</td>
								<td valign="middle" class="value">
