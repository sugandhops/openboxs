...
<div class="d-none d-${breakPoint}-flex">
    ...
    <div class="menu-icon">
        <div class="tooltip2">
            ...
            <span class="tooltiptext2">
                ${g.message(code:'default.support.label', default: 'Help')}
            </span>
        </div>
    </div>
    </g:if>
        ...
        <div class="btn-group">
            <div class="tooltip2">
                ...
                <div class="dropdown-menu dropdown-menu-right nav-item padding-8 margin-top-18">
                    ...
                    <div class="padding-8">
                        <g:each in="${configurationSection?.menuItems}" var="item">
                      
                            <% if (item?.href == '#') { %>
                                   </div><div class="padding-8">
                                    <span class="subsection-title"> <g:message code="${item?.label}"/></span>
                            <% } else { %>
                ...
                <span class="tooltiptext2">${g.message(code:'configuration.label', default: 'Configuration')}</span>
            </div>
        </div>
    </div>
    </g:if>
                ...
                <div class="dropdown-menu dropdown-menu-right nav-item padding-8 margin-top-18">
                    ...
                    <g:if test="${session?.useDebugLocale}">
                        <g:link controller="user" action="disableLocalizationMode" class="dropdown-item">
                            ...
                            ${g.message(code:'localization.disable.label', default: 'Disable translation mode')}
                        </g:link>
                    </g:if>
                    <g:else>
                        <g:link controller="user" action="enableLocalizationMode" class="dropdown-item">
                            ...
                            ${g.message(code:'localization.enable.label', default: 'Enable translation mode')}
                        </g:link>
                    </g:else>
                    <g:link controller="dashboard" action="flushCache" class="dropdown-item">
                        ...
                        ${g.message(code:'cache.flush.label', default: 'Refresh caches')}
                    </g:link>
