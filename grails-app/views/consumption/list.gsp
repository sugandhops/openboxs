		...
		<div class="body">
            ...
            <div class="button-bar">
                <g:link controller="consumption" action="list" class="button">
                    ...
                    <g:message code="consumption.report.show.label" default="Show Consumption Report"/>
                </g:link>
				<g:link controller="consumption" action="pivot" class="button">
					...
					<g:message code="consumption.report.edit.label" default="Edit Consumption Report"/>
				</g:link>
                ...
                <g:isSuperuser>
                    <div class="right">
                        <g:link controller="consumption" action="refresh" class="button">
                            ...
                            <g:message code="consumption.refreshData.label"/>
                        </g:link>
                    </div>
                </g:isSuperuser>
                        ...
                        <g:form action="list" method="get">
                            ...
                            <div class="filter-list-item">
                                    ...
                                    <button id="btn-execute" name="execute" class="button">
                                        ...
                                        &nbsp;<g:message code="default.button.view.label"/> </button>

                                    <button id="btn-download" name="download" class="button" value="true">
                                        <img src="${resource(dir: 'images/icons/silk', file: 'page_excel.png')}"/>
                                        &nbsp;<g:message code="default.button.download.label"/></button>
