...
<head>
    ...
    <g:set var="entityName" value="${g.message(code: 'consumption.label', default: 'Consumption').toLowerCase()}" />
    ...
    <div class="body">
        ...
        <div class="yui-gf">
            ...
            <div class="yui-u">
                ...
                <div class="box">
                    <h2>
                        ${g.message(code:'consumption.label')} <small>(${command.rows?.keySet()?.size()} ${g.message(code: 'default.resultsLowerCase.label', default: 'results')})</small>
                    </h2>
                        ...
                        <table class="dataTable">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="center"><g:message code="consumption.unitPrice.label" default="Unit Price"/></th>
                                    <th class="center"><g:message code="consumption.issued.label" default="Issued"/></th>
                                    <th class="center"><g:message code="consumption.consumed.label" default="Consumed"/></th>
                                    <th class="center"><g:message code="consumption.returned.label" default="Returned"/></th>
                                    <th class="center"><g:message code="consumption.total.label" default="Total Consumption"/></th>
                                    <th class="center"><g:message code="consumption.totalConsumptionValue.label" default="Total Consumption Value"/></th>
                                    <th class="center"><g:message code="consumption.monthly.label" default="Monthly"/></th>
                                    <th class="center"><g:message code="default.qoh.label" default="QoH"/></th>
                                    <th class="center"><g:message code="consumption.months.label" default="Months remaining"/></th>
                                </tr>
                            </thead>
                            <tbody>
