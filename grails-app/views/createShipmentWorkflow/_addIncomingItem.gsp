<div id="dlgAddIncomingItem" title="${g.message(code:'shipping.addIncomingItem.label')}" style="display: none;" >
				...
				<tbody>
					<tr class="prop">
						<td valign="top" class="name">
							<label><g:message code="default.lotSerialNo.label" /></label>
						</td>                            
					...
					<tr>
						...
						<td>
							<div class="left">
								<g:if test="${item}">
									<g:submitButton class="button" name="updateItem" value="${g.message(code:'shipping.saveItem.label')}"/>
								</g:if>
								<g:else>
									<g:submitButton name="saveItem" class="button" value="${g.message(code:'shipping.saveItem.label')}"/>
									<g:if test="${addItemToContainerId}">									
										<g:submitButton class="button" name="addAnotherItem" value="${g.message(code:'shipping.saveItemAndAddAnother.label')}"/>
									</g:if>
								</g:else>
								...
								<g:if test="${!item }">
									<a href="javascript:void(0);" class="button back"><g:message code="default.button.back.label"/></a>
								</g:if>
