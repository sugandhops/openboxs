...
<div id="dlgAddLocation" title="${g.message(code:'default.add.label', args: [g.message(code: 'location.label')])}" style="padding: 10px; display: none;" >
		...
		<table>
			<tbody>
				...
				<tr class="prop">
					<td class="name">
						<label for="name">
							<g:message code="location.locationType.label"/>
						</label>
					</td>
					<td class="value">
				...
				<tr class="prop">
					<td class="name">
						<label for="name">
							<g:message code="location.name.label"/>
						</label>
					</td>
					<td class="value">
				...
				<tr class="prop">
					...
					<td class="value">
						<div class="left">
							<g:submitButton name="saveLocation" value="${g.message(code:'default.button.save.label')}"/>
