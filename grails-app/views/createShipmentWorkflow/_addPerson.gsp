...
<div id="dlgAddPerson" title="${g.message(code:'default.add.label', args: [g.message(code: 'person.label')])}" style="padding: 10px; display: none;" >
		...
		<table>
			<tbody>
				...
				<tr class="prop">
					<td class="name">
						<label for="phoneNumber">
							<g:message code="person.phoneNumber.label"/>
						</label>
					</td>
					<td class="value">
				...
				<tr class="prop">
					...
					<td class="value">
						<div class="left">
							<g:submitButton name="savePerson" value="${g.message(code:'default.button.save.label')}"/>
