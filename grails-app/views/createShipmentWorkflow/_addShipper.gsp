...
<div id="dlgAddShipper" title="${g.message(code:'default.add.label', args: [g.message(code: 'shipper.label')])}" style="padding: 10px; display: none;" >
		...
		<table>
			<tbody>
				...
				<tr class="prop">
					<td class="name">
						<label for="name">
							<g:message code="shipper.name.label"/>
						</label>
					</td>
					<td class="value">
				...
				<tr class="prop">
					<td class="name">
						<label for="name">
							<g:message code="shipper.description.label"/>
						</label>
					</td>
					<td class="value">
				...
				<tr class="prop">
					...
					<td class="value">
						<div class="left">
							<g:submitButton name="saveShipper" value="${g.message(code:'default.button.save.label')}"/>
