...
<tr class="prop">
	<td valign="top" class="name"><label><g:message code="product.label" default="Product" /></label></td>                            
...
<tr class="prop">
	<td valign="top" class="name"><label><g:message code="inventory.onHandQuantity.label" /></label></td>                            
	<td valign="top" class="value">
	...
	<td>
		<div class="left">
			<g:if test="${itemToEdit}">
				<g:submitButton name="updateShipmentItem" value="${g.message(code:'shipping.saveItem.label')}" class="button"></g:submitButton>
			</g:if>
			<g:else>
				<g:submitButton name="saveItem" value="${g.message(code:'shipping.saveItem.label')}" class="button"></g:submitButton>
			</g:else>
			<button name="cancelDialog" type="reset" onclick="$('#dlgEditItem').dialog('close');" class="button"><g:message code="default.button.cancel.label"/></button>
		</div>
