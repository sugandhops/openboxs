...
<tr class="prop">
	<td valign="top" class="name">
		<label><g:message code="shipping.availableQuantity.label" /></label>
	</td>                            
	<td valign="top" class="value">
	...
	<td colspan="2">
		<div class="buttons center">
			<g:if test="${itemToEdit}">
				<g:submitButton name="updateItem" value="${g.message(code:'shipping.saveItem.label')}" class="button"></g:submitButton>
			</g:if>
			<g:else>
				<g:submitButton name="saveItem" value="${g.message(code:'shipping.saveItem.label')}" class="button"></g:submitButton>
			</g:else>
			<g:if test="${containerId}">
				<g:submitButton name="addAnotherItem" value="${g.message(code:'shipping.saveItemAndAddAnother.label')}" class="button"></g:submitButton>
			</g:if>
			<button name="cancelDialog" type="reset" onclick="$('.ui-dialog-titlebar-close').click();" class="button"><g:message code="default.button.cancel.label"/></button>
			<button class="show-search-form button">&lsaquo; <g:message code="shipping.returnToSearch.label"/></button>
		</div>
	</td>
</tr>
