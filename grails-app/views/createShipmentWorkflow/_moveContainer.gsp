...
<div id="dlgMoveContainer" title="${g.message(code:'shipping.moveContainer.label')}" style="padding: 10px; display: none;" >
		...
		<g:form name="moveContainer" action="createShipment">
			...
			<table>
				<tbody>
					...
					<tr class="prop">
						<td valign="top" class="name">
							<label><g:message code="default.to.label"/></label>
						</td>                            
						<td valign="top" class="value">
					...
					<tr>
						...
						<td>
							<div class="buttons left">
								<g:submitButton name="moveContainerToShipment" value="${g.message(code:'default.button.move.label')}"></g:submitButton>
								<button name="cancelDialog" type="reset" onclick="$('#dlgMoveContainer').dialog('close');"><g:message code="default.button.cancel.label"/></button>
							</div>
						</td>
					</tr>
				</tbody>
