...
<div id="dlgMoveItem" title="${g.message(code:'shipping.moveItem.label')}" style="padding: 10px; display: none;" >
	<g:if test="${itemToMove}">
		<g:form name="moveItem" action="createShipment">
			<table>
				<tbody>
					<tr class="prop">
						<td valign="top" class="name"><label><g:message code="item.label" /></label></td>                            
					...
					<tr class="prop">
						<td valign="top" class="name"><label><g:message code="default.from.label" /></label></td>                            
						<td valign="top" class="value">
							<div>
					...
					<tr class="prop">
						<td valign="top" class="name"><label><g:message code="default.to.label"/></label></td>                            
						<td valign="top" class="value">
							<div style="height: 200px; overflow: auto;">
								...
								<table>
									...
									<tr class="${count++ % 2 ? 'odd':'even' }">
										<td>
											<g:message code="shipping.unpackedItems.label" default="Unpacked Items" />
										</td>
										<td>
											<g:if test="${itemToMove.container}">
					...
					<tr>
						<td colspan="2">
							<div class="buttons center">
								<g:submitButton name="moveItemToContainer" value="${g.message(code:'default.button.move.label')}" class="button"></g:submitButton>
								<button name="cancelDialog" type="reset" onclick="$('#dlgMoveItem').dialog('close');" class="button"><g:message code="default.button.cancel.label" /></button>
							</div>
						</td>
					</tr>
				</tbody>
