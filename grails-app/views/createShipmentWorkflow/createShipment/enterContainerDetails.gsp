...
<head>
    ...
    <title><g:message code="shipping.addShipmentItems.label"/></title>
...
<div class="body">
        ...
        <div class="buttonBar">
            ...
            <div class="button-group">
                <g:link class="button icon reload" controller="createShipmentWorkflow" action="createShipment" event="enterContainerDetails" id="${shipmentInstance?.id}" params="[skipTo: 'Packing']">
                    <g:message code="shipping.reload.label" default="Reload"/></g:link>
            </div>
        </div>
        ...
        <div class="yui-gd">
            <div class="yui-u first">
                ...
                <div class="box" >
                    ...
                    <h2><g:message code="containers.label"/></h2>
                            ...
                            <tr class="droppable fade not-selected" container="trash" style="height: 44px;">
                                <td colspan="5" class="center middle">
                                    <div class="center">
                                        ...
                                        <g:message code="shipment.trash.label" default="Drop here to remove from shipment"/>
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="center">
                                        ...
                                        <g:submitButton name="deleteContainersAndItems" value="Delete Selected" class="button icon trash" onclick="return confirm('${g.message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');"></g:submitButton>
                                        <g:submitButton name="deleteAllContainersAndItems" value="Delete All" class="button icon trash" onclick="return confirm('${g.message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');"></g:submitButton>
                ...
                <div class="box">
                    ...
                    <table>
                        ...
                        <tr class="prop">
                            <th class="middle"></th>
                            <th class="middle"></th>
                            <th class="middle center"><g:message code="product.productCode.label"/></th>
                            <th class="middle"><g:message code="product.label"/></th>
                            <th class="middle"><g:message code="location.binLocation.label"/></th>
                            <th class="middle"><g:message code="inventoryItem.lotNumber.label"/></th>
                            <th class="center middle"><g:message code="inventoryItem.expirationDate.label"/></th>
                            <th class="left middle"><g:message code="default.qty.label"/></th>
                            <th class="left middle"><g:message code="default.uom.label"/></th>
                            <th class="middle"><g:message code="shipping.recipients.label"/></th>
                        </tr>
                        </thead>
                        <tbody>
    ...
    <div class="buttons">
        <g:form action="createShipment" method="post" >
            <button name="_eventId_back" class="button">&lsaquo; <g:message code="default.button.back.label"/></button>
            <button name="_eventId_next" class="button"><g:message code="default.button.next.label"/> &rsaquo;</button>
            <button name="_eventId_save" class="button"><g:message code="default.button.saveAndExit.label"/></button>
            <button name="_eventId_cancel" class="button"><g:message code="default.button.cancel.label"/></button>
        </g:form>
    </div>
</div>
    ...
    <!-- process an upload or save depending on whether we are adding a new doc or modifying a previous one -->
        <g:form action="createShipment">
            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label><g:message code="container.type.label" /></label>
                    </td>
                    <td valign="top" class="value">
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label><g:message code="shipment.numberOfContainers.label" default="Number of containers"/></label>
                    </td>
                    <td valign="top" class="value">
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label><g:message code="shipment.startIndex.label" default="Starting index"/></label>
                    </td>
                    <td valign="top" class="value">
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label><g:message code="shipment.parentContainer.label" default="Parent Container"/></label>
                    </td>
                    <td valign="top" class="value">
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label><g:message code="shipment.containerText.label" default="Create the following containers"/></label>
