...
<html>
    <head>
         ...
         <title><g:message code="shipping.enterShipmentDetails.label"/></title>
    </head>
    <body>
        <div class="body">
			<g:if test="${message}">
				...
				<g:hiddenField name="id" value="${shipmentInstance?.id}"/>
					...
					<g:render template="flowHeader" model="['currentState':'Details']"/>
               		...
               		<div class="dialog box">
                        <h2><g:message code="shipping.enterShipmentDetails.label"/></h2>
		                <table>
		                    <tbody>
                                <tr class='prop'>
                                    <td valign='top' class='name'>
                                        <label for='name'><g:message code="shipping.name.label"/></label>
                                    </td>
                                ...
                                <g:if test="${!shipmentWorkflow?.isExcluded('shipmentType')}">
									<tr class="prop">
										<td valign="top" class="name"><label><g:message code="default.type.label" /></label></td>
										<td valign="top"
								...
								<tr class="prop">
									<td valign="top" class="name">
                                        <label><g:message code="default.origin.label" /></label>
								...
								<tr class="prop">
									<td valign="top" class="name">
                                        <label><g:message code="default.destination.label" /></label>
                                        <g:link action="createShipment" event="addLocation" params="[target:'origin']" tabIndex="-1">
                                            <img src="${resource(dir:'images/icons/silk',file:'building_add.png')}" alt="Add a location" class="middle" />
                                        </g:link>
                                    </td>
								...
								<tr class="prop">
									<td valign="top" class="name"><label><g:message code="shipping.expectedShippingDate.label"/></label></td>
								...
								<g:if test="${!shipmentWorkflow?.isExcluded('expectedDeliveryDate')}">
									<tr class="prop">
										<td valign="top" class="name"><label><g:message code="shipping.expectedDeliveryDate.label"/></label></td>
					...
					<div class="buttons">
						<button name="_eventId_back" disabled class="button">&lsaquo; <g:message code="default.button.back.label"/></button>
