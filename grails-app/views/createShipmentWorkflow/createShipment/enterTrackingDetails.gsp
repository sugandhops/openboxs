...
<html>
    <head>
         ...
         <title><g:message code="shipping.enterTrackingDetails.label"/></title>
    </head>
    <body>
        <div class="body">
        	<g:if test="${message}">
			...
			<g:form action="createShipment" method="post">
				...
				<div class="dialog box">
                    <h2><g:message code="shipping.enterTrackingDetails.label"/></h2>
					<table>
	                    <tbody>
							...
							<g:if test="${!shipmentWorkflow?.isExcluded('shipmentMethod.shipper')}">
								...
								<tr class="prop">
									<td valign="top" class="name"><label><g:message
										code="shipmentMethod.trackingNumber.label" default="Tracking Number"/></label>
									</td>
									<td valign="top" class="value">
										<g:textField name="trackingNumber"
											size="20" class="text large" value="${shipmentInstance?.shipmentMethod?.trackingNumber}" />
									</td>
								</tr>
							</g:if>
								...
								<tr class="prop">
									...
									<td valign="top" class="value">
										<g:textField name="referenceNumbersInput.${referenceNumberType?.id}"
											size="20" class="large text" value="${shipmentInstance?.referenceNumbers?.find({it.referenceNumberType.id == referenceNumberType.id})?.identifier}" />
									</td>
								</tr>
							</g:each>
								...
								<tr class="prop">
									...
									<td valign="top"
										...
										nowrap="nowrap">
											...
											<div class="fade"><g:message code="shipping.statedValueExplanation.message"/></div>
									</td>
								</tr>
							</g:if>
									...
									<td valign="top"
										...
										nowrap="nowrap">
											<g:textField name="totalValue" value="${formatNumber(format: '##,##0.00', number: shipmentInstance.totalValue)}"
											 	class="text" size="20" placeholder="0.00"/>
											<div class="fade"><g:message code="shipping.totalValueExplanation.message"/></div>
									</td>
								</tr>
							</g:if>
