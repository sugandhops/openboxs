...
<html>
    <head>
         ...
         <title><g:message code="shipping.pickShipmentItems.label"/></title>
         <style>
                    ...
                    <g:form action="createShipment" method="post">
                        ...
                        <div id="picklistItemsBox" class="dialog box">
                            <h2>
                                ...
                                <g:message code="shipping.pickShipmentItems.label"/>
                            </h2>
                                                ...
                                                --%>
                                                    ...
                                                    <g:isSuperuser>
                                                        <button name="_eventId_clearPicklist" class="button">
                                                            ...
                                                            <g:message code="shipping.clearPicklist.label" default="Clear picklist"/>
                                                        </button>
                                                    </g:isSuperuser>

                                                    <button name="_eventId_validatePicklist" class="button">
                                                        <img src="${resource(dir:'images/icons/silk',file:'error.png')}" />&nbsp;
                                                        <g:message code="shipping.validatePicklist.label" default="Validate picklist"/>
                                                    </button>
