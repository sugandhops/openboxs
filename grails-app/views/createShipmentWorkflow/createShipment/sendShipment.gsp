						...
						<table>
							<tbody>
										...
										<table>
											...
											<tr>
												<td>
													...
													<g:else>
														<g:message code="shipping.itemsInShipmentWillNotBeDebited.message" args="[shipmentInstance?.shipmentItems?.size(),shipmentInstance?.origin?.name]"/>
													</g:else>
												</td>
											</tr>
												...
												<tr>
													<td>
														...
														<span id="notificationEmailsWillNotBeSentOut">
															<g:message code="shipping.notificationEmailsWillNotBeSentOut.message"/>
														</span>
													</td>
												</tr>
											</g:else>
								...
								<tr class="prop">
									<td valign="top" class="name">
										<label>
											<g:message code="shipping.actualShippingDate.label" />:
										</label>
									</td>
										...
										<g:if test="${shipmentInstance.shipmentItems}">
											<div id="debitShipmentItems" class="${!command || command?.debitStockOnSend ? '' : 'hidden'  }">
												...
												<div style="overflow: auto; max-height: 300px; border: 1px solid lightgrey;">
													<table>
														<tr>
															<th><g:message code="container.label"/></th>
