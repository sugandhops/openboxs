<div class="box">
    <h2><g:message code="inventory.alerts.label" default="Alerts"/></h2>
                    ...
                    <tr>
                        ...
                        <td>
                            <g:link controller="inventory" action="listOutOfStock">
                                <g:message code="inventory.listOutOfStock.label" default="Items that have stocked out"/>
                            </g:link>
                        </td>
                        <td class="right">
                    ...
                    <tr>
                        ...
                        <td>
                            <g:link controller="inventory" action="listOverStock">
                                <g:message code="inventory.listOverStock.label" default="Items that are over stocked"/>
                            </g:link>
                        </td>
                        <td class="right">
