...
<div class="box">
    ...
    <h2>
                    ...
                    <div class="action-menu-item">
                        ...
                        <g:if test="${!params.editCatalogs}">
                            <g:link controller="dashboard" action="index" params="[editCatalogs:true]">
                                ...
                                <g:message code="catalogs.editCatalogs.label" default="Edit catalogs"></warehouse:message>
                            </g:link>
                        </g:if>
                        <g:else>
                            <g:link controller="dashboard" action="index">
                                <img src="${resource(dir:'images/icons/silk',file:'control_end.png')}" style="vertical-align: middle" />
                                <g:message code="tag.doneEditing.label" default="Done editing"></warehouse:message>
                            </g:link>
                        </g:else>
                    </div>
                </div>
        ...
        <g:message code="catalogs.label" default="Formularies"/>
    </h2>
            ...
            <g:if test="${params.editCatalogs}">
                <g:isUserAdmin>
                    <table>
                        <thead>
                            <tr>
                                <th><g:message code="catalogs.name.label" default="Formulary"/></th>
                                <th><g:message code="tag.count.label" default="Count"/></th>
            ...
            <g:else>
                ...
                <g:else>
                    <div style="margin:10px;" class="center">
                        <span class="fade"><g:message code="catalogs.noCatalogs.label"/></span>
                    </div>
                </g:else>
            </g:else>
        </div>
