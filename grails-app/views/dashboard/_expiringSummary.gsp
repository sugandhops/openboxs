<div class="box">
	<h2><g:message code="dashboard.expirationSummary.label" /></h2>
                    ...
                    <tr>
                        ...
                        <td>
                            <g:link controller="inventory" action="listExpiringStock" params="[status:'greaterThan365Days']">
                                <g:message code="inventory.listGreaterThan365Days.label" args="[365]" default="Expires after {0} days"/>
                            </g:link>
                        </td>
                        <td class="right">
                            <div id="greaterThan365Days"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="center" style="width: 1%">
                        ...
                        <td>
                            <g:link controller="inventory" action="listExpiringStock" params="[status:'within365Days']">
                                <g:message code="inventory.listExpiringStock.label" args="[365]" default="Items that will expire within {0} days"/>
                            </g:link>
                        </td>
                        <td class="right">
                            <div id="within365Days"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="center" style="width: 1%">
                        ...
                        <td>
                            <g:link controller="inventory" action="listExpiringStock" params="[status:'within180Days']">
                                <g:message code="inventory.listExpiringStock.label" args="[180]" default="Items that will expire within {0} days"/>
                            </g:link>
                        </td>
                        <td class="right">
                            <div id="within180Days"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                    ...
                    <tr>
                        ...
                        <td>
                            <g:link controller="inventory" action="listExpiringStock" params="[status:'within90Days']">
                                <g:message code="inventory.listExpiringStock.label" args="[90]" default="Items that will expire within {0} days"/>
                            </g:link>
                        </td>
                        <td class="right">
                            <div id="within90Days"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                    ...
                    <tr>
                        ...
                        <td>
                            <g:link controller="inventory" action="listExpiringStock" params="[status:'within30Days']">
                                <g:message code="inventory.listExpiringStock.label" args="[30]" default="Items that will expire within {0} days"/>

                            </g:link>
                        </td>
                        <td class="right">
                            <div id="within30Days"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <g:link controller="inventory" action="listExpiredStock" params="[status:'expired']">
                                <g:message code="inventory.listExpiredStock.label" default="Items that have expired"/>
                            </g:link>
                        </td>
                        <td class="right">
                            <div id="expired">
                ...
                <tr>
                    <th class="center" style="width: 1%">
                        <img src="${resource(dir: 'images/icons/silk', file: 'sum.png')}" class="middle"
                             title='${g.message(code:"inventory.information.label",default:"information")}'/>
                    </th>
                    <th>
                    ...
                    <th class="right">
                        <div id="totalExpiring"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                    </th>
                </tr>
                </tfoot>
			</table>
