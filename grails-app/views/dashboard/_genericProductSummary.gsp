    		...
    		<table class="zebra">
                ...
                <tr class="prop">
                    <td class="center" style="width: 1%">
                        <img src="${resource(dir: 'images/icons/silk', file: 'accept.png')}" class="middle" title='${g.message(code:"inventory.information.label",default:"Information")}'/>
                    </td>
                    ...
                    <td class="right">
                        <div id="IN_STOCK" class="indicator"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                ...
                <tr>
                    ...
                    <td class="right">
                        <div id="OVERSTOCK" class="indicator"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                    </td>
                </tr>
                <tr>
                    <td class="center" style="width: 1%">
                        <img src="${resource(dir: 'images/icons/silk', file: 'error.png')}" class="middle" title='${g.message(code:"inventory.warning.label",default:"Warning")}'/>
                    </td>

                    <td>
                        <g:link controller="dashboard" action="downloadGenericProductSummaryAsCsv" params="[status:'REORDER']">
                            <g:message code="inventory.listReorderStock.label" default="Items that are below reorder level"/>
                        </g:link>
                    </td>
                    <td class="right">
                        <div id="REORDER" class="indicator"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <g:link controller="dashboard" action="downloadGenericProductSummaryAsCsv" params="[status:'LOW_STOCK']">
                            <g:message code="inventory.listLowStock.label" default="Items that are below minimum level"/>
                        </g:link>
                    </td>
                    <td class="right">
                        <div id="LOW_STOCK" class="indicator"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <g:link controller="dashboard" action="downloadGenericProductSummaryAsCsv" params="[status:'STOCK_OUT_OBSOLETE']">
                            <g:message code="inventory.listOutOfStockObsolete.label" default="Stocked out, but obsolete"/>
                        </g:link>
                    </td>
                    <td class="right">
                        <div id="STOCK_OUT_OBSOLETE" class="indicator"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                ...
                <tfoot>
                    <tr>
                        <th class="center" style="width: 1%">
                            <img src="${resource(dir: 'images/icons/silk', file: 'sum.png')}" class="middle" title='${g.message(code:"default.total.label",default:"Total")}'/>
                        </th>
                        <th>
                        ...
                        <th class="right">
                            <div id="TOTAL"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></div>
                        </th>
                    </tr>
    ...
    $(window).load(function(){
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                var errorHtml = "<img src='${resource(dir: 'images/icons/silk', file: 'exclamation.png')}' title='" + errorMessage +"'/>";
                $(".indicator").each(function( index ) {
