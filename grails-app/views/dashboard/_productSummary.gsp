<div class="box">
    <h2><g:message code="dashboard.productSummary.label" /></h2>
    		...
    		<table class="zebra">
                ...
                <tr>
                    <td class="center" style="width: 1%">
                        <img src="${resource(dir:'images/icons/silk', file: 'exclamation.png')}" class="middle" title='${g.message(code:"inventory.information.label",default:"information")}'/>
                    </td>
                    <td>
                        <g:link controller="inventory" action="listQuantityOnHandZero" target="_blank">
                            <g:message code="inventory.listQuantityOnHandZero.label" default="Items that have QoH equal to zero"/>
                        </g:link>
                    </td>
                    <td class="right">
                ...
                <tr>
                    <td class="center" style="width: 1%">
                        <img src="${resource(dir:'images/icons/silk', file: 'error.png')}" class="middle" title='${g.message(code:"inventory.warnings.label",default:"Warning")}'/>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="right">
                        <div id="inStockCount"><img class="spinner" src="${resource(dir:'images', file: 'spinner.gif')}" class="middle"/></div>
                ...
                <tr>
                    ...
                    <th class="right">
                        <div id="totalStockCount"><img class="spinner" src="${resource(dir:'images', file: 'spinner.gif')}" class="middle"/></div>
                    </th>
                </tr>
                </tfoot>
            </table>
