                    ...
                    <div class="action-menu-item">
                        ...
                        <g:if test="${!params.editTags}">
                            <g:link controller="dashboard" action="index" params="[editTags:true]">
                                ...
                                <g:message code="tag.editTags.label" default="Edit tags"></warehouse:message>
                            </g:link>
                        </g:if>
                        <g:else>
            ...
            <g:if test="${params.editTags}">
                <g:isUserAdmin>
                    <table>
                        <thead>
                            <tr>
                                <th><g:message code="tag.name.label" default="Tag"/></th>
                                <th><g:message code="tag.count.label" default="Count"/></th>
                                <th><g:message code="tag.active.label" default="Active"/></th>
            ...
            <g:else>
                ...
                <g:else>
                    <div style="margin:10px;" class="center">
                        <span class="fade"><g:message code="tag.noTags.label"/></span>
                    </div>
                </g:else>
            </g:else>
        </div>
