...
<div class="box">
    <h2>
        <g:message code="inventory.value.label" default="Stock Value"/>
    </h2>
    <div class="widget-content" style="padding:0; margin:0">
        ...
        <div class="tabs">
            <ul>
                <li>
                    <a href="#value-summary"><g:message code="default.summary.label" default="Summary"/></a>
                </li>
                <li>
                    <a href="#value-details"><g:message code="default.details.label" default="Details"/></a>
                </li>
            </ul>
            <div id="value-summary">
                <table class="zebra">
                    ...
                    <tr class="prop odd">
                        <td colspan="3">
                            <label class="fade lastUpdated"><img class="spinner" src="${resource(dir: 'images', file: 'spinner.gif')}" class="middle"/></label>
                        </td>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td class="center" style="width: 1%">
                            <img src="${resource(dir: 'images/icons/silk', file: 'money.png')}" class="middle"/>
                        </td>
                        <td>
                            <g:message code="inventory.totalStockValue.label" default="Total value of inventory"/>
                        </td>
                        <td class="right">
                    ...
                    <tr>
                        <td>
                            <img src="${resource(dir: 'images/icons/silk', file: 'chart_pie.png')}" class="middle"/>
                        </td>
                        <td>
