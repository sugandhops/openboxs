<html>
    <head>
        ...
        <title>${g.message(code: 'dashboard.chooseLocation.label')}</title>
    </head>
    <body>
        <div class="d-flex justify-content-center align-items-center h-100">
            <div class="location-chooser location-chooser__login">
                <div class="location-chooser__header">
                    <h2>${g.message(code: 'dashboard.chooseLocation.label')}</h2>
                    <g:if test="${flash.message}">
                        <div class="message">${g.message(code:flash.message,default:flash.message)}</div>
