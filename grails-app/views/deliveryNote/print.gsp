...
<body class="${params.orientation?:'portrait'}">
                ...
                <td colspan="2" class="b-0">
                    <table class=" w100">
                        <tr>
                            ...
                            <td class="left top">
                                <h1 class="m-5">${g.message(code: 'requisition.deliveryNote.label')}</h1>
                            ...
                            <td class="right" width="25%">
                                <table class="w100 no-wrap">
                                    ...
                                    <tr>
                                        <td class="name">
                                            <label><g:message code="requisition.date.label"/>:</label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="name">
                                            <label><g:message code="deliveryNote.shipDate.label" default="Ship date"/>:</label>
                                        </td>
                                        <td>
    ...
    <div class="content">
        <g:if test="${requisitionItemsColdChain}">
            <h2>
                ${g.message(code:'product.coldChain.label', default:'Cold chain')}
            </h2>
        ...
        <g:if test="${requisitionItemsControlled}">
            <h2 class="${requisitionItemsColdChain ? 'mt' : ''}">
                ${g.message(code:'product.controlledSubstance.label', default:'Controlled Substance')}
            </h2>
        ...
        <g:if test="${requisitionItemsHazmat}">
            <h2 class="${requisitionItemsControlled||requisitionItemsColdChain ? 'mt' : ''}">
                ${g.message(code:'product.hazardousMaterial.label', default:'Hazardous Material')}
            </h2>
        ...
        <g:if test="${requisitionItemsOther}">
            <h2 class="${requisitionItemsHazmat||requisitionItemsControlled||requisitionItemsColdChain ? 'mt' : ''}">
                ${g.message(code:'product.generalGoods.label', default:'General Goods')}
            </h2>
        ...
        <g:if test="${requisitionItemsCanceled}">
            <h2 class="${requisitionItemsOther ? 'mt' : ''}">
                ${g.message(code:'default.canceled.label', default:'Canceled Items')}
            </h2>
        ...
        <table class="w100 fixed-layout b-0">
            <tr>
                    <h2><g:message code="deliveryNote.notes.label" default="Notes"/></h2>
            </tr>
            <tr>
                <td>
                    <label><g:message code="deliveryNote.trackingNumber.label" default="Tracking number"/>: </label>
                    ${requisition?.shipment?.referenceNumbers ? requisition?.shipment?.referenceNumbers?.first() : ''}
                </td>
            </tr>
            <tr>
                <td>
                    <label><g:message code="deliveryNote.driverName.label" default="Driver name"/>: </label>
                    ${requisition?.shipment?.driverName?:''}
                </td>
            </tr>
            <tr>
                <td>
                    <label><g:message code="deliveryNote.comments.label" default="Comments"/>: </label>
        ...
        <table class="signature-table w100 fixed-layout">
            <tr>
                <td width="33%" align="left">
                    <g:message code="deliveryNote.sentBy.label"/>
                </td>
                <td width="33%" align="center">
                    <g:message code="deliveryReceipt.signature.label"/>
                </td>
                <td width="33%" align="right">
                    <g:message code="deliveryReceipt.date.label"/>
                </td>
            </tr>
            <tr>
                <td align="left">
                    <g:message code="deliveryNote.approvedBy.label"/>
                </td>
                <td align="center">
                    <g:message code="deliveryReceipt.signature.label"/>
                </td>
            ...
            <tr>
                <td align="left">
                    <g:message code="deliveryNote.deliveredBy.label"/>
                </td>
                <td align="center">
                    <g:message code="deliveryReceipt.signature.label"/>
                </td>
            ...
            <tr>
                <td align="left">
                    <g:message code="deliveryNote.receivedBy.label"/>
                </td>
                <td align="center">
                    <g:message code="deliveryReceipt.signature.label"/>
                </td>
            ...
            <tr>
                <td align="left">
                    <g:message code="deliveryNote.checkedBy.label"/>
                </td>
                <td align="center">
                    <g:message code="deliveryReceipt.signature.label"/>
                </td>
