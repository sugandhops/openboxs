<div class="box">
    <h2><g:message code="default.render.label" args="[documentInstance?.filename]" /></h2>
            ...
            <table>
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="shipmentId"><g:message code="shipment.label" /></label>
                    </td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top">
                        <div class="buttons left">
                            <g:actionSubmit class="button" action="render" value="${g.message(code: 'default.button.render.label', default: 'Render')}" />
                        </div>
                    </td>
                </tr>
            </table>
