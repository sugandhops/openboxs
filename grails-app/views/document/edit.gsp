...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'document.label', default: 'Document')}" />
    ...
    <body>
        <div class="body">
			...
			<div class="button-bar">
				<g:link class="button" action="list"><g:message code="default.list.label" args="['documents']"/></g:link>
				<g:link class="button" action="create"><g:message code="default.add.label" args="['document']"/></g:link>
			</div>


            <div id="document-tabs" class="tabs">
                <ul>
                    <li><a href="#document-metadata-tab"><g:message code="document.label"/></a></li>
                    <li><a href="#document-file-tab"><g:message code="document.file.label" default="File"/></a></li>
                    <li><a href="${request.contextPath}/document/preview/${documentInstance?.id}"><g:message code="default.button.preview.label" default="Preview"/></a></li>
                </ul>
                        ...
                        <div class="box">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr class="prop">
                                        <td valign="top" class="name">
                                            <label for="documentType.id"><g:message code="document.documentType.label" default="Document Type" /></label>
                                        </td>
                                    ...
                                    <tr class="prop">
                                        <td valign="top" class="name">
                                          <label for="contentType"><g:message code="document.contentType.label" default="Content Type" /></label>
                                        </td>
                                    ...
                                    <tr class="prop">
                                        <td valign="top" class="name">
                                          <label for="fileUri"><g:message code="document.fileUri.label" default="File Uri" /></label>
                                        </td>
                                    ...
                                    <tr class="prop">
                                        <td valign="top" class="name">
                                          <label for="documentNumber"><g:message code="document.documentNumber.label" default="Document Number" /></label>
                                        </td>
                ...
                <div id="document-file-tab">
                    <g:form method="post" enctype="multipart/form-data">
                        ...
                        <g:hiddenField name="version" value="${documentInstance?.version}" />
                        <div class="box">
                            <h2><g:message code="default.upload.label" args="[entityName]" /></h2>
                            <table>
                                <tr class="prop">
                                    <td valign="top" class="name">
                                        <label for="filename"><g:message code="document.filename.label" default="Filename" /></label>
                                    </td>
                                ...
                                <tr class="prop">
                                    <td valign="top" class="name">
                                        <label for="image"><g:message code="document.image.label" default="Image" /></label>
                                    </td>
                                ...
                                <tr class="prop">
                                    <td valign="top" class="name">
                                        <label for="size"><g:message code="document.size.label" default="Size" /></label>
                                    </td>
                                ...
                                <tr class="prop">
                                    <td valign="top" class="name">
                                        <label for="fileContents"><g:message code="document.lastUpdated.label" default="Last Updated" /></label>
                                    </td>
                                ...
                                <tr class="prop">
                                    <td valign="top" class="name">
                                        <label for="fileContents"><g:message code="document.fileContents.label" default="File Contents" /></label>
                                    </td>
                                    <td valign="top" class="value ${hasErrors(bean: documentInstance, field: 'fileContents', 'errors')}">
                                        ...
                                        <g:actionSubmit class="button" action="upload" value="${g.message(code: 'default.button.upload.label', default: 'Upload')}" />
                                    </td>
                                </tr>
                                <tr class="prop">
                                    <td valign="top"></td>
