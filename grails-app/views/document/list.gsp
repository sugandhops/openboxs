                    ...
                    <div class="yui-u first">
                        <div class="box">
                            ...
                            <g:form action="list" method="get">
                                ...
                                <div class="filter-list-item">
                                    <label><g:message code="documentType.label"/></label>
                        ...
                        <div class="box">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <g:sortableColumn property="id" title="${g.message(code: 'document.id.label', default: 'Id')}" />

                                    <g:sortableColumn property="name" title="${g.message(code: 'document.name.label', default: 'Name')}" />

                                    <g:sortableColumn property="name" title="${g.message(code: 'document.documentType.label', default: 'Document Type')}" />

                                    <g:sortableColumn property="filename" title="${g.message(code: 'document.filename.label', default: 'Filename')}" />

                                    <g:sortableColumn property="extension" title="${g.message(code: 'document.extension.label', default: 'Extension')}" />

                                    <g:sortableColumn property="contentType" title="${g.message(code: 'document.contentType.label', default: 'Content Type')}" />
