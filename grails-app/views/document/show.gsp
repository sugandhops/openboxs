            ...
            <div class="box">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="document.filename.label" default="Filename" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="document.fileContents.label" default="File Contents" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="document.contentType.label" default="Content Type" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="document.fileUri.label" default="File Uri" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="document.documentNumber.label" default="Document Number" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="document.image.label" default="Image" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="document.size.label" default="Size" /></td>
