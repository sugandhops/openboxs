...
<head>
	...
	<title><g:message code="default.addDocument.label" /></title>
</head>
<body>
									...
									<div class="buttons">
										...
										<button type="submit" class="positive"><img
											src="${resource(dir:'images/icons/silk',file:'tick.png')}"
														alt="save" />${documentInstance?.id ? g.message(code:'default.button.save.label') : g.message(code:'default.button.upload.label')}</button>
