...
<g:applyLayout name="email">
    <div class="box">
        ...
        <div style="margin: 5px;">
            <div class="lead">
                ${g.message(code: 'email.userAccountCreated.message', args: [userInstance.username])}
            ...
            <table style="width:auto">
                ...
                <tr class="">
                    <td class="right" width="15%">
                        <label><g:message code="user.name.label" default="Name" /></label>
                    </td>
                    <td class="value">
                ...
                <tr class="">
                    <td class="name">
                        <label><g:message code="user.roles.label" default="Roles" /></label>
                    </td>
                    <td class="value">
                        ${userInstance?.roles}
                    </td>
