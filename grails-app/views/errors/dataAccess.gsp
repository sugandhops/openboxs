...
<head>
	...
	<g:set var="entityName" value="${g.message(code: 'errors.dataAccess.label', default: 'Data Access Error')}" />
	<title><g:message code="errors.dataAccess.label" default="Data Access Error"/></title>
	<content tag="title"><g:message code="dataAccess.label" default="Page Not Found"/></content>
...
<body>
	<div class="body">
        ...
        <div class="summary">
            <div class="title">
                <g:message code="errors.dataAccess.label" default="Data Access Error"/>
            </div>
        </div>

		<div style="width: 25%;">
			<div class="triangle-isosceles">
				<g:message code="errors.dataAccess.message" default="Apologies, but you just tried to do something unspeakable to the database."/>
			</div>
