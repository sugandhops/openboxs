    ...
    <body>
        <div class="body">
            ...
            <div class="list">
				...
				<div class="buttonBar">
                    <g:link class="button icon add" action="create"><g:message code="default.add.label" args="['eventType']"/></g:link>
            	</div>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <g:sortableColumn property="id" title="${g.message(code: 'eventType.id.label', default: 'Id')}" />

                                <g:sortableColumn property="name" title="${g.message(code: 'eventType.name.label', default: 'Name')}" />

                                <g:sortableColumn property="description" title="${g.message(code: 'eventType.description.label', default: 'Description')}" />

                                <g:sortableColumn property="sortOrder" title="${g.message(code: 'eventType.sortOrder.label', default: 'Sort Order')}" />

                                <g:sortableColumn property="eventCode" title="${g.message(code: 'eventType.eventCode.label', default: 'Event Status')}" />
