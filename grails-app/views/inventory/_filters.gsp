<div class="filters" >
	<g:form method="GET" controller="inventory" action="browse">
		...
		<div class="box">
			<h2><g:message code="inventory.filterByProduct.label"/></h2>
			<div class="filter-list-item">
				<g:textField name="searchTerms"
							 value="${commandInstance.searchTerms}"
							 placeholder="${g.message(code:'inventory.searchTerms.label')}"
			...
			<div class="filter-list-item">
				...
				<label for="showOutOfStockProducts">${g.message(code:'inventory.showOutOfStockProducts.label')}</label>
			</div>
			<div class="buttons">
