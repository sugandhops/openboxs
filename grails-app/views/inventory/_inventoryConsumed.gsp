<div class="box">
	...
	<g:form action="saveDebitTransaction">
		...
		<table>
            ...
            <tr class="prop">
				<td class="name">
					<label><g:message code="default.date.label"/></label>
				</td>
				<td class="value">
            ...
            <tr class="prop">
                <td class="name">
                    <label class="fade"><g:message code="transaction.destination.label"/></label>
                </td>
                <td class="value">
            ...
            <tr class="prop">
                <td class="name">
                    <label><g:message code="transaction.createdBy.label"/></label>
                </td>
                <td class="value">
            ...
            <tr class="prop">
                <td class="name">
                    <label class="fade"><g:message code="transaction.comment.label"/></label>
                </td>
                <td class="value">
                    <span class="value">
								...
								<g:unless test="${command?.binLocations}">
									<tr>
										<td colspan="10" class="center empty">
                                            <g:message code="inventory.noItemsCurrentlyInStock.message" />
										</td>
									</tr>
								</g:unless>
