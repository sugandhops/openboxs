...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'inventory.label', default: 'Inventory')}" />
        <title><g:message code="inventory.browse.label" default="Browse inventory"/></title>
    </head>
    <body>
        <div class="body">
                        ...
                        <div class="box">
							<h2>
								...
								<g:if test="${totalResults > 0 }">
									<g:message code="inventory.browseTab.label" args="[rangeBegin, rangeEnd, totalResults]"/>
								</g:if>
								<g:else>
									<g:message code="inventory.showingNoResults.label" default="Showing 0 results"/>
								</g:else>
...
%{--												</th>--}%
												...
												<tr>
													<td colspan="12" class="even center">
														<div class="fade empty">
                                                            <g:message code="inventory.searchNoMatch.message"
							...
							<g:if test="${commandInstance?.searchResults instanceof PaginatedList}">
								<div class="paginateButtons">
									...
									<div class="right">
										<g:message code="inventory.browseResultsPerPage.label"/>:
