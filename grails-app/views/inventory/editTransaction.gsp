...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'transaction.label', default: 'Transaction')}" />
        <title>
	        <g:if test="${transactionInstance?.id }">
		        <g:message code="default.edit.label" args="[entityName.toLowerCase()]" />
	    	</g:if>
	    	<g:else>
		        <g:message code="default.add.label" args="[entityName.toLowerCase()]" />
			</g:else>
		</title>
    </head>
    <body>
					...
					<div class="yui-u">
						<div class="tabs tabs-ui">
							...
							<div id="transaction-header" class="ui-tabs-hide">
								...
								<div class="box">
									<h2>${g.message(code: 'transaction.details.label')}</h2>
											...
											<tbody>
												<tr class="prop">
													...
													<td class="value">
														...
														<g:else>
															<span class="fade">
																<g:message code="transaction.new.label"/>
															</span>
														</g:else>
													</td>
												</tr>
												<tr class="prop">
													<td class="name">
														<label><g:message code="transaction.status.label"/></label>
													</td>
													<td class="value">
														<g:if test="${transactionInstance?.id }">
															<g:message code="enum.TransactionStatus.COMPLETE"/>
														</g:if>
														<g:else>
															<g:message code="enum.TransactionStatus.PENDING"/>
														</g:else>
													</td>
												</tr>
												<tr class="prop">
												...
												<tr class="prop">
													<td class="name">
														<label><g:message code="transaction.inventory.label"/></label>
													</td>
													<td class="value">
											...
											<table id="transaction-entries-table" border="0" style="margin: 0; padding: 0; border: 0px solid lightgrey; background-color: white;">
												<thead>
													<tr class="odd">
														...
														<th class="left"><g:message code="location.binLocation.label"/></th>
														<th class="left"><g:message code="inventoryItem.lotNumber.label"/></th>
													...
													<g:unless test="${transactionInstance?.transactionEntries }">
														<tr class="empty">
															<td colspan="7" style="text-align: center; display:none;" id="noItemsRow">
																<span class="fade"><g:message code="transaction.noItems.message"/></span>
															</td>
														</tr>
													</g:unless>
												</tbody>
