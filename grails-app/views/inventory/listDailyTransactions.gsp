...
<html>
    <head>
        ...
        <title><g:message code="transaction.dailyTransactions.label"/></title>
	...
	<body>
       <div class="body">
			...
			<fieldset>
				<div class="box">
					<h2><g:message code="transaction.dailyTransactionsFor.label"/> ${session.warehouse.name}
                                ...
                                <div class="list">
                                    <table class="scrollTable">
                                        <thead class="fixedHeader">
                                            <tr>
                                                <th class="odd"><g:message code="default.dates.label"/></th>
                                            </tr>
                                        </thead>
                            ...
                            <td class="left">
                                ...
                                <div class="list">
                                    <table>
                                        <thead>
                                            <tr class="odd">
                                                <th><g:message code="default.datetime.label"/></th>
                                                <th><g:message code="transaction.id.label"/></th>
                                                <th><g:message code="transaction.type.label"/></th>
                                                <th><g:message code="product.label"/></th>
                                                <th><g:message code="product.lotNumber.label"/></th>
