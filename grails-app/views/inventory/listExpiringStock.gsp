...
<html>
	...
	<body>
		<div class="body">
			...
			<div class="summary">
                <h3><g:message code="inventory.expiringStock.label"/></h3>
            </div>
				...
				<div class="yui-u first">
		            <g:form action="listExpiringStock" method="get">
						<div class="dialog box">
							...
							<div class="filter-list-item">
		           				<label><g:message code="inventory.expiresWithin.label"/></label>
				           		<g:select name="status" class="chzn-select-deselect"
									from="[
										    'within30Days':
                                                    g.message(code:'inventory.listExpiringStock.label', args: [30]),
										    'within90Days':
                                                    g.message(code:'inventory.listExpiringStock.label', args: [90]),
                                            'within180Days':
                                                    g.message(code:'inventory.listExpiringStock.label', args: [180]),
                                            'within365Days':
                                                    g.message(code:'inventory.listExpiringStock.label', args: [365]),
                                            'greaterThan365Days':
                                                    g.message(code:'inventory.listGreaterThan365Days.label',
				           	...
				           	<div class="filter-list-item right">
								<button name="filter" class="button icon search">
									<g:message code="default.button.filter.label"/> </button>
		   		...
		   		<div class="yui-u">
					...
					<div class="box">
                        <h2>
                            <g:message code="inventoryItems.expiring.label" default="Expiring inventory items"/> (${inventoryItems.size()} <g:message code="default.results.label" default="Results"/>)
                        </h2>
                        <div class="dialog">
                                            ...
                                            <tr>
                                                <td colspan="8">
                                                    <div class="padded center fade">
                                                        <g:message code="inventory.noExpiringStock.label" />
                                                    </div>
                                                </td>
                                            </tr>
                                        </g:unless>
