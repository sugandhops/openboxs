...
<html>
    <head>
        ...
        <title><g:message code="inventory.lowStock.label"/></title>    
    </head>    
					...
					<td>
						<div class="list box">
							<h2>
								...
								<g:message code="inventory.belowMinimumLevel.label"/>
							</h2>
							<table>
			                    <thead>
			                        <tr>   
			                        	<th><g:message code="category.label"/>
										<th width="55%"><g:message code="product.label"/></th>
										<th class="center" width="15%"><g:message code="default.qty.label"/></th>
										<th class="center" width="15%"><g:message code="inventoryLevel.minimumQuantity.label"/></th>
			                        </tr>
			                    </thead>
			       	           	<tbody>			
									...
									<g:unless test="${minimumProductsQuantityMap }">
										<tr>
											<td colspan="4" style="height: 60px;" class="center middle">
												...
												<span class="fade">
													<g:message code="inventory.noLowStockItems.label" default="No stocked out items"/>
												</span>
