					...
					<td>
						<div class="list box">
							<h2>
								...
								<g:message code="inventory.belowReorderLevel.label"/>
							</h2>
							<table>
			                    <thead>
			                        <tr>   
										...
										<th class="center" width="15%"><g:message code="inventory.reorderQuantity.label" default="Reorder quantity"/></th>
										<th class="center" width="15%"><g:message code="inventory.remainingQuantity.label" default="Remaining quantity "/></th>
			                        </tr>
			                    </thead>
			       	           	<tbody>			
