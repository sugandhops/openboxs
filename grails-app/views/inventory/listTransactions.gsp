...
<html>
    <head>
        ...
        <title><g:message code="transaction.list.label"/></title>
    </head>
       ...
       <div class="body">
			...
			<div class="yui-gf">
                        ...
                        <form>
                            ...
                            <div class="filter">
                                ...
                                <select id="transactionTypeSelect" name="transactionType.id" class="chzn-select-deselect">
                                    <option value="">
                                        <g:message code="transactionType.all.label"/>
                                    </option>
                            ...
                            <div class="filter">
                                <label>
                                    <g:message code="default.dateRange.label" default="Date Range"/>
                                </label>
                                <div>
                ...
                <div class="yui-u">
                    ...
                    <div class="box">
                        <h2><g:message code="default.showing.message" args="[transactionCount]"/></h2>
                        <table>
                            <thead>
                                <tr class="even">
                                    <th><g:message code="default.actions.label"/></th>
                                    <th><g:message code="default.count.label" default="Count"/></th>
                                    ...
                                    <th><g:message code="inventory.label"/></th>
                                    <th class="center">
                                        <g:message code="default.source.label"/> /
                                        <g:message code="default.destination.label"/>
                                    </th>
                                    <th class="center">
                                ...
                                <g:each var="transactionInstance" in="${transactionInstanceList}" status="i">
                                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        ...
                                        <td class="center">
                                            ...
                                            <g:else>
                                                <span class="fade">
                                                    <g:message code="default.na.label" default="Not applicable"/>
                                                </span>
                                            </g:else>
                                        ...
                                        <td class="center">
                                            ...
                                            <g:else>
                                                <span class="fade">
                                                    <g:message code="default.nobody.label" default="Nobody"/>
                                                </span>
                                            </g:else>
