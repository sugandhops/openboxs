                ...
                <div class="box">
                    ...
                    <g:form controller="inventory" action="search">
                        <div class="filters">
                            ...
                            <div class="filter-list-item">
                                <label>${g.message(code:'locations.label')}</label>
                                <div>
                    ...
                    <table class="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th class="border-right"><g:message code="product.uom.label"/></th>
