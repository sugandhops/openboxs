					...
					<tr>					
						<td>
							<label>
								...
								<g:message code="inventory.productsWithoutDefaultInventoryItem.label"/>
							</label>
							<div style="padding: 10px;">
								<g:message code="inventory.createDefaultInventoryItems.message"/>
								
								<g:link controller="inventory" action="createDefaultInventoryItems">
									<g:message code="inventory.createDefaultInventoryItems.label"/>
								</g:link>
							</div>
							<div class="list box">
								<table>
