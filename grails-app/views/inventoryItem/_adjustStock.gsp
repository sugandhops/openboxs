        ...
        <table>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">
                    ...
                    <g:else><span class="fade"><g:message code="default.none.label"/></span></g:else>
                </td>
            </tr>
            <tr class="prop">
            ...
            <tr class="prop">
                <td valign="top" class="name"><label><g:message code="inventory.previousQuantity.label" /></label></td>
                <td valign="top" class="value">
            ...
            <tr class="prop">
                <td valign="top" class="name"><label><g:message code="inventory.quantity.label" /></label></td>
                <td valign="top" class="value">
            ...
            <tr class="prop">
                <td valign="top" class="name"><label><g:message code="default.reasonCode.label" default="Reason Code"/></label></td>
                <td valign="top" class="">
