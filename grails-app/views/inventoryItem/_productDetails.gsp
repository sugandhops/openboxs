...
<div class="box">
    <h2>
        <g:message code="product.status.label" />
    </h2>
    <table>
        <tbody>
            <tr class="prop">
                <td class="label">
                    <label><g:message code="product.onHandQuantity.label"/></label>
                </td>
                <td class="value">
                    <div>
            ...
            <g:if test="${totalQuantityAvailableToPromise >= 0}">
                <tr class="prop">
                    <td class="label">
                        <label><g:message code="product.quantityAvailableToPromise.label" default="Quantity Available"/></label>
                    </td>
                    <td class="value">
                        <div>
            ...
            <g:if test="${grailsApplication.config.openboxes.forecasting.enabled}">
                <tr class="prop">
                    <td class="label">
                        <label><g:message code="forecasting.demand.label"/></label>
                    </td>
                ...
                <tr class="prop">
                    <td class="label">
                        <label><g:message code="forecasting.onHandMonths.label"/></label>
                    </td>
                ...
                <tr class="prop">
                    <td class="label">
                        <label><g:message code="forecasting.stockoutDays.label" default="Stockout Days (last 30 days)"/></label>
                    </td>
            ...
            <%--<g:set var="inventoryLevel" value="${productInstance?.getInventoryLevel(session?.g?.id)}"/>%>
            <g:if test="${inventoryLevel}">
                <g:if test="${inventoryLevel?.minQuantity}">
                    <tr class="prop">
                        <td class="label">
                            <label><g:message code="inventoryLevel.minQuantity.label"/></label>
                        </td>
                        <td class="value">
                ...
                <g:if test="${inventoryLevel?.forecastQuantity}">
                    <tr class="prop">
                        <td class="label">
                            <label><g:message code="inventoryLevel.forecastQuantity.label"/></label>
                        </td>
                ...
                <g:if test="${inventoryLevel?.maxQuantity}">
                    <tr class="prop">
                        <td class="label">
                            <label><g:message code="inventoryLevel.maxQuantity.label"/></label>
                        </td>
                        <td class="value">
                ...
                <g:if test="${inventoryLevel?.preferredBinLocation}">
                    <tr class="prop">
                        <td class="label">
                            <label><g:message code="product.preferredBin.label"/></label>
                        </td>
                        <td class="value middle">
                            ${inventoryLevel?.preferredBinLocation ?: g.message(code:'default.none.label')}
                        </td>
                    </tr>
                </g:if>
            </g:if>
            <%--<g:set var="latestInventoryDate"
               value="${productInstance?.latestInventoryDate(session?.g?.id)}" />--%>

            <tr class="prop">
                <td class="label">
                    <label><g:message code="product.latestInventoryDate.label"/></label>
                </td>
                <td class="value">
                    <span class="">
                        ...
                        <g:else>
                            <p class="fade"><g:message code="default.never.label" /></p>
                        </g:else>
                    </span>
                </td>
            </tr>
            ...
            <tr class="prop">
                <td class="label">
                    <label><g:message code="product.pricePerUnit.label"/></label>
                </td>
                <td class="value middle">
            ...
            <tr class="prop">
                <td class="label">
                    <label><g:message code="product.totalValue.label"/></label>
                </td>
                <td class="value middle">
                    <g:hasRoleFinance onAccessDenied="${g.message(code:'errors.blurred.message', args: [g.message(code:'default.none.label')])}">
...
<div class="box">
    ...
    <table>
        <tbody>
            ...
            <tr class="prop">
                <td class="label left">
                    <label><g:message code="product.productFamily.label"/></label>
                </td>
                <td class="value">
            ...
            <g:if test="${productInstance?.glAccount}">
                <tr class="prop">
                    <td class="label">
                        <label><g:message code="product.glCode.label"/></label>
                    </td>
                    <td class="value middle">
            ...
            <tr class="prop">
                <td class="label">
                    <label>${g.message(code: 'product.description.label') }</label>
                </td>
                <td class="value">
            ...
            <g:if test="${inventoryLevel?.abcClass || productInstance?.abcClass}">
                <tr class="prop">
                    <td class="label">
                        <label><g:message code="product.abcClass.label"/></label>
                    </td>
                    <td class="value middle">
...
<div class="box">
    <h2>
        ${g.message(code: 'default.auditing.label') }
    </h2>
    <table>
        <tbody>
            <tr class="prop">
                <td class="label">
                    <label><g:message code="product.createdBy.label"/></label>
                </td>
                <td class="value">
                    <span class="fade">${productInstance?.createdBy?.name?:g.message(code: 'default.unknown.label') }</span> <br/>
                </td>
            </tr>
            <tr class="prop">
                <td class="label">
                    <label><g:message code="product.modifiedBy.label"/></label>
                </td>
                <td class="value">
                    <span class="fade">${productInstance?.updatedBy?.name?:g.message(code: 'default.unknown.label') }</span> <br/>
                </td>
            </tr>
            <tr class="prop">
                <td class="label">
                    <label><g:message code="product.createdOn.label"/></label>
                </td>
                <td class="value">
                    <span class="fade">
            ...
            <tr class="prop">
                <td class="label"  >
                    <label><g:message code="product.modifiedOn.label"/></label>
                </td>
                <td class="value">
                    <span class="fade">
