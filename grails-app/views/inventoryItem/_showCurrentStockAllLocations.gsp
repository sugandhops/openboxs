        ...
        <div>
            ...
            <div class="download-button">
                <g:link controller="inventoryItem" action="showCurrentStockAllLocations" params="[download:true]" id="${commandInstance.product.id}" class="button">
                    ...
                    ${g.message(code: 'inventory.exportExcel.label', default: 'Export to Excel')}
                </g:link>
            </div>
        </div>
    </h2>
            ...
            <tr>
                <td colspan="5">
                    <div class="empty center fade">
                        <g:message code="inventory.quantityOnHand.unavailable.label" default="No quantity on hand at any locations."/>
                    </div>
                </td>
