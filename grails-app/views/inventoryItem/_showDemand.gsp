...
<div id="demand-table">
    ...
    <g:formRemote name="demand" onLoading="showLoading()" onComplete="hideLoading()"
        ...
        <div class="date-picker-width filters-container">
            <label class="name"><g:message code="consumption.startDate.label"/></label>
            <g:jqueryDatePicker id="startDate" name="startDate" value="${params.startDate}" class="text middle" size="12" format="dd/MMM/yyyy" />

            <label class="name" style="margin-left: 10px;"><g:message code="consumption.endDate.label"/></label>
            <g:jqueryDatePicker id="endDate" name="endDate" value="${params.endDate}" class="text middle" size="12" format="dd/MMM/yyyy" />

            <label for="destination.id" style="margin-left: 10px;"><g:message code="requisition.destination.label" default="Destination Location" /></label>
    ...
    <div class="box">
        <h2>
            <g:message code="forecasting.demand.label" default="Demand"/>
        </h2>
        <table id="data">
            <thead>
                <tr class="header odd">
                    <th><g:message code="requisition.monthIssued.label" default="Month issued"/></th>
                    <th class="center middle"><g:message code="requisitionItem.quantityRequested.label"/></th>
                    <th class="center middle"><g:message code="requisitionItem.quantityIssued.label" default="Issued"/></th>
                    <th class="center middle"><g:message code="requisitionItem.quantityDemand.label" default="Demand"/></th>
                </tr>
            </thead>
            <tbody>
                        ...
                        <tr class="prop data fade">
                            <td colspan="5">
                                <div class="box">
                                    <table>
                                        <tr>
                                            <th><g:message code="requisition.requestNumber.label"/></th>
                                            <th><g:message code="requisition.dateRequested.label"/></th>
                                            <th><g:message code="requisition.dateIssued.label"/></th>
                                            <th><g:message code="requisition.destination.label"/></th>
                                            <th class="center middle"><g:message code="requisitionItem.quantityRequested.label"/></th>
                                            <th class="center middle"><g:message code="requisitionItem.quantityIssued.label" default="Issued"/></th>
            ...
            <tfoot>
                <tr>
                    <th><g:message code="default.monthly.label" default="Monthly"/></th>
                ...
                <tr>
                    <th><g:message code="default.total.label" default="Total"/></th>
