<div class="box">
    <h2><g:message code="product.associations.label"/></h2>
    <table >
        <thead>
            <tr class="odd">
                ...
                <th class="center middle" >
                    <g:message code="product.quantityAvailableToPromise.label"/>
                </th>
                <th class="center middle" >
                    <g:message code="productAssociation.comments.label"/>
                </th>
            </tr>
        </thead>
