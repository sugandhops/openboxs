    ...
    <g:form action="saveRecordInventory2" autocomplete="off">
        ...
        <div class="form-content box">
            ...
            <div class="middle left" style="padding: 10px 0 10px 0;">
                <label><g:message code="inventory.inventoryDate.label"/></label>
                <g:jqueryDatePicker
                        id="transactionDate"
            ...
            <table id="inventoryItemsTable">
                ...
                <tr>
                    ...
                    <th class="left"><g:message code="inventory.oldQty.label"/></th>
                    <th class="left"><g:message code="inventory.newQty.label"/></th>
                    <th class="left"><g:message code="default.actions.label"/></th>
                </tr>
                </thead>
        ...
        <div class="center buttons">
            ...
            <g:link controller="inventoryItem" action="showStockCard"
                    params="['product.id':commandInstance.product?.id]" class="negative"><g:message code="default.button.cancel.label"/></g:link>
