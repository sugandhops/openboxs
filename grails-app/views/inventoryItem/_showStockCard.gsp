    ...
    <div id="transactionLogTabs" class="tabs" data-moreBtn="${g.message(code: 'default.more.label', default: 'More')}">
		<ul class="-primary">
            <li><a href="${request.contextPath}/inventoryItem/showCurrentStock/${commandInstance?.product?.id}"
                   id="current-stock-tab"><g:message code="inventory.listInStock.label" default="In stock"/></a>
            </li>
			<li><a href="${request.contextPath}/inventoryItem/showStockHistory/${commandInstance?.product?.id}"><g:message code="inventory.stockHistory.label"/></a></li>
            <li><a href="${request.contextPath}/inventoryItem/showCurrentStockAllLocations/${commandInstance?.product?.id}"><g:message code="locations.all.label" default="All Locations"/></a></li>
			<li><a href="${request.contextPath}/inventoryItem/showSuppliers/${commandInstance?.product?.id}"><g:message code="product.productSuppliers.label" default="Product Sources"/></a></li>
			<li><a href="${request.contextPath}/inventoryItem/showAssociatedProducts/${commandInstance?.product?.id}"><g:message code="productAssociations.label" default="Product Associations"/></a></li>
			<li><a href="${request.contextPath}/inventoryItem/showPendingInbound/${commandInstance?.product?.id}"><g:message code="stockCard.pendingInbound.label" default="Pending Inbound"/></a></li>
			<li><a id="showPendingOutboundTabLink" href="${request.contextPath}/inventoryItem/showPendingOutbound/${commandInstance?.product?.id}"><g:message code="stockCard.pendingOutbound.label" default="Pending Outbound"/></a></li>
            <li><a href="${request.contextPath}/inventoryItem/showDemand/${commandInstance?.product?.id}"><g:message code="forecasting.demand.label" default="Demand"/></a></li>
            <li><a href="${request.contextPath}/inventoryItem/showInventorySnapshot/${commandInstance?.product?.id}"><g:message code="inventory.snapshot.label" default="Snapshot"/></a></li>
            <li><a href="${request.contextPath}/inventoryItem/showDocuments/${commandInstance?.product?.id}"><g:message code="document.documents.label" default="Documents"/></a></li>
		</ul>
	</div>
</g:if>
