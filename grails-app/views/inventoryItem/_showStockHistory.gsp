    ...
    <h2>
        <div>
            ...
            <div class="showAll button">
                ${g.message(code: 'default.showAll.label')}
            </div>
        </div>
    </h2>
    <input
    ...
    <table id="stockHistoryTable" class="stockHistory">
        <thead>
            <tr class="odd">
                ...
                <th>
                    ${g.message(code: 'default.origin.label', default: "Origin")}&nbsp;/&nbsp;
                ...
                <th class="border-right center" width="7%">
                    ${g.message(code: 'default.count.label', default: 'Count')}
                </th>
                <th class="border-right center" width="7%">
                    ${g.message(code: 'default.credit.label', default: 'Credit')}
                </th>
                <th class="border-right center" width="7%">
                    ${g.message(code: 'default.debit.label', default: 'Debit')}
                </th>
                <th class="center" width="7%">
                    ${g.message(code: 'report.quantityBalance.label', default: 'Balance')}
                </th>
            </tr>
        </thead>
        <tbody>
                ...
                <tr class="yearRow border-top">
                    ...
                    <td colspan="14" class="icon ${isCurrentYear ? 'active' : ''}">
                        ...
                        <button class="showYear button">
                            ${g.message(code: 'default.showYear.label')}
                        </button>
                    </td>
                    </div>
                </tr>
                <g:each var="month" in="${year.value}">
                    ...
                    <g:each var="stockHistoryEntry" in="${month.value}">
                        ...
                        <tr class="${rowClass} monthRow dataRow ${isCurrentYear ? 'currentYear' : ''} ${stockHistoryEntry?.inventoryItem?.lotStatus == LotStatusCode.RECALLED ? 'recalled' : ''}"
                            title="${stockHistoryEntry?.inventoryItem?.lotStatus == LotStatusCode.RECALLED ? g.message(code: 'inventoryItem.recalledLot.label') : ''}">
                            <td  class="middle">
