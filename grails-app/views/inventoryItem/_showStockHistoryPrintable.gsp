    ...
    <table>
        ...
        <tbody style="margin: 0; padding: 0;">
            <td class="noBorder">
                <h2>
                    <div>
                        <g:message code="inventory.stockHistory.label"/>
                        <div class="print-history">
                            <g:link controller="inventoryItem" action="showStockHistory" params="[print:true]" id="${commandInstance.product.id}" class="button">
                                ...
                                ${g.message(code: 'inventory.exportPdf.label', default: 'Export to PDF')}
                            </g:link>
                        </div>
                    </div>
                </h2>
                <table class="stockHistory">
                    ...
                    <tr class="odd">
                        ...
                        <th>
                            ${g.message(code: 'default.time.label')}
                        </th>
                        <th>
                            ${g.message(code: 'default.createdBy.label')}
                        </th>
                        <th>
                            ${g.message(code: 'transaction.label')}
                        </th>
                        <th>
                            ${g.message(code: 'default.originOrDestination.label', default: "Origin / Destination")}
                        </th>
                        <th class="border-right">
                            ${g.message(code: 'default.reference.label')}
                        </th>
                        ...
                        <th class="border-right center" width="7%">
                            ${g.message(code: 'transaction.count.label', default: 'Count')}
                        </th>
                        <th class="border-right center" width="7%">
                            ${g.message(code: 'transaction.credit.label', default: 'Credit')}
                        </th>
                        <th class="border-right center" width="7%">
                            ${g.message(code: 'transaction.debit.label', default: 'Debit')}
                        </th>
                        <th class="center" width="7%">
                            ${g.message(code: 'stockCard.balance.label', default: 'Balance')}
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="${rowClass}">
                            <td  class="middle">
                                <g:if test="${stockHistoryEntry?.showDetails}">
                                    ...
                                    <g:elseif test="${stockHistoryEntry?.transaction?.transactionType?.transactionCode== org.pih.g.inventory.TransactionCode.DEBIT}">
                                    ...
                                    <g:elseif test="${stockHistoryEntry?.transaction?.transactionType?.transactionCode== org.pih.g.inventory.TransactionCode.CREDIT}">
                                    ...
                                    <g:elseif test="${stockHistoryEntry?.transaction?.transactionType?.transactionCode== org.pih.g.inventory.TransactionCode.INVENTORY}">
                                    ...
                                    <g:elseif test="${stockHistoryEntry?.transaction?.transactionType?.transactionCode== org.pih.g.inventory.TransactionCode.PRODUCT_INVENTORY}">
                    ...
                    <tr class="odd">
                        <th colspan="7" class="left border-right">
                            <g:message code="stockCard.totals.label" default="Totals"/>
                        </th>
