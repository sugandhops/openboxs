...
<div class="box">
    <h2>
        <div>
            <g:message code="product.productSuppliers.label" default="Product Sources"/>
    ...
    <div class="dialog">
        <table>
            <thead>
            <g:sortableColumn property="code" title="${g.message(code: 'productSupplier.code.label', default: 'Code')}" />
