<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'inventory.level.label', default: 'Inventory Level')}" />
			...
			<div class="dialog">
				<g:form action="updateInventoryLevel">
					...
					<fieldset>
						...
						<table>
							<tr class="prop">
								<td class="name"><label><g:message code="inventory.label"/></label></td>
								<td class="value">
									${inventoryInstance?.warehouse?.name }
								</td>
							</tr>
							<tr class="prop">
								<td class="name"><label><g:message code="product.label"/></label></td>
								<td class="value">
									<format:product product="${productInstance}" />
								</td>
							</tr>
							<tr class="prop">
								<td class="name"><label><g:message code="inventoryLevel.status.label"/></label></td>
								<td class="value">
						           	<g:select name="status"
		           					   ...
		           					   noSelection="['':g.message(code:'inventoryLevel.chooseStatus.label')]" />&nbsp;&nbsp;
							...
							<tr class="prop">
								...
								<td>
									...
									<button type="submit" class="positive"><img
										...
										alt="Save" /> ${g.message(code: 'default.button.save.label', default: 'Save')}
									</button>
									&nbsp;
