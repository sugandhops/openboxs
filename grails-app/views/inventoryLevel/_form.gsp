            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="product.id"><g:message code="inventoryLevel.status.label" default="Status" /></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: inventoryLevelInstance, field: 'product', 'errors')}">
                        <g:select name="status"
                                  ...
                                  noSelection="['null':g.message(code:'inventoryLevel.chooseStatus.label',default:'Choose status')]" />
                    </td>
                </tr>
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="product.id"><g:message code="product.label" /></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: inventoryLevelInstance, field: 'product', 'errors')}">
                        <g:if test="${!productInstance}">
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="location.id"><g:message code="location.label" /></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="internalLocation"><g:message code="location.binLocation.label" default="Bin Location"/></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="abcClass"><g:message code="inventoryLevel.abcClass.label" default="ABC Analysis Class" /></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="comments"><g:message code="inventoryLevel.comments.label" default="Comments" /></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="minQuantity">
                            <g:message code="inventoryLevel.minQuantity.label" default="Min Quantity" />
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="reorderQuantity">
                            <g:message code="inventoryLevel.reorderQuantity.label" default="Reorder Quantity" />
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="maxQuantity">
                            <g:message code="inventoryLevel.maximumQuantity.label" default="Max Quantity" />
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="expectedLeadTimeDays">
                            <g:message code="inventoryLevel.expectedLeadTimeDays.label" default="Expected Lead Time Days"/>
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="expectedOrderPeriodDays">
                            <g:message code="inventoryLevel.replenishmentPeriodDays.label" default="Replenishment Period Days"/>
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="replenishmentLocation">
                            <g:message code="inventoryLevel.replenishmentLocation.label" default="Default Replenishment Source"/>
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="preferredBinLocation">
                            <g:message code="inventoryLevel.preferredBinLocation.label" default="Default Putaway Location"/>
                        </label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: inventoryLevelInstance, field: 'binLocation', 'errors')}">
        ...
        <div id="tabs-4">
            <table>
                <tbody>
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="forecastQuantity"><g:message code="inventoryLevel.forecastQuantity.label" default="Forecast Quantity" /></label>
                        </td>
                        <td valign="top" class="value ${hasErrors(bean: inventoryLevelInstance, field: 'forecastQuantity', 'errors')}">
                            ...
                            ${inventoryLevelInstance?.product?.unitOfMeasure?:g.message(code:'default.each.label')}
                        </td>
                    </tr>
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="forecastPeriodDays"><g:message code="inventoryLevel.forecastPeriodDays.label" /></label>
                        </td>
                        <td valign="top" class="value ${hasErrors(bean: inventoryLevelInstance, field: 'forecastPeriodDays', 'errors')}">
                            ...
                            ${g.message(code:'default.days.label')}
                        </td>
                    </tr>
                </tbody>
            </table>
