...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'inventoryLevel.label', default: 'InventoryLevel')}" />
            ...
            <div>
				...
				<div class="buttonBar">
                    <g:link action="list" class="button">
                       ...
                       <g:message code="default.list.label" default="List" args="[g.message(code: 'inventoryLevels.label')]"/>
                    </g:link>
                    <g:link action="create" class="button">
                        <img src="${resource(dir: 'images/icons/silk', file: 'add.png')}" />&nbsp;
                        <g:message code="default.add.label" default="Add" args="[g.message(code: 'inventoryLevel.label')]"/>
                    </g:link>
                ...
                <div class="yui-gf">
                    ...
                    <div class="yui-u">
                        ...
                        <div class="box">
                            <h2><g:message code="results.label" default="Results"/></h2>

                            <table>
                                <thead>
                                    <tr>

                                        <g:sortableColumn property="status" title="${g.message(code: 'inventoryLevel.status.label', default: 'Status')}" />

                                        <th><g:message code="product.productCode.label" default="Product Code" /></th>

                                        <th><g:message code="product.label" default="Product" /></th>

                                        <g:sortableColumn property="inventory" title="${g.message(code: 'inventoryLevel.inventory.label', default: 'Inventory')}" />

                                        <g:sortableColumn property="minQuantity" title="${g.message(code: 'inventoryLevel.minQuantity.label', default: 'Min Quantity')}" />

                                        <g:sortableColumn property="reorderQuantity" title="${g.message(code: 'inventoryLevel.reorderQuantity.label', default: 'Reorder Quantity')}" />

                                        <g:sortableColumn property="maxQuantity" title="${g.message(code: 'inventoryLevel.maxQuantity.label', default: 'Max Quantity')}" />

                                        <g:sortableColumn property="dateCreated" title="${g.message(code: 'inventoryLevel.dateCreated.label', default: 'Date Created')}" />
