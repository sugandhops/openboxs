<form role="form" controlle="inventorySnapshot" action="index" class="form-search">
    ...
    <div class="form-group">
        <label><i class="icon icon-map-marker"></i> <g:message code="default.location.label" default="Location"/></label>
        <div>
    ...
    <div class="form-group">
        <label><i class="icon icon-calendar"></i> <g:message code="default.date.label" default="Date"/></label>
        <div>
