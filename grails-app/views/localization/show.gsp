            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="localization.code.label" default="Code" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="localization.locale.label" default="Locale" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="localization.text.label" default="Text" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="localization.dateCreated.label" default="Date Created" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="localization.lastUpdated.label" default="Last Updated" /></td>
