...
<head>
    ...
    <g:set var="entityName"
           value="${g.message(code: 'larehouse.label', default: 'Location')}"/>
        ...
        <div class="dialog">
            <div id="location-tabs" class="tabs">
                <ul>
                    ...
                    <g:else>
                        <li><a href="${request.contextPath}/location/showContents/${locationInstance?.id}"><g:message
                ...
                <div id="location-details-tab">
                    <div class="box">
                        <h2>
                            ...
                            <g:message code="location.details.label" default="Details"/>
                        </h2>
                        <table>
                            <tbody>
                            <g:if test="${locationInstance?.id}">
                                <tr class="prop">
                                    <td valign="top" class="name">
                                        <label for="name"><g:message code="default.id.label"/></label>
                                    </td>
                                    <td valign="top"
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="location.name.label"
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="locationNumber"><g:message
                            ...
                            <g:if test="${!locationInstance?.isInternalLocation() && !locationInstance.isZoneLocation()}">
                                ...
                                <tr class="prop">
                                    <td valign="top" class="name">
                                        <label for="manager.id"><g:message
                ...
                <div id="location-configuration-tab">
                    <div class="box">
                        <h2>
                            ...
                            <g:message code="default.configuration.label" default="Configuration"/>
                        </h2>
                        <table>
                            <tbody>
                            <tr class="prop">
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">
                        ...
                        <g:select name="locationType.id" from="${binLocationTypes}"
                                  ...
                                  optionKey="id" optionValue="${{ it }}"
                                  noSelection="['null': '']"/>
                    </td>
                </tr>
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="name"><g:message code="location.name.label"/></label>
                    </td>
                    <td valign="top"
                        class="value ${hasErrors(bean: locationInstance, field: 'name', 'errors')}">
