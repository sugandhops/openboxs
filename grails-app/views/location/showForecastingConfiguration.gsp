            ...
            <tbody>
                <tr class="prop">
                    <td valign="top" class="name">
                        <label>
                            <g:message code="location.expectedLeadTimeDays.label" default="Expected Lead Time Days"/>
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label>
                            <g:message code="location.replenishmentPeriodDays.label" default="Replenishment Period Days"/>
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label>
                            <g:message code="location.demandTimePeriodDays.label" default="Demand Time Period Days"/>
                        </label>
                    </td>
            ...
            <tr>
                ...
                <td>
                    <div class="buttons left">
                        <g:actionSubmit class="button icon approve" action="updateForecastingConfiguration" value="${g.message(code: 'default.button.save.label', default: 'Save')}" />
                        &nbsp;
                        <g:link action="list">
