    ...
    <body>
        <div class="body">
            ...
            <div class="button-bar">
                ...
                <g:link class="button" action="create"><g:message code="default.add.label" args="[entityName]"/></g:link>
            </div>
                ...
                <div class="dialog box">
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="address.address.label" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="address.address2.label" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="address.city.label" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="address.stateOrProvince.label" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="address.postalCode.label" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="address.country.label" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="address.description.label" /></label>
                                </td>
