...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'locationGroups.label', default: 'Location Groups')}" />
                ...
                <table>
                    <thead>
                        <tr>      
                            ...
                            <g:sortableColumn property="description" title="${g.message(code: 'default.description.label')}" class="bottom"/>
                            <g:sortableColumn property="locations" title="${g.message(code: 'locations.label')}" class="bottom"/>
                        </tr>
                    </thead>
                    <tbody>
