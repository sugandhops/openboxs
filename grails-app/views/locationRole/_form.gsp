<g:form method="post" controller="user" autocomplete="off">
    ...
    <table>
        <tbody>
            <g:if test="${locationRoleInstance?.id}">
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="id"><g:message code="default.id.label" /></label>
                    </td>
            ...
            <tr class="prop">
                <td valign="top" class="name">
                    <label for="user.id"><g:message code="locationRole.user.label" default="User" /></label>
                </td>
            ...
            <tr class="prop">
                <td valign="top" class="name">
                    <label for="location.id"><g:message code="locationRole.location.label" default="Location" /></label>
                </td>
            ...
            <tr class="prop">
                <td valign="top" class="name">
                    <label for="role.id"><g:message code="locationRole.role.label" default="Role" /></label>
                </td>
            ...
            <tr class="prop">
                ...
                <td valign="top">
                    <div class="buttons left">
                        <g:actionSubmit class="button" action="saveLocationRole" value="${g.message(code: 'default.button.save.label', default: 'Save')}" />
                        <g:if test="${locationRoleInstance.id}">
                            <g:actionSubmit class="button" action="deleteLocationRole" value="${g.message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${g.message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
                        </g:if>
                    </div>
                </td>
            </tr>
