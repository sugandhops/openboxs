        ...
        <div class="body">
            ...
            <div class="button-bar">
                <g:link class="button icon search" action="list" controller="locationType">
                    <g:message code="default.list.label" args="[g.message(code: 'locationTypes.label')]" />
                </g:link>
            </div>
					...
					<table>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="locationTypeCode"><g:message code="locationTypeCode.label" default="Location Type Code" /></label>
                            </td>
						...
						<tr class="prop">
							...
							<td valign="top" class="value ${hasErrors(bean: locationTypeInstance, field: 'supportedActivities', 'errors')}">
								...
								<select name="supportedActivities" multiple="true"  style="width: 100%">
						...
						<tr class="prop">
							<td valign="top" class="name">
								<label for="sortOrder"><g:message code="default.sortOrder.label" /></label>
							</td>
