...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'locationType.label', default: 'LocationType')}" />
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="locationType.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="locationType.name.label" default="Name" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="locationType.description.label" default="Description" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="locationType.sortOrder.label" default="Sort Order" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="locationType.dateCreated.label" default="Date Created" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="locationType.lastUpdated.label" default="Last Updated" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="locationType.supportedActivities.label" default="Supported Activities" /></td>
