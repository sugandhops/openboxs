...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'orderAdjustmentType.label', default: 'Order Adjustment Type')}" />
        ...
        <div class="body">
			...
			<div class="button-bar">
				<g:link class="button" action="list">
					...
					<g:message code="default.list.label" args="['Order Adjustment Type']"/>
				</g:link>
				<g:link class="button" action="create">
                	<img src="${resource(dir: 'images/icons/silk', file: 'add.png')}" />&nbsp;
					<g:message code="default.add.label" args="['Order Adjustment Type']"/>
				</g:link>
			</div>
						...
						<tbody>
							...
							<tr class="prop">
								<td valign="middle" class="name">
									<label for="name">
										<g:message code="orderAdjustmentType.name.label" default="Name" />
									</label>
								</td>
							...
							<tr class="prop">
								<td valign="middle" class="name">
									<label for="description">
										<g:message code="orderAdjustmentType.description.label" default="Description" />
									</label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="code">
										<g:message code="orderAdjustmentType.code.label" default="Order Adjustment Type Code" />
									</label>
								</td>
							...
							<tr class="prop">
								<td class="name middle">
									<label id="glAccountLabel" for="glAccount.id">
										<g:message code="orderAdjustmentType.glAccount.label" default="GL Account"/>
									</label>
								</td>
