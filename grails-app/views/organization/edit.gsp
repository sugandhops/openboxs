    ...
    <body>
						...
						<tbody>
							<tr class="prop">
								<td valign="top" class="name">
									<label for="active"><g:message code="user.active.label" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
								  <label for="organization.id"><g:message code="default.id.label" default="ID" /></label>
								</td>
							...
							<tr class="prop">
								...
								<td valign="top" class="value ${hasErrors(bean: organizationInstance, field: 'roles', 'errors')}">
									...
									<g:link controller="partyRole" action="create" params="['party.id': organizationInstance?.id]">${g.message(code: 'default.add.label', args: [g.message(code: 'partyRole.label', default: 'PartyRole')])}</g:link>
								</td>
							</tr>
							<tr class="prop">
								<td valign="top" class="name">
								  <label for="partyType.id"><g:message code="organization.partyType.label" default="Party Type" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="defaultLocation"><g:message code="organization.defaultLocation.label" default="Default Location" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
								  	<label for="sequencesReadOnly"><g:message code="organization.sequences.label" default="Sequences" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
								  	<label for="description"><g:message code="organization.maxPurchaseOrderNumber.label" default="Last PO Number" /></label>
								</td>
								<td valign="top" class="value ${hasErrors(bean: organizationInstance, field: 'description', 'errors')}">
		...
		<script type="text/javascript">
			function validateForm()  {
				...
				return confirm('${g.message(code:'organization.confirm.inactive.message')}')
			}
		</script>
    </body>
</html>
