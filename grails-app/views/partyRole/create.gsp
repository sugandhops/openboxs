        ...
        <div class="body">
			...
			<div class="button-bar">
				<g:link class="button" action="list">
					...
					<g:message code="default.list.label" args="['partyRole']"/>
				</g:link>
				<g:link class="button" action="create">
					<img src="${resource(dir: 'images/icons/silk', file: 'add.png')}" />&nbsp;
					<g:message code="default.add.label" args="['partyRole']"/>
				</g:link>
			</div>
						...
						<tbody>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="party.id"><g:message code="partyRole.party.label" default="Party" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="roleType"><g:message code="partyRole.roleType.label" default="Role Type" /></label>
								</td>
