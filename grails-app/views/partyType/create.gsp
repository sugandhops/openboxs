						...
						<tbody>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="code"><g:message code="default.code.label" default="code" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="name"><g:message code="partyType.name.label" default="Name" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="description"><g:message code="partyType.description.label" default="Description" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="partyTypeCode"><g:message code="partyType.partyTypeCode.label" default="Party Type Code" /></label>
								</td>
