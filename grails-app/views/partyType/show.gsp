            ...
            <div class="box">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="partyType.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="partyType.name.label" default="Name" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="partyType.description.label" default="Description" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="partyType.dateCreated.label" default="Date Created" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="partyType.lastUpdated.label" default="Last Updated" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="partyType.partyTypeCode.label" default="Party Type Code" /></td>
