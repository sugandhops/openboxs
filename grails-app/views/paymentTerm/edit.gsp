                        ...
                        <tbody>
                            <tr class="prop">
                                <td valign="middle" class="name">
                                    <label><g:message code="default.code.label" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="middle" class="name">
                                    <label><g:message code="paymentTerm.prepaymentPercent.label" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="middle" class="name">
                                    <label><g:message code="paymentTerm.daysToPayment.label" /></label>
                                </td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top left">
                                <div class="buttons left">
                                    <g:actionSubmit class="button" action="save" value="${g.message(code: 'default.button.update.label', default: 'Update')}" />
                                    <g:actionSubmit class="button" action="delete" value="${g.message(code: 'default.button.delete.label', default: 'Delete')}"
                                        onclick="return confirm('${g.message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
                                    <g:link class="button" action="list">${g.message(code: 'default.button.cancel.label', default: 'Cancel')}</g:link>
                                </div>
                            </td>
                        </tr>
                        </tfoot>
