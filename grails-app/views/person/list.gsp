                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <g:sortableColumn property="lastName" title="${g.message(code: 'default.name.label')}" />

                                <g:sortableColumn property="type" title="${g.message(code: 'person.type.label')}" />

                                <g:sortableColumn property="email" title="${g.message(code: 'person.email.label')}" />

                                <g:sortableColumn property="phoneNumber" title="${g.message(code: 'person.phoneNumber.label')}" />
                            ...
                            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                ...
                                <td>
                                    <g:if test="${personInstance?.active }">
                                        <span class="active"><g:message code="default.yes.label"/></span></g:if>
                                    <g:else><span class="inactive"><g:message code="default.no.label"/></span></g:else>
                                </td>
                                ...
                                <td>
                                    ${g.message(code: (personInstance.class.simpleName.toLowerCase() + '.label'))}
                                </td>
