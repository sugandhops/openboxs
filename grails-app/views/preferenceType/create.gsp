...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'preferenceType.label', default: 'Preference Type')}" />
        ...
        <div class="body">
			...
			<div class="button-bar">
				<g:link class="button" action="list">
					...
					<g:message code="default.list.label" args="['Preference Type']"/>
				</g:link>
				<g:link class="button" action="create">
                	<img src="${resource(dir: 'images/icons/silk', file: 'add.png')}" />&nbsp;
					<g:message code="default.add.label" args="['Preference Type']"/>
				</g:link>
			</div>
						...
						<tbody>
							...
							<tr class="prop">
								<td valign="middle" class="name">
									<label for="name"><g:message code="preferenceType.name.label" default="Name" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="validationCode"><g:message code="preferenceType.validationCode.label" default="Validation Code" /></label>
								</td>
