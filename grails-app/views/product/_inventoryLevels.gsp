...
<g:form controller="product" action="updateInventoryLevels">
    <div class="box">
        ...
        <h2>
            <g:message code="product.stockLevels.label" default="Stock levels"/>
        </h2>
        <table>
            <thead>
            <tr class="odd">
                ...
                <th class="center"><g:message code="inventoryLevel.abcClass.label" default="ABC Class"/></th>
                <th class="center"><g:message code="inventoryLevel.preferredBinLocation.label" default="Putaway Location"/></th>
                <th class="center border-right"><g:message code="inventoryLevel.replenishmentLocation.label" default="Replenishment Location"/></th>
                <th class="center"><g:message code="default.minimum.label" default="Minimum"/></th>
                <th class="center"><g:message code="default.reorder.label" default="Reorder"/></th>
                <th class="center border-right"><g:message code="default.maximum.label" default="Maximum"/></th>
                <th class="center"><g:message code="inventoryLevel.forecastQuantity.label"/></th>
                <th class="center border-right"><g:message code="inventoryLevel.forecastPeriodDays.label"/></th>
                <th class="center"><g:message code="default.comments.label"/></th>
                <th class="center"><g:message code="default.lastUpdated.label"/></th>
            ...
            <g:each var="inventoryLevelInstance" in="${productInstance?.inventoryLevels.sort { it?.inventory?.warehouse?.name }}" status="i">
                ...
                <tr class="prop ${i%2?'even':'odd'}">
                    ...
                    <td class="center middle">
                        ...
                        ${productInstance?.unitOfMeasure?:g.message(code:'default.each.label')}
                    </td>
                    <td class="center middle">
                    ...
                    <td>
                        <a href="javascript:void(0);" class="button btn-show-dialog"  data-width="900" data-height="500"
                           data-title="${g.message(code:'inventoryLevel.edit.label', default: 'Edit stock level')}"
                           data-url="${request.contextPath}/inventoryLevel/dialog/${inventoryLevelInstance?.id}">
                            <img src="${resource(dir:'images/icons/silk', file: 'pencil.png')}"/>&nbsp;
                            ${g.message(code:'default.button.edit.label')}</a>
                    </td>
                </tr>
            </g:each>
                ...
                <tr>
                    <td colspan="12" class="center">
                        <div class="empty center">
                            <g:message code="product.hasNoInventoryLevels.label" default="There are no stock levels"/>
                        </div>
                    </td>
                </tr>
            </g:unless>
            ...
            <tr class="prop">
                <td colspan="14" class="center">
                    ...
                    <a href="javascript:void(0);" class="button btn-show-dialog"
                       data-title="${g.message(code:'inventoryLevel.create.label', default: 'Create stock level')}" data-width="900" data-height="500"
                       data-url="${request.contextPath}/inventoryLevel/dialog/${inventoryLevelInstance?.id}?productId=${productInstance?.id}">
                        <img src="${resource(dir:'images/icons/silk', file: 'add.png')}"/>&nbsp;
                        ${g.message(code:'inventoryLevel.create.label', default: 'Create stock level')}</a>

                    <g:link class="button" controller="inventoryLevel" action="export" id="${productInstance?.id}">
                        <img src="${resource(dir:'images/icons/silk', file: 'page_excel.png')}"/>&nbsp;
                        ${g.message(code:'inventoryLevel.export.label', default: 'Export stock levels')}
                    </g:link>
