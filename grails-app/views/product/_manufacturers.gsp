<g:form action="update" method="post">
    ...
    <div class="box">
        ...
        <h2>
            <g:message code="product.manufacturerDetails.label" default="Manufacturer details"/>
        </h2>

        <table>
            <tbody>
            <tr class="prop">
                <td class="name middle"><label for="brandName"><g:message
            ...
            <tr class="prop">
                <td class="name middle"><label for="manufacturer"><g:message
            ...
            <tr class="prop">
                <td class="name middle"><label for="manufacturerCode"><g:message
            ...
            <tr class="prop">
                <td class="name middle"><label for="manufacturerName"><g:message
            ...
            <tr class="prop">
                <td class="name middle"><label for="modelNumber"><g:message
            ...
            <tr class="prop">
                <td class="name middle"><label for="vendor"><g:message
            ...
            <tr class="prop">
                <td class="name middle"><label for="vendorCode"><g:message
            ...
            <tr class="prop">
                <td class="name middle"><label for="vendorName"><g:message
            ...
            <tr class="prop">
                <td class="name middle"><label for="pricePerUnit"><g:message
