<div id="merge-product-confirmation-dialog" class="p-2" title="${g.message(code: 'product.mergeProducts.label')}">
    <div id="merge-product-warning-message" class="message">
      ${g.message(code: 'product.mergeProducts.confirmation.warning.label')}
    </div>
  <div class="my-2">
    <input
    ...
    />
    <i class="fade">
      ${g.message(code: 'product.mergeProducts.proceed.label')}
    </i>
  </div>
