<div class="dialog">
    <p class="message m-2">
        <g:message code="product.mergeProducts.description.label"/>
    </p>
    <table>
        <tbody>
            <tr class="prop">
                <td valign="top" class="name">
                    <label for="primary-product">
                        <g:message code="product.mergeProducts.primaryProduct.label"/>
                    </label>
                </td>
            ...
            <tr class="prop">
                <td valign="top" class="name">
                    <label for="obsolete-product">
                        <g:message code="product.mergeProducts.obsoleteProduct.label"/>
                    </label>
                </td>
                <td valign="top" class="value">
                    <g:autoSuggest
