...
<div id="productCatalogs">
    <div class="box dialog">
        <h2>
            <g:message code="product.catalogs.label" default="Product Catalogs"/>
        </h2>
       <%-- <g:formRemote name="addToProductCatalog"
        ...
        <g:form name="addToProductCatalog" update="productCatalogs" onSuccess="onSuccess()" onComplete="onComplete()" remote="true" action="addToProductCatalog">                  
