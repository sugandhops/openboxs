<div id="productComponents">
    <div class="box">
        <h2>
            <g:message code="product.billOfMaterials.label" default="Bill of Materials"/>
        </h2>
        ...
        <g:formRemote id="addProductComponent" name="addProductComponent"
            ...
            <table>
                ...
                <tr>
                    ...
                    <th>
                        <g:message code="productComponent.quantity.label" default="Quantity"/>
                    </th>
                    <th>
                        <g:message code="productComponent.unitOfMeasure.label" default="Unit of Measure"/>
                    </th>
                    <th>
                        <g:message code="productComponent.cost.label" default="Cost"/>
                    </th>
                    <th>
                    ...
                    <tr class="${status%2?'even':'odd'}">
                        ...
                        <td>
                            <g:remoteLink controller="product" action="deleteProductComponent" id="${productComponent.id }" class="button"
                                ...
                                <g:message code="default.button.delete.label" args="[g.message(code:'package.label')]"/>
                            </g:remoteLink>
                        </td>
                    </tr>
                </g:each>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <g:autoSuggest id="componentProduct" name="componentProduct" size="80" class="medium text"
                                           placeholder="${g.message(code:'product.addProductComponent.label', default: 'Search for a product to add as a component')}"
