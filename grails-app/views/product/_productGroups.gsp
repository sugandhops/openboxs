<div id="productGroups">
    <div class="box">
        <h2><g:message code="product.productGroups.label" default="Product Groups"/></h2>

        <table id="productGroupTable" class="zebra">
            <thead>
                <tr>
                    <th><g:message code="productGroup.label" default="Description"/></th>
                    <th><g:message code="productGroup.products.label" default="Products"/></th>
                    ...
                    <tr>
                        ...
                        <td class="middle">
                            ...
                            <g:remoteLink controller="product" action="removeFromProductGroups" update="productGroups" class="button"
                                ...
                                <g:message code="default.button.unlink.label" default="Unlink"/>
                            </g:remoteLink>
                        </td>
                    </tr>
                </g:each>
            ...
            <tfoot>
                <tr>
                    <td colspan="4">
                        <%-- <g:formRemote id="addProductGroupToProduct" name="addProductGroupToProduct"           update="productGroups" onSuccess="onSuccess(data,textStatus)" onComplete="onComplete()"                                url="[controller: 'product', action:'addProductGroupToProduct']"> --%>
                        <g:form name="addProductGroupToProduct"  update="productGroups" onSuccess="onSuccess(data,textStatus)" onComplete="onComplete()" remote="true" action="addProductGroupToProduct">        
                            ...
                            <g:autoSuggestString id="productGroup" name="productGroup" size="80" class="medium text"
                                                 ...
                                                 value=""
                                                 placeholder="${g.message(code:'product.addProductGroup.label', default: 'Enter product group name')}"/>
