<g:form controller="product" action="savePackage" method="post">
	...
	<table>
		<tbody>
			...
			<tr class="prop">
				<td valign="top" class="name">
					<label for="name">${g.message(code:'productSupplier.label')}</label>
				</td>
				<td valign="top" class="value ">
			...
			<tr class="prop">
				<td class="name">
					<label>
						<g:message code="package.quantity.label"/>
					</label>
				</td>
				<td class="value middle">
	...
	<div class="buttons">
		...
		<a href="#" class="btn-close-dialog" data-target="package-dialog">${g.message(code: 'default.button.cancel.label', default: 'Cancel')}</a>
	</div>
</g:form>
