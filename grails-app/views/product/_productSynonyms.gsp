...
<div id="synonyms">
    <div class="box">
        ...
        <%
            ...
            flash.error = null
        %>
        <h2><g:message code="product.synonyms.label" default="Synonyms"/></h2>
        <table id="synonymTable" class="zebra">
            <thead>
                <tr>
                    <th><g:message code="synonym.name.label" default="Synonym"/></th>
                    <th><g:message code="synonym.locale.label" default="Locale"/></th>
