                ...
                <div class="button-container">
					<div class="button-group">
						<g:link controller='inventoryItem' action='showStockCard' id='${productInstance?.id }' class="button">
							...
							${g.message(code: 'inventory.showStockCard.label', default: 'Show stock')}
						</g:link>
						<g:link controller='inventoryItem' action='showRecordInventory' params="['product.id':productInstance?.id]" class="button">
							...
							${g.message(code: 'inventory.record.label', default: 'Record Stock')}
						</g:link>
						<g:link controller='product' action='edit' id='${productInstance?.id }' class="button">
							<img src="${resource(dir: 'images/icons/silk', file: 'pencil.png')}" />&nbsp;
							${g.message(code: 'default.edit.label', args:[g.message(code: 'product.label', 'Product')])}
						</g:link>
						<g:isUserManager>
						...
						<g:link controller="stocklistManagement" action="index" id="${productInstance?.id}" class="button">
							...
							${g.message(code: 'default.manage.label', default: 'Manage stock lists', args:[g.message(code:'requisitionTemplates.label')])}
						</g:link>
					</div>
					...
					<g:isSuperuser>
						<div class="button-group">
							<g:link controller="product" action="createProductSnapshot" id="${productInstance?.id}" class="button"
									onclick="return confirm('${g.message(code: 'default.button.confirm.message', default: 'Are you sure?')}');">
								<img src="${resource(dir: 'images/icons/silk', file: 'camera.png')}"/>&nbsp;
								<g:message code="default.create.label" default="Create Snapshot" args="[g.message(code: 'snapshot.label', default:' Snapshot')]"/>
							</g:link>
							<g:link controller="migration" action="migrateProduct" id="${productInstance?.id}" class="button"
								...
								<g:message code="product.migrateInventoryTransactions.label" default="Migrate Inventory Transactions"/>
							</g:link>
					...
					<div class="button-group right">
						<g:link controller="product" action="addDocument" id="${productInstance?.id}" class="button">
							...
							<g:message code="product.addDocument.label" default="Add document"/>
						</g:link>
					</div>
                </div>
            </td>
