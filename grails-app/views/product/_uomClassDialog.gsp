<g:form controller="unitOfMeasureClass" action="save" method="post">
    <table>
        ...
        <tr>
            ...
            <td>
                <div>
                    <button type="submit" name="create" class="button icon approve" value="Create" id="create">${g.message(code: 'default.button.create.label', default: 'Create')}</button>
                    <a href="#" class="btn-close-dialog button icon remove" data-target="uom-class-dialog">${g.message(code: 'default.button.cancel.label', default: 'Cancel')}</a>
                </div>
            </td>
        </tr>
        </tfoot>
