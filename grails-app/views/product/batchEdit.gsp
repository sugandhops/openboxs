...
<head>
    ...
    <title><g:message code="product.batchEdit.label" /></title>
        ...
        <div class="yui-gf">
            <div class="yui-u first">
                ...
                <div class="dialog form box">
                    <h2>
                        <g:message code="default.filters.label"/>
                    </h2>
                    <g:form action="batchEdit" method="get">
                        ...
                        <div class="filter">
                            ...
                            <div>
                                ...
                                <label><g:message code="product.includeCategoryChildren.label" default="Include category children"/></label>
                            </div>
                        </div>
                        <%--
                        <div class="filter">
                            <label><g:message code="product.tags.label"/></label>
                            <div>
                        ...
                        --%>
                        <div class="filter">
                            <label><g:message code="product.name.label"/></label>
                            <div>
                        ...
                        <div class="filter">
                            ...
                            <div>
                                ...
                                <label><g:message code="product.productCodeIsNull.label" default="Product code is empty"/></label>
                            </div>
                        </div>
                        <div class="filter">
                            <label><g:message code="product.unitOfMeasure.label"/></label>
                            <div>
                            ...
                            <div>
                                ...
                                <label><g:message code="product.unitOfMeasureIsNull.label" default="Unit of measure is empty"/></label>
                            </div>
                        </div>
                        <div class="filter">
                            <label><g:message code="product.brandName.label"/></label>
                            <div>
                            ...
                            <div>
                                ...
                                <label><g:message code="product.brandNameIsNull.label" default="Brand name is empty"/></label>
                            </div>
                        </div>
                        <div class="filter">
                            <label><g:message code="product.manufacturer.label"/></label>
                            <div>
                            ...
                            <div>
                                ...
                                <label><g:message code="product.manufacturerIsNull.label" default="Manufacturer is empty"/></label>
                            </div>
                        </div>
                        <div class="filter">
                            <label><g:message code="product.manufacturerCode.label"/></label>
                            <div>
                            ...
                            <div>
                                ...
                                <label><g:message code="product.manufacturerCodeIsNull.label" default="Manufacturer code is empty"/></label>
                            </div>
                        </div>
                        <div class="filter">
                            <label><g:message code="product.vendor.label"/></label>
                            <div>
                            ...
                            <div>
                                ...
                                <label><g:message code="product.vendorIsNull.label" default="Vendor is empty"/></label>
                            </div>
                        </div>
                        <div class="filter">
                            <label><g:message code="product.vendorCode.label"/></label>
                            <div>
                            ...
                            <div>
                                ...
                                <label><g:message code="product.vendorCodeIsNull.label" default="Vendor code is empty"/></label>
                            </div>
                        </div>
                        <div class="filter">
                            <label><g:message code="default.createdBy.label"/></label>
                            <div>
                                <g:selectUser name="createdById" class="chzn-select" value="${params.createdById}" noSelection="['':'']" style="width:100%;"/>
                            </div>
                        </div>
                        <div class="filter">
                            <label><g:message code="default.updatedBy.label"/></label>
                            <div>
                                <g:selectUser name="updatedById" class="chzn-select" value="${params.updatedById}" noSelection="['':'']" style="width:100%;"/>
                            </div>
                        </div>
                        <div class="buttons center">
                            <button type="submit" class="button"> ${g.message(code: 'default.button.find.label')}</button>
                        </div>
                    </g:form>
                </div>
            </div>
                ...
                <div class="box">
                    <div>
                        ...
                        <h2>
                            ...
                            --%>
                            <label>
                                <g:message code="default.results.label"/>
                            </label>
                            <g:if test="${commandInstance?.productInstanceList}">
                                <g:message code="default.showingPaginatedResults.message" args="[firstResult, pageCount, totalCount]"/>

                            </g:if>
                            <g:link controller="product" action="batchEdit">
                                <g:message code="default.reset.label" default="Reset"/>
                            </g:link>
                    ...
                    <div class="filter">
                        <g:if test="${categoryInstance}">
                            <span class="tag">
                                <label><g:message code="category.label"/></label>
                                ${categoryInstance?.name?:g.message(code:'default.none.label')}
                            </span>
                        </g:if>
                        <g:if test="${params.includeCategoryChildren}">
                            <span class="tag">
                                <label>
                                    <g:message code="product.includeCategoryChildren.label" default="Include category children"/>
                                </label>
                        ...
                        <g:if test="${params.name}">
                            <span class="tag">
                                <label><g:message code="product.name.label"/></label>
                                ${params.name?:g.message(code:'default.none.label')}
                            </span>
                        </g:if>
                        <g:if test="${params.unitOfMeasure}">
                            <span class="tag">
                                <label><g:message code="product.unitOfMeasure.label"/></label>
                                ${params.unitOfMeasure?:g.message(code:'default.none.label')}
                            </span>
                        </g:if>
                        <g:if test="${params.productCode}">
                            <span class="tag">
                                <label><g:message code="product.productCode.label"/></label>
                                ${params.productCode?:g.message(code:'default.none.label')}
                            </span>
                        </g:if>
                        <g:if test="${params.manufacturer}">
                            <span class="tag">
                                <label><g:message code="product.manufacturer.label"/></label>
                                ${params.manufacturer?:g.message(code:'default.none.label')}
                            </span>
                        </g:if>
                        <g:if test="${params.brandName}">
                            <span class="tag">
                                <label><g:message code="product.brandName.label"/></label>
                                ${params.brandName?:g.message(code:'default.none.label')}
                            </span>
                        </g:if>
                        <g:if test="${params.manufacturerCode}">
                            <span class="tag">
                                <label><g:message code="product.manufacturerCode.label"/></label>
                                ${params.manufacturerCode?:g.message(code:'default.none.label')}
                            </span>
                        </g:if>
                        <g:if test="${params.vendor}">
                            <span class="tag">
                                <label><g:message code="product.vendor.label"/></label>
                                ${params.vendor?:g.message(code:'default.none.label')}
                            </span>
                        </g:if>
                        <g:if test="${params.vendorCode}">
                            <span class="tag">
                                <label><g:message code="product.vendorCode.label"/></label>
                                ${params.vendorCode?:g.message(code:'default.none.label')}
                            </span>
                        </g:if>
                        ...
                        <g:if test="${params.updatedById}">
                            <span class="tag">
                                <label><g:message code="default.updatedBy.label" /></label>
                                ${org.pih.g.core.User.get(params.updatedById)?.name}
                            </span>
                        </g:if>
                    ...
                    <g:form action="batchSave" method="post">
                        ...
                        <div class="dialog">
                            <table>
                                ...
                                <tr class="odd">
                                    <th valign="top">
                                        <g:message code="product.productCode.label"/></th>
                                    <th valign="top">
                                        <g:message code="product.name.label" /></th>
                                    <th valign="top">
                                        <g:message code="product.primaryCategory.label" /></th>
                                    <%--
                                    <th valign="top">
                                        <label for="name"><g:message code="product.productStatus.label" /></th>
                                    --%>
                                    <th valign="top">
                                        <g:message code="product.manufacturer.label" /></th>
                                    <th valign="top">
                                        <g:message code="product.manufacturerCode.label" /></th>
                                    <th valign="top">
                                        <g:message code="product.brandName.label" /></th>
                                    <%--
                                    <th valign="top">
                                        <label for="name"><g:message code="product.upc.label" /></th>
                                    <th valign="top">
                                        <label for="name"><g:message code="product.ndc.label" /></th>
                                    --%>
                                    <th valign="top">
                                        <g:message code="default.unitOfMeasure.label" /></th>
                                    <th valign="top">
                                        <g:message code="product.coldChain.label" /></th>
                                    <th valign="top">
                                        <g:message code="default.createdBy.label" /></th>
                                    <th valign="top">
                                        <g:message code="default.updatedBy.label" /></th>
                                    <th valign="top">
                                        <g:message code="default.dateCreated.label" /></th>
                                    <th valign="top">
                                        <g:message code="default.lastUpdated.label" /></th>
                                </tr>
                                </thead>
                                <tbody>
                                    <g:if test="${products}">
                                    ...
                                    <g:else>
                                        <tr>
                                            <td colspan="11" class="center empty">
                                                <g:message code="default.noResults.message" default="No results"/>
                                            </td>
                                        </tr>
                                    </g:else>
                                </tbody>
                        ...
                        <div class="paginateButtons">
                            ...
                            <div class="right">
                                <g:message code="batchEdit.resultsPerPage.label" default="Results per page"/>:
                                ...
                                <g:if test="${params.max != '-1'}"><g:link action="batchEdit" params="[max:-1]">${g.message(code:'default.all.label') }</g:link></g:if><g:else><span class="currentStep">${g.message(code:'default.all.label') }</span></g:else>
                            </div>
                        </div>
