...
<html>
	<head>
		...
		<title>
			<g:message code="default.import.label" args="[g.message(code:'default.data.label')]"/>
		</title>
	...
	<body>
		<div class="body">
            ...
            <div class="tabs tabs-ui">
                <%-- <ul>
                    <li><a href="#upload-data-tab"><g:message code="product.import.step1.label" default="Step 1"/>.
                        <g:message code="product.import.upload.label" default="Upload data file"/></a></li>
                    <li><a href="#verify-data-tab">
                        <g:message code="product.import.step2.label" default="Step 2"/>.
                        <g:message code="product.import.verify.label" default="Verify products"/></a></li>
                    <li><a href="#import-data-tab">
                        <g:message code="product.import.step2.label" default="Step 3"/>.
                        <g:message code="product.import.save.label" default="Import products"/></a></li>
                </ul> --%>
                    ...
                    <div class="box">
                        <div id="upload-form" class="dialog">
                            ...
                            <g:uploadForm name="uploadCsv" controller="product" action="uploadCsv" fragment="verify-data-tab">
                                <input name="location.id" type="hidden" value="1"/>
                                <input name="importType" type="hidden" value="product"/>
                                <table>
                                    <tbody>
                                        <tr class="prop">
                                            <td class="name">
                                                <label><g:message code="import.file.label" default="Choose a starter data file"/></label>
                                            </td>
                                            <td class="value">
                                                <div class="">
                                                    <g:link controller="batch" action="downloadCsvTemplate" params="[template:'products.csv']" class="button icon arrowdown">
                                                        <g:message code="import.product.template.label" default="Download CSV template"/>
                                                    </g:link>
                                                    <b>
                                                    -- OR --
                                                    </b>
                                                    <g:link controller="product" action="exportAsCsv" class="button icon arrowdown">
                                                        <g:message code="import.product.exportAll.label" default="Download CSV of all products"/>
                                                    </g:link>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr class="prop">
                                            <td class="name">
                                                <label><g:message code="import.file.label" default="Choose the data file you'd like to import"/></label>
                                            </td>
                                            <td class="value">
                    ...
                    <div class="box">
                                                            ...
                                                            <g:each var="productProperties" in="${command?.products }" status="status">
                                                                ...
                                                                <tr class="${status%2?'even':'odd' }">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <g:else>
                                                                            <span class="modified">${g.message(code: 'default.new.label') }</span>
                                                                        </g:else>
                                                                    </td>
                        ...
                        <g:else>
                            <div class="empty center">
                                <g:message code="import.product.uploadDataFile.message" default="You must upload a data file before proceeding to this step."/>
                            </div>
                        </g:else>
                    </div>
                </div>
                ...
                <div id="import-data-tab" class="ui-tabs-hide">
                    <div class="box">
                        <h2><g:message code="product.import.save.label" default="Import products"/></h2>
                            ...
                            <g:form name="importCsv" controller="product" action="importCsv" method="POST">
                                ...
                                <div id="import" class="dialog">
                                    <table>
                                        ...
                                        <tr class="prop">
                                            <td class="name">
                                                <label><g:message code="import.filename.label" default="Filename"/></label>
                                            </td>
                                            <td class="value">
                                        ...
                                        <tr class="prop">
                                            <td class="name">
                                                <label><g:message code="import.contentType.label" default="Content Type"/></label>
                                            </td>
                                            <td class="value">
                                        ...
                                        <tr class="prop">
                                            <td class="name">
                                                <label><g:message code="import.size.label" default="Size"/></label>
                                            </td>
                                            <td class="value">
                                        ...
                                        <tr class="prop">
                                            <td class="name">
                                                <label><g:message code="import.numOfRecords.label" default="# of Records"/></label>
                                            </td>
                                            <td class="value">
                                                ...
                                                <ul>
                                                    <li>${existingProducts } ${g.message(code:'import.existingProducts.label', default: 'updates to existing products') }</li>
                                                    <li>${newProducts } ${g.message(code:'import.newProducts.label', default: 'new products to be created') }</li>
                                                    <li>${totalProducts } ${g.message(code:'import.importedProducts.label', default: 'imported products') }</li>
                                                </ul>
                                        ...
                                        <tr class="prop">
                                            <td valign="top" class="name">
                                                <label for="tags1"><g:message code="product.tags.label" /></label>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="value">
                                                ...
                                                <button type="submit" class="button">
                                                    ${g.message(code: 'default.button.import.label', default: 'Import')}</button>
                                                &nbsp;
                                                <a href="${createLink(controller: "product", action: "importAsCsv")}" >
                                                    <g:message code="default.button.cancel.label"/>
                                                </a>
