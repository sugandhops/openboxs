            ...
            <div>
				...
				<div class="button-bar">
                    <g:link class="button" action="list">
                        ...
                        <g:message code="default.list.label" args="[g.message(code:'products.label')]"/>
                    </g:link>
	            	<g:isUserAdmin>
                        <g:link class="button" action="create">
                            <img src="${resource(dir: 'images/icons/silk', file: 'add.png')}" />&nbsp;
                            <g:message code="default.add.label" args="[g.message(code:'product.label')]"/>
                        </g:link>
	                </g:isUserAdmin>
                    ...
                    <g:link controller="product" action="exportAsCsv" class="button" params="[includeAttributes:true]">
                        <img src="${resource(dir: 'images/icons/silk', file: 'page_white_excel.png')}" />&nbsp;
                        <g:message code="default.export.label" args="[g.message(code: 'productAttributes.label')]"/>
                    </g:link>
                    <g:isUserAdmin>
                        <g:link controller="product" action="importAsCsv" class="button">
                            ...
                            <g:message code="default.import.label" args="[g.message(code: 'products.label')]"/>
                        </g:link>
                    </g:isUserAdmin>
                </div>
                ...
                <div class="yui-gf">
                            ...
                            <g:form action="list" method="get">
                                ...
                                <div class="filter-list-item">
                                    ...
                                    <p>
                                        ...
                                        <label>${g.message(code:'search.includeCategoryChildren.label', default: 'Include all products in all subcategories.')}</label>
                                    </p>
                                </div>
                                <div class="filter-list-item">
                                    <label><g:message code="product.formulary.label"/></label>
                                    <p>
                                ...
                                <div class="filter-list-item">
                                    <label for="includeInactive">
                                        ...
                                        <g:message code="default.includeInactive.label" default="Include inactive"/>
                                    </label>
                                </div>
                                <div class="filter-list-item">
                                ...
                                <div class="filter-list-item center middle">
                                    ...
                                    <button type="submit" name="format" value="csv" class="button">
                                        ...
                                        ${g.message(code: 'default.button.downloadFiltered.label', default: 'Download results')}
                                    </button>
                                </div>
                    ...
                    <div class="yui-u">
                        ...
                        <div class="box">
                            <h2>
                                Showing ${productInstanceTotal > params.max ? params.max : productInstanceTotal} of ${productInstanceTotal} ${g.message(code:'products.label')}
                            </h2>
                            ...
                            <div class="dialog">
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            <th>${g.message(code:'product.active.label')}</th>
                                            <th>${g.message(code:'product.productCode.label')}</th>
                                            <g:sortableColumn property="name" title="${g.message(code: 'default.name.label')}" params="${params}"/>
                                            <g:sortableColumn property="category" title="${g.message(code: 'category.label')}" params="${params}"/>
                                            <g:sortableColumn property="updatedBy" title="${g.message(code: 'default.updatedBy.label')}" params="${params}"/>
                                            <g:sortableColumn property="lastUpdated" title="${g.message(code: 'default.lastUpdated.label')}" params="${params}"/>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <g:each in="${productInstanceList}" status="i" var="productInstance">
                                            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                                ...
                                                <td align="center">
                                                    <format:category category="${productInstance?.category?.name }"/>
