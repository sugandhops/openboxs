...
<html>
	<head>
		...
		<g:set var="entityName" value="${g.message(code: 'productMergeLogs.label', default: 'Product Merge Logs')}" />
				...
				<div class="yui-u">
					...
					<div class="box">
						...
						<table>
							<thead>
								<tr>
									<th>${g.message(code: 'productMerge.id.label', default: "Log ID")}</th>
									<th>${g.message(code: 'productMerge.primaryProduct.label', default: "Primary Product")}</th>
									<th>${g.message(code: 'productMerge.obsoleteProduct.label', default: "Obsolete Product")}</th>
									<th>${g.message(code: 'productMerge.relatedObjectId.label', default: "Related Object ID")}</th>
									<th>${g.message(code: 'productMerge.relatedObjectClassName.label', default: "Related Object class name")}</th>
									<th>${g.message(code: 'productMerge.dateMerged.label', default: "Date Merged")}</th>
									<th>${g.message(code: 'productMerge.createdBy.label', default: "Created By")}</th>
								</tr>
							</thead>
							<tbody>
									...
									<tr class="prop">
										<td colspan="15">
											<div class="empty fade center">
												<g:message code="productMerge.none.message" default="None"/>
											</div>
										</td>
									</tr>
								</g:unless>
