...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'productAssociations.label', default: 'Product Associations')}" />
            ...
            <div>
				...
				<div class="button-bar">
                    <g:link class="button" action="list">
                        ...
                        <g:message code="default.list.label" args="[g.message(code:'productAssociations.label')]"/>
                    </g:link>
                    <g:link class="button" action="create">
                        <img src="${resource(dir: 'images/icons/silk', file: 'add.png')}" />&nbsp;
                        <g:message code="default.add.label" args="[g.message(code:'productAssociation.label')]"/>
                    </g:link>
                    <g:link class="button" controller="batch" action="downloadExcel" params="[type:'ProductAssociation']">
                        <img src="${resource(dir: 'images/icons/silk', file: 'page_excel.png')}" />&nbsp;
                        <g:message code="default.export.label" args="[g.message(code:'productAssociations.label')]"/>
                    </g:link>
                    <g:link class="button" controller="batch" action="importData" params="[type: 'productAssociation']" >
                        ...
                        <g:message code="default.import.label" args="[g.message(code:'productAssociations.label')]"/>
                    </g:link>
	        	</div>
                ...
                <div class="yui-gf">
                    <div class="yui-u first">
                        <div class="box">
                            <h2><g:message code="filters.label" default="Filters"/></h2>
                        ...
                        <div class="box">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <g:sortableColumn property="id" title="${g.message(code: 'productAssociation.id.label', default: 'Id')}" />

                                    <g:sortableColumn property="code" title="${g.message(code: 'productAssociation.code.label', default: 'Code')}" />

                                    <th><g:message code="productAssociation.product.label" default="Product" /></th>

                                    <th><g:message code="productAssociation.associatedProduct.label" default="Associated Product" /></th>

                                    <g:sortableColumn property="quantity" title="${g.message(code: 'productAssociation.quantity.label', default: 'Quantity')}" />

                                    <g:sortableColumn property="comments" title="${g.message(code: 'productAssociation.comments.label', default: 'Comments')}" />

                                    <g:sortableColumn property="dateCreated" title="${g.message(code: 'productAssociation.dateCreated.label', default: 'Date Created')}" />
