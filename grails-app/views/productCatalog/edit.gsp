...
<body>
    <div class="body">
        ...
        <div class="button-bar">
            ...
            <g:isSuperuser>
                ...
                <a href="#" class="button button-dialog" data-dialog="#dialog-import-data" action="importCsv">
                    ...
                    <g:message code="default.import.label" args="[g.message(code: 'productCatalogItems.label', default: 'Product Catalog Items')]"/>
                </a>
            </g:isSuperuser>
        ...
        <div class="tabs">
            <ul>
                <li>
                    <a href="#edit-product-catalog">
                        <g:message code="productCatalog.label" default="Product Catalog"/>
                    </a>
                </li>
                <li>
                    <a href="#edit-product-catalog-items">
                        <g:message code="productCatalogItems.label" default="Product Catalog Items"/>
                    </a>
                </li>
            </ul>
            ...
            <div id="edit-product-catalog-items">
                <div class="box">
                    <h2><g:message code="productCatalog.productCatalogItems.label" default="Product Catalog Items"/></h2>
    ...
    <div id="dialog-import-data" class="dialog" style="display: none;" title="<g:message code="default.import.label" args="[g.message(code: 'productCatalogItems.label', default: 'Product Catalog Items')]"/>">
        <g:form controller="productCatalog" action="importProductCatalog" method="post" enctype="multipart/form-data">
            <label>${g.message(code:'importDataCommand.importFile.label')}</label>
            <input type="file" name="importFile" />
            <g:hiddenField name="id" value="${productCatalogInstance?.id}"/>
            <g:hiddenField name="type" value="productCatalog"/>
            <g:hiddenField name="location.id" value="${session?.g?.id}"/>
            <g:submitButton name="importData" class="button" value="${g.message(code: 'default.button.import.label', default: 'Import')}" />
        </g:form>
