                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="id" title="${g.message(code: 'productCatalog.id.label', default: 'Id')}" />

                            <g:sortableColumn property="code" title="${g.message(code: 'productCatalog.code.label', default: 'Code')}" />

                            <g:sortableColumn property="name" title="${g.message(code: 'productCatalog.name.label', default: 'Name')}" />

                            <g:sortableColumn property="description" title="${g.message(code: 'productCatalog.description.label', default: 'Description')}" />

                            <g:sortableColumn property="active" title="${g.message(code: 'productCatalog.active.label', default: 'Active')}" />

                            <g:sortableColumn property="color"
                                              title="${g.message(code: 'productCatalog.color.label', default: 'Color')}"/>

                            <g:sortableColumn property="dateCreated" title="${g.message(code: 'productCatalog.dateCreated.label', default: 'Date Created')}" />
