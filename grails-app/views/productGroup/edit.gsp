...
<content tag="pageTitle"> <g:message
            ...
            <div id="product-group-tabs" class="tabs">
                ...
                <div id="product-group-tab">
					<g:form method="post" action="update">
						...
						<div class="box">
							<h2><g:message code="productGroup.label" default="Product group"/></h2>
							<table>
								<tbody>
									<tr class="prop">
				...
				<div id="product-group-products-tab">
					<div class="box">
						<h2><g:message code="productGroup.products.label" default="Products"/></h2>
