...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'productGroup.label', default: 'ProductGroup')}" />
    ...
    <body>
        <div class="body">
            ...
            <div class="summary">
                <h1 class="title"><g:message code="productGroups.label"/></h1>
            </div>
            ...
            <div class="yui-gf">
                ...
                <div class="yui-u">
                    <div class="list box">
                        <h2><g:message code="productGroups.label"/> (${productGroupInstanceTotal})</h2>

                        <table>
                            <thead>
                            <tr>

                                <g:sortableColumn property="name" title="${g.message(code: 'productGroup.name.label', default: 'Name')}" />

                                <g:sortableColumn property="category" title="${g.message(code: 'productGroup.category.label', default: 'Category')}" />

                                <g:sortableColumn property="products" title="${g.message(code: 'productGroup.products.label', default: 'Products')}" />

                                <g:sortableColumn property="dateCreated" title="${g.message(code: 'productGroup.dateCreated.label', default: 'Date Created')}" />

                                <g:sortableColumn property="lastUpdated" title="${g.message(code: 'productGroup.lastUpdated.label', default: 'Last Updated')}" />
