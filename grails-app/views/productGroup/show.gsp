...
<html>
    ...
    <body>
        <div class="body">
            ...
            <div class="box">
                <h2><g:message code="productGroup.show.label" default="Show product group" /></h2>
                <table>
                    <tbody>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="productGroup.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="productGroup.products.label" default="Products" /></td>
                        	...
                        	<td valign="top">                         
					            <div class="buttons left">
					                <g:form>
					                    ...
					                    <g:actionSubmit class="button icon edit" action="edit" value="${g.message(code: 'default.button.edit.label', default: 'Edit')}"/>
