            ...
            <div class="dialog">
				<div class="button-bar">
                    <g:link class="button" action="list">
                        ...
                        <g:message code="default.list.label" args="[g.message(code:'productSupplier.label')]"/>
                    </g:link>
                    <g:link class="button" action="create">
                        <img src="${resource(dir:'images/icons/silk', file:'add.png')}" />
                        <g:message code="default.add.label" args="[g.message(code:'productSupplier.label')]"/>
                    </g:link>
                    <g:link class="button" action="export" params="[format: 'xls']">
                        <img src="${resource(dir:'images/icons/silk', file:'page_excel.png')}" />
                        <g:message code="default.export.label" args="[g.message(code:'productSuppliers.label')]"/>
                    </g:link>
                    <g:link class="button" controller="batch" action="downloadExcel" params="[type:'ProductSupplierPreference']">
                        <img src="${resource(dir:'images/icons/silk', file:'page_excel.png')}" />
                        <g:message code="default.export.label" args="[g.message(code:'productSupplier.productSourcePreference.label')]"/>
                    </g:link>
	        	</div>
                <div class="box">
                        ...
                        <div class="filter-list">
                            <table>
                                <tr>
                                    ...
                                    <td width="25%">
                                        <label><g:message code="productSupplier.supplier.label"/></label>
                                        <p>
                                    ...
                                    <td width="25%">
                                        <label><g:message code="productSupplier.manufacturer.label"/></label>
                                        <p>
