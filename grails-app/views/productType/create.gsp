    ...
    <body>
        <div class="body">
			...
			<div class="button-bar">
				<g:link class="button" action="list"><g:message code="default.list.label" args="['productType']"/></g:link>
				<g:link class="button" action="create"><g:message code="default.add.label" args="['productType']"/></g:link>
			</div>
				...
				<div class="box">
					...
					<table>
						<tbody>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label><g:message code="productType.productTypeCode.label" default="Product Type Code" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="productIdentifierFormat"><g:message code="productType.productIdentifierFormat.label" default="Product Identifier Format" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="sequenceNumber"><g:message code="productType.sequenceNumber.label" default="Sequence Number" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="supportedActivities"><g:message code="productType.supportedActivities.label" default="Supported Activities" /></label>
								</td>
								<td valign="top" class="value ${hasErrors(bean: productTypeInstance, field: 'supportedActivities', 'errors')}">
									<g:set var="activityList" value="${org.pih.g.product.ProductActivityCode.values()}"/>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="requiredFields"><g:message code="productType.requiredFields.label" default="Required Fields" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label for="displayedFields"><g:message code="productType.displayedFields.label" default="Displayed Fields" /></label>
								</td>
