				...
				<div class="box">
					...
					<table>
						<tbody>
							...
							<g:if test="${org.pih.g.product.Product.findAllByProductType(productTypeInstance)?.size() == 0}">
								<tr class="prop">
									<td valign="top" class="name">
										<label><g:message code="productType.productIdentifierFormat.label" default="Product Identifier Format" /></label>
									</td>
