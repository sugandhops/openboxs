            ...
            <div class="box">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="productType.productTypeCode.label" default="Product Type Code" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="productType.productIdentifierFormat.label" default="Product Identifier Format" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="productType.supportedActivities.label" default="Supported Activities" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="productType.requiredFields.label" default="Required Fields" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="productType.displayedFields.label" default="Displayed Fields" /></td>
