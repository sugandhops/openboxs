                    ...
                    <div class="button-container">
                        <div class="button-group">
                            ...
                            <g:remoteLink controller="requisition" action="showRequisitionItems" id="${requisitionItem?.requisition?.id }" update="requisitionItems" class="button icon log">
                                <g:message code="default.button.list.label" default="Back to list"/>
                            </g:remoteLink>
                            <g:remoteLink controller="requisition" action="editRequisitionItem" id="${requisitionItem?.requisition?.id }"
                                ...
                                <g:message code="default.button.refresh.label" default="Refresh"/>
                            </g:remoteLink>
                    ...
                    <div class="button-container">
                        <div class="button-group">
                            <g:remoteLink controller="requisition" action="previousRequisitionItem" id="${requisitionItem?.requisition?.id }"
                                ...
                                <g:message code="default.button.previous.label" default="Previous"/>
                            </g:remoteLink>
    ...
    <table>
        <tr class="prop">
            <td class="middle right name">
                <label><g:message code="requisitionItem.status.label"/></label>
            </td>
            <td class="middle">
        ...
        <tr class="prop">
            <td class="middle right name">
                <label><g:message code="requisitionItem.cancelReasonCode.label"/></label>
            </td>
            <td class="middle">
                <g:if test="${requisitionItem?.cancelReasonCode}">
                    ${g.message(code:'enum.ReasonCode.' + requisitionItem?.cancelReasonCode)}
                </g:if>
                <g:else>
        ...
        <tr class="prop">
            <td class="middle right name">
                <label><g:message code="requisitionItem.cancelComments.label"/></label>
            </td>
            <td class="middle">
        ...
        <tr class="prop">
            <td class="top right name">
                <label><g:message code="requisitionItem.availability.label" default="Availability"/></label>
            </td>
            <td class="middle">
                <table style="width:auto;" class="box">
                    <tr>
                        ...
                        <th><g:message code="product.productPackages.label" default="Package sizes"/></th>
                        <th><g:message code="inventoryItem.quantityOnHand.label"/></th>
                        <th><g:message code="inventoryItem.status.label" default="Status"/></th>
                    </tr>
                    ...
                    <g:if test="${requisitionItem.canUndoChanges()}">
                        <div class="button-group">
                            <g:remoteLink controller="requisition" action="undoChanges" id="${requisitionItem?.requisition?.id }"
                                ...
                                <g:message code="default.button.undo.label" default="Undo changes"/>
                            </g:remoteLink>
                        </div>
                    </g:if>
                    <g:else>
                        <div class="">
                            <g:remoteLink controller="requisition" action="approveQuantity" id="${requisitionItem?.requisition?.id }"
                                ...
                                ${g.message(code:'verify.button.approve.label', default: 'Approve item') }
                            </g:remoteLink>
                            <g:remoteLink controller="requisition" action="editRequisitionItem" id="${requisitionItem?.requisition?.id }"
                                          onFailure="alert('An error has occurred.  Please contact your system administrator (${requisition.requestNumber}).')"
                                ...
                                <g:message code="verify.button.change.label" default="Change quantity"/>
                            </g:remoteLink>
                            <g:remoteLink controller="requisition" action="editRequisitionItem" id="${requisitionItem?.requisition?.id }"
                                          onFailure="alert('An error has occurred.  Please contact your system administrator (${requisition.requestNumber}).')"
                                ...
                                <g:message code="verify.button.substitute.label" default="Substitute product"/>
                            </g:remoteLink>
                            <g:remoteLink controller="requisition" action="editRequisitionItem" id="${requisitionItem?.requisition?.id }"
                                          onFailure="alert('An error has occurred.  Please contact your system administrator (${requisition.requestNumber}).')"
                                ...
                                <g:message code="verify.button.cancel.label" default="Cancel item"/>
                            </g:remoteLink>
                        </div>
                    </g:else>
                </div>
                ...
                <tr class="prop">
                    ...
                    <td>
                        <g:textArea name="comments" value="${requisitionItem.cancelComments}"
                                    ...
                                    placeholder="${g.message(code:'requisitionItem.comments.placeholder', default:'Enter any additional information')}"/>
                ...
                <tr class="prop">
                    ...
                    <td class="middle left">
                        ...
                        <g:remoteLink controller="requisition" action="editRequisitionItem" id="${requisitionItem?.requisition?.id }"
                            ...
                            <g:message code="default.button.discard.label" default="Discard changes"/>
                        </g:remoteLink>
                        </div>
...
<g:if test="${params.actionType=='substitute'}">
    <div class="box">
        <h2><g:message code="requisitionItem.substitution.label" default="Substitution"/></h2>
        <g:formRemote id="substitutionForm" name="substitutionForm"
            ...
            <table>
                ...
                <tr class="prop">
                    <td class="middle right name">
                        <label><g:message code="product.label" default="Product"/></label>
                    </td>
                    <td class="middle">
                ...
                <tr class="prop">
                    <td class="top right name">
                        <label><g:message code="requisitionItem.substitution.label" default="Substitution"/></label>
                    </td>
                    <td class="middle">
                        <table style="width:auto;" class="box">
                            <tr>
                ...
                <tr class="prop">
                    ...
                    <td>
                        <g:textArea name="comments" value="${requisitionItem.cancelComments}"
                                    cols="80" rows="5" class="text"
                                    placeholder="${g.message(code:'requisitionItem.comments.placeholder', default:'Any additional information')}"/>
