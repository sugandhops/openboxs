    <div id="requisition-header" class="box">
            ...
            <div class="box-button">
                <g:if test="${requisition?.id }">
                    <g:link controller="requisition" action="editHeader" id="${requisition?.id }" class="button icon edit">
                        ${g.message(code:'requisition.button.edit.label', default: 'Edit header')}
                    </g:link>
                </g:if>
            </div>
            <g:message code="requisition.label" default="Requisition"/>
        </h2>
        ...
        <div id="requisition-workflow" class="box dialog">
            <h2>
                <g:message code="default.workflow.label" default="Requisition workflow"/>
            </h2>
            <table>
                <tr class="prop">
                    <td class="name">
                ...
                <tr class="prop">
                    <td class="name"><label><g:message code="transactions.label" /></label></td>
                    <td class="value">
