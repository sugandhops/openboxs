                ...
                <div class="tabs">
                    ...
                    <div id="tabs-change">
                        <g:if test="${!selectedRequisitionItem?.quantityCanceled }">
                            <div class="box">
                                <h2>${g.message(code:'requisitionItem.changeQuantity.label') }</h2>
                                <div class="dialog">
                                    <g:form controller="requisition" action="changeQuantity">
                                        ...
                                        <div class="prop">
                                            <g:textField name="quantity" value="${selectedRequisitionItem?.quantity}" class="text" placeholder="${g.message(code:'default.quantity.label') }"/>
                                        </div>
                                        <div class="prop">
                    ...
                    <div id="tabs-substitution">
                        <g:if test="${!selectedRequisitionItem?.quantityCanceled }">
                            <div class="box">
                                <h2>${g.message(code:'requisitionItem.addSubstitution.label') }</h2>
                                <div class="dialog">
