...
<tr class="prop ${(i % 2) == 0 ? 'odd' : 'even'} ${(requisitionItem?.isCanceled())?'canceled':''} ${selected ?'selected-middle':'unselected'}">
                ...
                <div class="actions">
                    ...
                    <div class="box" style="max-width: 600px;">
                        ...
                        <g:form controller="requisition" action="addToPicklistItems">
                            ...
                            <h2>
                                ${g.message(code:'picklist.pickingItemsFor.label', default:'Picking items for')}
                            ...
                            <table>
                                ...
                                <tr>
                                    <th colspan="3" class="center no-border-bottom border-right">
                                        ${g.message(code: 'inventory.availableItems.label', default: 'Available items')}
                                    </th>
                                    <th colspan="4" class="center no-border-bottom">
                                        ${g.message(code: 'picklist.picklistItems.label')}
                                    </th>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <th class="center border-right">
                                        ${g.message(code: 'requisitionItem.quantityAvailable.label')}
                                    </th>
                                    <th class="center">
                                        ${g.message(code: 'picklistItem.quantity.label')}
                                    </th>
                                    <th class="center">
                                ...
                                <g:unless test="${inventoryItems}">
                                    <tr style="height: 60px;">
                                        <td colspan="7" class="center middle">
                                            <span class="fade">${g.message(code: 'requisitionItem.noInventoryItems.label', default: 'No available items')}</span>
                                        </td>
                                    </tr>
                                </g:unless>
                                <g:each var="inventoryItem" in="${inventoryItems}" status="status">
                                    ...
                                    <tr class="prop ${status % 2 ? 'odd' : 'even'}">
                                        <td class="middle">
                                            <span class="lotNumber">${inventoryItem?.lotNumber?:g.message(code:'default.none.label')}</span>
                                        </td>
                                        <td class="middle">
                                        ...
                                        <td>
                                            <g:if test="${picklistItem}">
                                                <g:link controller="picklistItem"
                                                    ...
                                                    <g:message code="picklist.removeFromPicklistItems.label" default="Remove from picklist"/>
                                                </g:link>
                                            </g:if>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="7" class="center">
                                            <g:if test="${requisitionItem?.retrievePicklistItems()}">
                                                <button class="button">
                                                    ${g.message(code: 'picklist.updatePicklistItems.label', default:'Update picklist items')}
                                                </button>
                                            </g:if>
                                            <g:else>
                                                <button class="button">
                                                    ${g.message(code: 'picklist.addToPicklistItems.label', default:'Add to picklist items')}
                                                </button>
    ...
    <td>
        ...
        <g:else>
            ${requisitionItem?.product?.unitOfMeasure?:g.message(code:'default.each.label') }
        </g:else>
    </td>
    <td class="center">
