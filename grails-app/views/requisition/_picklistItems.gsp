<g:if test="${requisitionItem.isCanceled() || requisitionItem?.isSubstituted() || requisitionItem?.isChanged()}">
    <div class="box" style="max-width: 600px;">
        <span class="fade">
            <format:metadata obj="${requisitionItem.status}"/>: ${g.message(code: 'requisitionItem.cannotPickItems.label', default: 'Cannot pick stock for this requisition item.')}
        </span>
    </div>
</g:if>
<g:else>
    <g:form controller="requisition" action="addToPicklistItems">
        ...
        <div class="box">
            <table>
                ...
                <tr class="prop">
                    <td class="name">
                        <label><g:message code="inventoryItem.quantity.label"/>:</label>
                    </td>
                    <td class="value">
                ...
                <table>
                    ...
                    <tr class="prop">
                        <th colspan="4" class="center no-border-bottom border-right">
                            <h3>${g.message(code: 'inventory.availableItems.label', default: 'Available items')}</h3>
                        </th>
                        <th colspan="3" class="center no-border-bottom">
                            <h3>${g.message(code: 'picklist.picklistItems.label')}</h3>
                        </th>
                    </tr>
                    <tr class="prop">
                        <th>
                                    ...
                                    <div class="button-group">
                                        ...
                                        <g:if test="${picklistItem}">
                                            <g:link controller="picklistItem"
                                                ...
                                                <g:message code="picklist.removeFromPicklistItems.label" default="Remove"/>
                                            </g:link>
                                        </g:if>
                                    </div>
                                    ...
                                    <div class="buttons">
                                        <g:if test="${requisitionItem?.retrievePicklistItems()}">
                                            <button class="button icon approve">
                                                ${g.message(code: 'picklist.updatePicklistItems.label', default:'Update picklist')}
                                            </button>
                                        </g:if>
                                        <g:else>
                                            <button class="button icon add">
                                                ${g.message(code: 'picklist.addToPicklistItems.label', default:'Add to picklist')}
                                            </button>
                                        </g:else>
                                    </div>
                                </g:if>
