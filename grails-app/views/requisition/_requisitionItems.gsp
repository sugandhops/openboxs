...
<tr class="odd">
    ...
    <th>
        <g:message code="requisitionItem.status.label" default="Status" />
    </th>
    <th>
        <g:message code="product.productCode.label" />
    </th>
    <th>
        <g:message code="requisitionItem.product.label" />
    </th>
    <th>
        <g:message code="product.unitOfMeasure.label" />
    </th>
    <th class="center">
        <g:message code="requisitionItem.reasonCode.label" default="Reason Code" />
    </th>
    <th class="center ">
        <g:message code="requisitionItem.quantityRequested.label" />
    </th>
    <th class="center">
        <g:message code="requisitionItem.quantityAvailable.label" default="Quantity available" />
    </th>
    <th class="center">
        <g:message code="requisitionItem.orderIndex.label" default="Sort order" />
    </th>
</tr>
</thead>
<tbody>
<g:if test="${requisition?.requisitionItems?.size() == 0}">
    <tr class="prop odd">
        <td colspan="8" class="center"><g:message
                ...
                <g:if test="${requisitionItem?.canApproveQuantity()}">
                    <div class="action-menu-item">
                        <g:link controller="requisitionItem" action="approveQuantity" id="${requisitionItem?.id }" fragment="${requisitionItem?.id}">
                            <img src="${resource(dir: 'images/icons/silk', file: 'accept.png')}"/>&nbsp;
                            <g:message code="requisitionItem.approveQuantity.label" default="Approve quantity"/>
                        </g:link>
                    </div>
                ...
                <g:if test="${requisitionItem.canChangeQuantity()}">
                    <div class="action-menu-item">
                        <g:link controller="requisition" action="review" id="${requisitionItem?.requisition?.id }"
                            ...
                            <img src="${resource(dir: 'images/icons/silk', file: 'pencil.png')}"/>&nbsp;
                            <g:message code="requisitionItem.changeQuantity.label" default="Change quantity"/>
                        </g:link>
                    </div>
                ...
                <g:if test="${requisitionItem.canChooseSubstitute()}">
                    <div class="action-menu-item">
                        <g:link controller="requisition" action="review" id="${requisitionItem?.requisition?.id }" fragment="${requisitionItem?.id}"
                            ...
                            <img src="${resource(dir: 'images/icons/silk', file: 'arrow_switch.png')}"/>&nbsp;
                            <g:message code="requisitionItem.substitute.label" default="Choose substitute"/>
                        </g:link>
                    </div>
                ...
                <g:if test="${requisitionItem.canChangeQuantity()}">
                    <div class="action-menu-item">
                        <g:link controller="requisition" action="review" id="${requisitionItem?.requisition?.id }"
                            ...
                            <img src="${resource(dir: 'images/icons/silk', file: 'decline.png')}"/>&nbsp;
                            <g:message code="requisitionItem.cancel.label" default="Cancel requisition item"/>
                        </g:link>
                    </div>
                </g:if>
                <g:if test="${requisitionItem.canUndoChanges()}">
                    <div class="action-menu-item">
                        <g:link controller="requisitionItem" action="undoChanges" id="${requisitionItem?.id }" params="[redirectAction:'review']" fragment="${requisitionItem?.id}"
                                onclick="return confirm('${g.message(code: 'default.button.undo.confirm.message', default: 'Are you sure?')}');">
                            <img src="${resource(dir: 'images/icons/silk', file: 'arrow_undo.png')}"/>&nbsp;
                            <g:message code="requisitionItem.undoChange.label" default="Undo changes"/>
                        </g:link>
                    </div>
            ...
            <g:else>
                <div class="action-menu-item">
                    <g:link controller="requisitionItem" action="delete" id="${requisitionItem?.id }" params="[redirectAction:'review']" fragment="${requisitionItem?.id}"
                        ...
                        <g:message code="requisitionItem.delete.label" default="Delete requisition item"/>
                    </g:link>
                </div>
            </g:else>
...
<td class="center middle" style="width: 10%;">
    <g:if test="${requisitionItem?.cancelReasonCode}">
        <p>${g.message(code:'enum.ReasonCode.' + requisitionItem?.cancelReasonCode)}</p>
...
<td class="center middle">
    ...
    <g:else>
        <div class="box unavailable">
            <div>${g.message(code:'inventory.unavailable.label',default:'Unavailable')}</div>
            ${quantityOnHand?:0} EA/1
        </div>
    </g:else>
</td>
...
<g:if test="${params?.actionType=='changeQuantity'}">
    <div class="box" id="changeQuantity">
        <h2>${g.message(code:'requisitionItem.changeQuantity.label', default:'Change quantity')}</h2>
            ...
            <table>
                <tr>
                    <td class="middle right">
                        <label><g:message code="requisitionItem.quantity.label"/></label>
                    </td>
                    <td class="middle">
                ...
                <tr>
                    <td class="middle right">
                        <label><g:message code="requisitionItem.product.label"/></label>
                    </td>
                    <td class="middle">
                ...
                <tr>
                    <td class="middle right">
                        <label><g:message code="requisitionItem.cancelReasonCode.label" default="Reason code"/></label>
                    </td>
                    <td class="middle">
                ...
                <tr>
                    <td class="top right">
                        <label style="display: block;"><g:message code="requisitionItem.comments.label" default="Comments"/></label>
                    </td>
                    <td>
                        <g:textField name="comments" value="${selectedRequisitionItem.cancelComments}"
                                     size="60" class="text" placeholder="${g.message(code:'requisitionItem.comments.placeholder', default:'Any additional information')}"/>
...
<g:elseif test="${params?.actionType=='changePackageSize'}">
    <div class="box">
        <h2>${g.message(code:'requisitionItem.changePackageSize.label', default:'Change package size')}</h2>
...
<g:elseif test="${params?.actionType=='cancelQuantity'}">
    <div class="box" class="cancelQuantity">
        <h2>${g.message(code:'requisitionItem.cancel.label', default:'Cancel requisition item')}</h2>
        ...
        <g:form controller="requisitionItem" action="cancelQuantity" fragment="${selectedRequisitionItem?.id}">
            ...
            <table>
                ...
                <tr>
                    <td class="right top">
                        <label><g:message code="requisitionItem.product.label" default="Product"/></label>
                    </td>
                    <td>
                        ${selectedRequisitionItem?.product?.productCode}
                        <format:product product="${selectedRequisitionItem?.product}"/>
                ...
                <tr>
                    <td class="right top">
                        <label><g:message code="requisitionItem.cancelQuantity.label" default="Cancel quantity"/></label>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="right top">
                        <label><g:message code="requisitionItem.reasonCode.label" default="Reason code"/></label>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="right top">
                        <label><g:message code="requisitionItem.comments.label" default="Comments"/></label>
...
<g:elseif test="${params?.actionType=='chooseSubstitute'}">
    <div class="box" id="chooseSubstitute">
        <h2>${g.message(code:'requisitionItem.chooseSubstitute.label', default: 'Choose substitute') }</h2>
        <div class="dialog">
            <g:hasErrors bean="${flash.errors}">
                <div class="errors">
                    <g:renderErrors bean="${flash.errors}" as="list" />
                ...
                <table>
                    ...
                    <tr class="">
                        <td class="name middle right">
                            <label><g:message code="requisitionItem.quantity.label" default="Quantity"/></label>
                        </td>
                        <td class="value ${hasErrors(bean: selectedRequisitionItem, field: 'quantity', 'errors')}">
                            <g:textField id="quantity" name="quantity" value="${selectedRequisitionItem?.quantity}" class="text"
                                         placeholder="${g.message(code:'default.quantity.label') }"/> EA/1
                        </td>
                    </tr>
                    <tr>
                        <td class="name middle right">
                            <label><g:message code="requisitionItem.totalQuantity.label" default="Total quantity"/></label>
                        </td>
                        <td>
...
<g:elseif test="${params?.actionType=='supplementProduct'}">
    <div class="box">
        <h2>${g.message(code:'requisitionItem.addAddition.label') }</h2>
        <div class="dialog">
            <g:form controller="requisition" action="addAddition" fragment="${selectedRequisitionItem?.id}">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <g:textField name="quantity" value="" class="text" placeholder="${g.message(code:'default.quantity.label') }"/>
                        </td>
                        <td>
                            <button class="button">
                                ${g.message(code:'default.button.save.label') }
