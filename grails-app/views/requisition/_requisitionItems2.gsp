<div id="requisitionItems">
    <div class="box">
        <h2>
            <g:message code="requisition.verify.label" default="Verify requisition"/>
        </h2>
        <g:form controller="requisition" action="saveDetails">
            ...
            <table>
                <tr class="prop">
                    <td class="name">
                        <label>
                            ${g.message(code:'requisition.verifiedBy.label', default: 'Verified by')}
                        </label>
                    </td>
                    <td class="value">
                ...
                <tr class="prop">
                    <td class="name">
                        <label>
                            ${g.message(code:'requisition.dateVerified.label', default: 'Date verified')}
                        </label>
                    </td>
                    <td class="value">
        ...
        <table id="requisitionItemsTable">
            <thead>
                <tr>
                    ...
                    <%--
                    <th>
                        <g:message code="requisitionItem.type.label" default="Type" />
                    </th>
                    --%>
                    <th>
                    ...
                    <th class="center middle">
                        <g:message code="requisitionItem.quantityRequested.label" default="Requested"/>
                    </th>
                    <th class="center middle">
                        <g:message code="requisitionItem.quantityApproved.label" default="Approved" />
                    </th>
                    <th class="center middle">
                        <g:message code="requisitionItem.quantityAvailable.label" default="Available" />
                    </th>
                    <th>
                        <g:message code="requisitionItem.cancelReasonCode.label" default="Reason code"/>
                    </th>
            ...
            <tbody>
                <g:if test="${!requisitionItems}">
                    <tr class="prop">
                        <td colspan="9" class="center empty"><g:message
