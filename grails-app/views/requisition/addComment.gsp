...
<head>
	...
	<g:set var="entityName" value="${g.message(code: 'request.label', default: 'Request')}" />
						...
						<g:render template="summary" model="[requisition:requestInstance]" />
							<g:form action="saveComment">
								...
								<table>
									<tbody>
										<tr class="prop">
				                            <td valign="top" class="name"><label><g:message code="default.to.label" default="To" /></label></td>
										...
										<tr class="prop">
				                            <td valign="top" class="name"><label><g:message code="default.from.label" default="From" /></label></td>
										...
										<tr class="prop">
				                            <td valign="top" class="name"><label><g:message code="default.comment.label" default="Comment" /></label></td>
										...
										<tr class="prop">
				                            <td valign="top" class="name"><label><g:message code="default.dateCreated.label" default="Date created" /></label></td>
				                            <td valign="top" class="value ${hasErrors(bean: commentInstance, field: 'dateCreated', 'errors')}">
												${commentInstance?.dateCreated }
			                                </td>
				                        </tr>
										<tr class="prop">
				                            <td valign="top" class="name"><label><g:message code="default.lastUpdated.label" default="Last updated" /></label></td>
												...
												<div class="buttons">
													<button type="submit" class="positive">
														<img src="${resource(dir:'images/icons/silk',file:'tick.png')}"
															alt="Save" /><g:message code="default.button.save.label" /></button>
													<g:link controller="requisition" action="show" id="${requestInstance?.id}" class="negative">
														<img src="${resource(dir:'images/icons/silk',file:'cancel.png')}"
															alt="Cancel" /><g:message code="default.button.cancel.label" /></g:link>
												</div>
											</td>
										</tr>
								</tbody>
