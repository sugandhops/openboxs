								...
								<td valign="top"
									class="value ${hasErrors(bean: documentInstance, field: 'documentType', 'errors')}">
												<g:select name="typeId" from="${org.pih.warehouse.core.DocumentType.list().sort{it.name}}"
													...
													noSelection="['': g.message(code:'document.chooseDocumentType.label')]"
								...
								<td valign="top" class="value">
									<div class="buttons left">
										...
										<button type="submit" class="positive">
											<img src="${resource(dir:'images/icons/silk',file:'tick.png')}" alt="save" />${documentInstance?.id ? g.message(code:'default.button.save.label') : g.message(code:'default.button.upload.label')}
										</button>
										<g:link controller="requisition" action="show" id="${requestInstance?.id}" class="negative">
											<img src="${resource(dir:'images/icons/silk',file:'cancel.png')}" alt="Cancel" /> <g:message
