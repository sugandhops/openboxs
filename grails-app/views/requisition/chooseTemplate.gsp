...
<body>
	...
	<div class="buttonBar">
		<g:link class="button icon log" controller="requisitionTemplate" action="list">
			<g:message code="default.list.label" args="[g.message(code:'requisitionTemplates.label').toLowerCase()]"/>
		</g:link>
		<g:link class="button icon add" controller="requisitionTemplate" action="create" params="[type:'STOCK']">
			<g:message code="default.add.label" args="[g.message(code:'requisitionTemplate.label')]"/>
		</g:link>
	</div>
		...
		<div class="yui-u first">
            ...
            <g:form controller="requisition" action="createStockFromTemplate">
                ...
                <div id="requisition-template-details" class="dialog ui-validation box">
                    <h2>${g.message(code:'requisition.chooseTemplate.label', default:'Choose stock requisition template')}</h2>
                    <table id="requisition-template-table">
                        <tbody>
                            <tr class="prop">
                                <td class="name">
                                    <label for="requisitionTemplate">
                                        <g:message code="requisitionTemplate.label" />
                                    </label>
                                </td>
                                <td class="value">
