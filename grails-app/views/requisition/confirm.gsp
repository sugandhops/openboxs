...
<head>
    ...
    <title><g:message code="requisition.check.label" /></title>
    <style>
    .selected { color: #666; }
	...
	<div class="yui-gf">
        ...
        <div class="yui-u">
            <div class="box dialog">
                <h2>
                    <g:message code="requisition.check.label"/>
                </h2>
                ...
                <g:form controller="requisition" action="saveDetails">
                    ...
                    <table>
                        <tr class="prop">
                            <td class="name">
                                <label>
                                    ${g.message(code:'requisition.checkedBy.label', default: 'Checked by')}
                                </label>
                            </td>
                            <td class="value">
                        ...
                        <tr class="prop">
                            <td class="name">
                                <label>
                                    ${g.message(code:'requisition.dateChecked.label', default: 'Date checked')}
                                </label>
                            </td>
                            <td class="value">
