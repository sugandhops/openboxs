		...
		<div class="yui-u first">
			<g:form name="requisitionForm" method="post" action="save" useToken="true">
				...
				<div id="requisition-template-details" class="dialog ui-validation box">
                    ...
                    <g:else>
                        <h2>${requisition?.name?:g.message(code: 'requisition.new.label') }</h2>
                    ...
                    <table id="requisition-template-table">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td class="name">
                                    <label for="type">
                                        <g:message code="requisition.requisitionNumber.label" />
                                    </label>
                                </td>
                                <td class="value">
                            ...
                            <tr class="prop">
                                <td class="name">
                                    <label for="description">
                                        <g:message code="requisition.description.label" />
                                    </label>
                                </td>
                ...
                <div class="buttons center">
                    <button class="button" name="save">${g.message(code:'default.button.save.label', default: 'Save') }</button>
                    &nbsp;
