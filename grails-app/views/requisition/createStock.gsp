		...
		<div class="yui-u first">
			...
			<g:form name="requisitionForm" method="post" action="save" useToken="true">
				...
				<div id="requisition-template-details" class="dialog ui-validation box">
                    ...
                    <g:else>
                        <h2>${g.message(code: 'requisition.details.label', default: 'Requisition details') }</h2>
                    </g:else>
                            ...
                            <tr class="prop">
                                <td class="name">
                                    <label for="commodityClass">
                                        <g:message code="requisition.commodityClass.label" />
                                    </label>
                                </td>
                            ...
                            <tr class="prop">
                                ...
                                <td class="value">
                                    <g:textArea name="description" cols="80" rows="2" style="width:100%"
                                        placeholder="${g.message(code:'requisition.description.message')}"
                            ...
                            <tr class="prop">
                                <td class="name">
                                    <label for="requisitionItems">
                                        <g:message code="requisition.requisitionItems.label" />
                                    </label>
                                </td>
                                <td class="value">
                                                ...
                                                <td >
                                                    <table >
                                                        <tr>
                                                            ...
                                                            <th>
                                                                ${g.message(code: 'inventoryLevel.maxQuantity.label')}
                                                            </th>
                                                            <th>
                                                                ${g.message(code: 'requisitionItem.quantity.label')}
                                                            </th>
                                                            <th>
                                                                ${g.message(code: 'requisitionItem.productPackage.label')}
                                                            </th>
                                                            <th>
