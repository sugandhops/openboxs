			...
			<g:form name="requisitionForm" method="post" action="saveRequisitionItems">
                <g:if test="${requisition?.id}">
                    ...
                    <div class="box dialog">
                        <h2>
                            <g:message code="requisition.addRequisitionItems.label" default="Add requisition items"/>
                        </h2>
                        ...
                        <table id="requisition-items" class="ui-validation-items zebra "
                            ...
                            <thead>
                                ...
                                <%--
                                <th class="list-header center">
                                    ${g.message(code: 'requisitionItem.totalQuantity.label', default:'Total quantity')}
                                </th>
                                --%>
