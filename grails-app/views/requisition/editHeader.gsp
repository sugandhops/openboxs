        ...
        <div class="yui-u">
			...
			<g:form name="requisitionForm" method="post" action="saveHeader">
				...
				<div id="requisition-header-details" class="dialog ui-validation expandable box">
                    <h2>
                        ${g.message(code: 'requisition.editHeader.label', default: 'Edit requisition header')}
				...
				<div class="buttons">
					...
					<button class="button" name="saveAndContinue">${g.message(code:'default.button.next.label', default: 'Next') }</button>
