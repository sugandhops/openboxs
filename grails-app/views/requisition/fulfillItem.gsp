		...
		<g:form action="fulfillRequest" autocomplete="false">
			<fieldset>
					...
					<table border="0">
						...
						<g:each var="entry" in="${inventoryItems}" status="i">
							...
							<tr class="${i%2?'odd':'even' }">	
								<td>
									${inventoryItem.lotNumber?:g.message(code: 'default.none.label') }
								</td>
								<td>
									${inventoryItem.expirationDate?:g.message(code: 'default.never.label')}
								</td>
								<td>
									${quantity }
								</td>
				...
				<div class="center buttons">
					<g:submitButton name="fullRequestItemRemote" value="${g.message(code: 'request.fulfill.label')}"></g:submitButton>
				</div>
			</fieldset>
		</g:form>
	</div>
