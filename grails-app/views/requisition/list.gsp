...
<head>
    ...
    <g:set var="entityName" value="${g.message(code: 'requests.label', default: 'Requisitions')}" />
    <title>
            ...
            <table>
                <tbody>
                    <tr>
                        <td class="top">
                            <div class="title">
                                <g:message code="default.list.label" args="${[entityName]}" /> (${requisitions.totalCount})
                            </div>
                        </td>
                        <td class="right">
                            <g:link controller="requisition" action="exportRequisitions" params="${pageParams.findAll {it.value != 'null' }}" class="button">
                                <g:message code="requisition.button.export.label" default="Export requisitions"/>
                            </g:link>
                            <g:link controller="requisition" action="exportRequisitionItems" params="${pageParams.findAll {it.value != 'null' }}" class="button">
                                <g:message code="requisition.button.export.label" default="Export requisition items"/>
                            </g:link>
                        </td>
                    </tr>
                </tbody>
        ...
        <div class="yui-gf">
                ...
                <div class="box">
                    ...
                    <g:form action="list" method="GET">
                        <div class="filter-list">
                            ...
                            <div class="filter-list-item">
                                <label><g:message code="requisition.status.label"/></label>
                                <p>
                            ...
                            <div class="filter-list-item">
                                <label><g:message code="requisition.dateRequested.label"/></label>
                                <p>
                            ...
                            <div class="filter-list-item">
                                <label>
                                    ...
                                    <g:message code="requisition.relatedToMe.label" default="Only include requisitions related to me"/>
                                </label>
                            </div>
                            <hr/>
                            <div class="filter-list-item">
            ...
            <div class="yui-u">
                <div class="box">
                    ...
                    <h2>
                        <g:message code="requisitions.label"/>
                    </h2>
                    <table>
                        <thead>
                        <tr>
                            ...
                            <th>
                                <g:message code="default.numItems.label"/>
                            </th>

                            <g:sortableColumn property="status" params="${pageParams}"
                                              title="${g.message(code: 'default.status.label', default: 'Status')}" />

                            <g:sortableColumn property="requestNumber" params="${pageParams}"
                                              title="${g.message(code: 'requisition.requestNumber.label', default: 'Request number')}" />
                            ...
                            <g:sortableColumn property="requestedBy" params="${pageParams}"
                                              title="${g.message(code: 'requisition.requestedBy.label', default: 'Requested by')}" />

                            <g:sortableColumn property="dateRequested" params="${pageParams}"
                                              title="${g.message(code: 'requisition.dateRequested.label', default: 'Date requested')}" />

                            <g:sortableColumn property="dateIssued" params="${pageParams}"
                                              title="${g.message(code: 'requisition.dateIssued.label', default: 'Date issued')}" />
                            <th>
                        ...
                        <g:unless test="${requisitions}">
                            <tr class="prop odd">
                                <td colspan="11" class="center">
                                    <div class="empty">
                                        <g:message code="requisition.noRequisitionsMatchingCriteria.message"/>
                                    </div>
                                </td>
                            </tr>
                        </g:unless>
                        <g:each in="${requisitions}" status="i" var="requisition">
                            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                                ...
                                <td class="middle">
                                    ${requisition.requestedBy?:g.message(code:'default.none.label')}
                                </td>
                                <td class="middle">
                                        ...
                                        <div class="box">
                                            <table>
                                                <tr>
                                                    ...
                                                    <th><g:message code="requisitionItem.productPackage.label"/></th>
                                                </tr>
