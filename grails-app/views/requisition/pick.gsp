		...
		<div class="yui-gf">
            ...
            <div class="yui-u">
                <div id="picklist" class="left ui-validation">
                    <div class="">
                            <div class="box">
                                <h2><g:message code="requisition.pick.label"/></h2>
                                    ...
                                    <g:form controller="requisition" action="saveDetails">
                                        ...
                                        <table>
                                            <tr class="prop">
                                                <td class="name">
                                                    <label>
                                                        ${g.message(code:'requisition.pickedBy.label', default: 'Picked by')}
                                                    </label>
                                                </td>
                                                <td class="value">
                                            ...
                                            <tr class="prop">
                                                <td class="name">
                                                    <label>
                                                        ${g.message(code:'requisition.datePicked.label', default: 'Date picked')}
                                                    </label>
                                                </td>
                                                <td class="value">
                                ...
                                <table>
                                    <thead>
                                        <tr class="odd">
                                            ...
                                            <th class="center">
                                                ${g.message(code: 'requisitionItem.quantityCanceled.label')}
                                            </th>
                                            <th class="center">
