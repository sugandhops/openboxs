...
<body>
    ...
    <div  style="float: left;">
	    ...
	    <div class="header">
	        <label><g:message code="requisition.origin.label"/>:</label> ${requisition.origin?.name}
	    </div>
	    <div class="header">
	        <label><g:message code="requisition.date.label"/>:</label> <g:formatDate date="${requisition?.dateRequested}" format="MMMMM dd, yyyy"/>
	    </div>
	    <div class="header">
	        <label><g:message code="requisition.requisitionNumber.label"/>:</label> ${requisition?.requestNumber }
	    </div>
    ...
    <table id="signature-table">
        <tr class="theader">
            <td></td>
            <td><g:message code="default.name.label"/></td>
            <td><g:message code="default.signature.label"/></td>
            <td><g:message code="default.date.label"/></td>
        </tr>
        <tr>
            <td><label><g:message code="requisition.requestedBy.label"/></label></td>
            <td>${requisition?.requestedBy?.name}</td>
            <td></td>
            <td></td>
        </tr>
        <tr>
            <td><label><g:message code="requisition.fulfilledBy.label"/></label></td>
            <td></td>
            <td></td>
            <td></td>
        </tr>
    ...
    <table id="requisition-items">
            <tr class="theader">
                <th><g:message code="report.number.label"/></th>
                <th></th>
                <th></th>
                ...
                <th class="center border-right">${g.message(code: 'requisitionItem.quantityRequested.label')}</th>
                <th class="center">${g.message(code: 'inventoryLevel.binLocation.label')}</th>
                <th class="center">${g.message(code: 'requisitionItem.quantityPicked.label')}</th>
            </tr>
    ...
    <p><g:message code="requisitionItem.comment.label"/>:</p>
    <div id="comment-box">
