...
<g:set var="entityName"
	value="${g.message(code: 'requisition.label', default: 'Requisition')}" />
<title><g:message code="requisition.process.label" /></title>
<content tag="pageTitle">
<g:message code="requisition.process.label" /></content>
</head>
<body>
	<div class="body">
			...
			<g:form name="requisitionForm" method="post" action="save"
						...
						<li>
							<div class="accordion-header">
								...
								<div class="quantityPicked">
									${g.message(code: 'requisitionItem.quantityPicked.label')}:
									<span data-bind="text:quantityPicked"></span>
								</div>
								<div class="quantityRemaining">
									${g.message(code: 'requisitionItem.quantityRemaining.label')}:
								...
								<div class="requisitionItemPicklist">
									<div class="picklist-header">
										<div class="product-name">
											<g:message code="inventoryItem.item.label" />
										</div>
										<div class="lot">
											<g:message code="inventoryItem.lot.label" />
										</div>
										<div class="expiration-date">
											<g:message code="inventoryItem.exp.label" />
										</div>
										<div class="quantity-onhand">
											<g:message code="inventoryItem.onHandQuantity.label" />
										</div>
										<div class="quantity-picked">
											<g:message code="inventoryItem.quantityPicked.label" />
										</div>
										<div class="clear"></div>
									</div>
									...
									<div data-bind="if: picklistItems().length == 0">
										<div class="error">
											<g:message code="requisition.picklistItems.message" default="No picklist items available"></g:message>
										</div>
									</div>
				...
				<div class="center footer">
					<input type="submit" class="button" id="save-requisition"
						value="${g.message(code: 'default.button.submit.label')}" />
					<g:link action="show" id="${requisitionId}">
						<input type="button" class="button" id="cancelRequisition"
							value="${g.message(code: 'default.button.cancel.label')}" />
					</g:link>
				</div>
		...
		<div class=" right" id="requisition-status-key">
			<fieldset>
				<legend class="left">
					<g:message code="requisitionItem.legend.label" />
				</legend>
				<div class="Complete left requisition-status"></div>
				<div class="left">
					<g:message code="requisitionItem.complete.label" />
				</div>
				<div class="clear"></div>
				<div class="PartiallyComplete left requisition-status"></div>
				<div class="left">
					<g:message code="requisitionItem.partiallycomplete.label" />
				</div>
				<div class="clear"></div>
				<div class="Incomplete left requisition-status"></div>
				<div class="left">
					<g:message code="requisitionItem.incomplete.label" />
				</div>
				<div class="clear"></div>
				<div class="substitution ok left"></div>
				<div class="left">
					<g:message code="requisitionItem.substitutable.label" />
				</div>
				<div class="clear"></div>
			</fieldset>
		</div>
