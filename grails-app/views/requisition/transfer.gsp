...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'request.label', default: 'Requisition')}" />
        <title><g:message code="default.fulfill.label" default="Fulfill {0}" args="[entityName]" /></title>
    </head>
    <body>
        <div class="body">
            ...
            <g:if test="${requisition.status == RequisitionStatus.ISSUED || requisition.status == RequisitionStatus.CANCELED}">
                <div class="notice">
                    <g:message code="requisition.hasAlreadyBeenCompleted.message" default="This requisition has already been issued."/>
                </div>
            </g:if>
			...
			<div class="yui-gf">
                ...
                <div class="yui-u">
                    ...
                    <g:form controller="requisition" action="complete" method="POST">
                        ...
                        <div class="box">
                            <h2>
                                ${g.message(code:'requisition.issue.label')}
                            </h2>
                            <table>
                                <tbody>
                                <tr class="prop">
                                    <td class="name">
                                        <label><g:message code="requisition.issuedBy.label"/></label>
                                    </td>
                                    <td class="value">
                                ...
                                <tr class="prop">
                                    <td class="name">
                                        <label><g:message code="requisition.deliveredBy.label" default="Delivered By"/></label>
                                    </td>
                                    <td class="value">
                        ...
                        <div class="box dialog">
                            ...
                            <table class="requisition">
                                ...
                                <tr class="odd">
                                    ...
                                    <th><g:message code="product.unitOfMeasure.label"/></th>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="empty center">
                                                <g:message code="picklistItems.empty.label" default="Picklist is empty"/>
                                            </div>
                                        </td>
                                    </tr>
                                </g:unless>
                                        ...
                                        <div class="buttons center">
                                            ...
                                            <g:else>
                                                <g:submitButton name="finish" value="Finish" class="button">
                                                    <g:message code="default.button.finish.label"/>
                                                </g:submitButton>
                                            </g:else>
                                        </div>
                                    </td>
