	...
	<table class="dataTable">
		<thead>
			<tr>
				...
				<th class="center">
					${g.message(code: 'shipping.shipmentNumber.label')}
				</th>
				<th>
					${g.message(code: 'shipping.shipment.label')}
				</th>
				<th class="center">
					${g.message(code: 'shipping.shipmentItems.label', default: "Items")}
				</th>
				<th>
                    <g:message code="default.origin.label" />
				</th>
                <th>
                    <g:message code="default.destination.label" />
			    </th>
                <th>
                    ${g.message(code: 'shipping.shippingDate.label', default: 'Shipped')}
                </th>
                <th>
                    ${g.message(code: 'shipping.receivingDate.label', default: 'Received')}
                </th>
				<th>
                        ...
                        <g:if test="${shipmentInstance?.actualShippingDate}">
                            <div title="${g.formatDate(date: shipmentInstance?.actualShippingDate)}">
                                <g:if test="${shipmentInstance?.actualShippingDate?.equals(today) }">
                                    <g:message code="default.today.label" />
                                </g:if>
                                <g:else>
                        ...
                        <div class="bulk-actions">
                            <g:if test="${statusCode==org.pih.warehouse.shipping.ShipmentStatusCode.SHIPPED}">
                                <div class="button-group">
                                    <button type="submit" class="button icon approve" data-action="bulkReceiveShipments">
                                        <g:message code="bulk.receive.label" default="Bulk Receive"/>
                                    </button>
                                    <button type="submit" class="button icon tag" data-action="bulkMarkAsReceived">
                                        <g:message code="bulk.markAsReceived.label" default="Bulk Mark as Received"/>
                                    </button>
                                </div>
                                <div class="button-group">
                                    <button type="submit" class="button icon loop" data-action="bulkRollbackShipments">
                                        <g:message code="bulk.receive.label" default="Bulk Rollback"/>
                                    </button>
                                </div>
                            </g:if>
                            ...
                            <div class="button-group">
                                <button type="submit" class="button icon remove" data-action="bulkDeleteShipments">
                                    <g:message code="bulk.delete.label" default="Delete"/>
                                </button>
                            </div>
                        </div>
                    </td>
