		...
		<div class="actions">
			<g:if test="${shipmentInstance?.origin?.id == session.warehouse.id}">
				<div class="action-menu-item">
					<g:link controller="shipment" action="list">
						...
						<g:message code="shipping.listOutgoing.label"/>
					</g:link>
				</div>
			</g:if>
			<g:if test="${shipmentInstance?.destination?.id == session.warehouse.id}">
				<div class="action-menu-item">
					<g:link controller="shipment" action="list" params="[type: 'incoming']">
						<img src="${resource(dir:'images/icons/silk',file:'lorry.png')}" style="vertical-align: middle" />&nbsp;
						<g:message code="shipping.listIncoming.label"/>
					</g:link>
				</div>
			</g:if>
			<div class="action-menu-item">
			...
			<div class="action-menu-item">
				<g:link controller="shipment" action="showDetails" id="${shipmentInstance.id}">
					...
					<g:if test="${request.request.requestURL.toString().contains('showDetails')}"><g:message code="shipping.showDetails.label"/></g:if>
					<g:else><g:message code="shipping.showDetails.label"/></g:else>
				</g:link>
			</div>
			...
			<g:if test="${(session?.warehouse?.id == shipmentInstance?.origin?.id) || (!shipmentInstance?.origin?.isWarehouse() && session?.warehouse?.id == shipmentInstance?.destination?.id)}">
				<div class="action-menu-item">
					<g:link controller="createShipmentWorkflow" action="createShipment" id="${shipmentInstance.id}">
						...
						<g:if test="${request.request.requestURL.toString().contains('createShipment')}"><g:message code="shipping.editShipment.label"/></g:if>
						<g:else><g:message code="shipping.editShipment.label"/></g:else>
					</g:link>
				</div>
				<div class="action-menu-item">
					<g:link controller="createShipmentWorkflow" action="createShipment" event="enterContainerDetails"  id="${shipmentInstance?.id }" params="[skipTo:'Packing']">
						...
						<g:message code="shipping.editPackingList.label"/></g:link>
				</div>
			</g:if>
			<div class="action-menu-item">
				<a href="${createLink(controller: "shipment", action: "addDocument", id: shipmentInstance.id)}">
					<img src="${resource(dir:'images/icons/silk',file:'page_add.png')}" alt="Upload a Document" style="vertical-align: middle"/>&nbsp;<g:message code="shipping.uploadADocument.label"/></a>
			</div>
			<div class="action-menu-item">
				<a href="${createLink(controller: "shipment", action: "addComment", id: shipmentInstance.id)}">
					<img src="${resource(dir:'images/icons/silk',file:'note_add.png')}" alt="Add Note" style="vertical-align: middle"/>&nbsp;<g:message code="shipping.addNote.label"/></a>
			</div>
			<div class="action-menu-item">
				<hr/>
			</div>
			...
			<div class="action-menu-item">
				<g:link controller="shipment" action="showPackingList" id="${shipmentInstance.id}">
					...
					<g:if test="${request.request.requestURL.toString().contains('showPackingList')}"><g:message code="shipping.viewPackingList.label"/></g:if>
					<g:else><g:message code="shipping.viewPackingList.label"/></g:else>
				</g:link>
			</div>
			<div class="action-menu-item">
				<g:link controller="doc4j" action="downloadPackingList" id="${shipmentInstance?.id }">
					...
					<g:message code="shipping.downloadPackingList.label"/> <span class="fade">(.xls)</span></g:link>
			</div>
			<div class="action-menu-item">
				<hr/>
			</div>
					...
					<g:if test="${!shipmentInstance?.hasShipped()}">
						<g:link controller="shipment" action="sendShipment" id="${shipmentInstance.id}">
							<img src="${resource(dir:'images/icons',file:'truck.png')}" alt="Send Shipment" style="vertical-align: middle" />&nbsp;
								<g:if test="${request.request.requestURL.toString().contains('sendShipment')}"><g:message code="shipping.sendShipment.label"/></g:if>
								<g:else><g:message code="shipping.sendShipment.label"/></g:else>
						</g:link>
					</g:if>
					<g:else>
						<img src="${resource(dir:'images/icons',file:'truck.png')}" alt="Send Shipment" style="vertical-align: middle" />&nbsp;
						<span class="fade"><g:message code="shipping.sendShipment.label"/></span>
					</g:else>
				</div>
			</g:if>
				...
				<div class="action-menu-item">
					<g:if test="${shipmentInstance.hasShipped() && !shipmentInstance.wasReceived()}">
						<g:link controller="shipment" action="receiveShipment" params="${ [shipmentId : shipmentInstance.id] }">
							...
							<g:if test="${request.request.requestURL.toString().contains('receiveShipment')}"><g:message code="shipping.receiveShipment.label"/></g:if>
							<g:else><g:message code="shipping.receiveShipment.label"/></g:else>
						</g:link>
					</g:if>
					<g:else>
						...
						<a href="javascript:void(0);" onclick="alert('${message}')">
							<img src="${resource(dir:'images/icons',file:'handtruck.png')}" alt="Receive Shipment" style="vertical-align: middle" />&nbsp;
							<span class="fade"><g:message code="shipping.receiveShipment.label"/></span>
						</a>
					</g:else>
				</div>
			</g:if>
			<g:if test="${session?.warehouse?.id == shipmentInstance?.origin?.id ||
				...
				<div class="action-menu-item">
					...
					alt="Delete Shipment" style="vertical-align: middle" />&nbsp;
						<g:if test="${request.request.requestURL.toString().contains('deleteShipment')}"><g:message code="shipping.deleteShipment.label"/></g:if>
						<g:else><g:message code="shipping.deleteShipment.label"/></g:else>
					</g:link>
				</div>
			</g:if>
		</div>
