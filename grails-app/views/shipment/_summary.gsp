					...
					<div>
						...
						<g:if test="${!shipmentInstance?.wasReceived() }">
							<g:if test="${shipmentInstance?.expectedDeliveryDate }">
								<span class="expectedDeliveryDate">
									<g:message code="shipping.expectedDeliveryDate.label"/>:
									<label>
						...
						<g:else>
							<span class="actualDeliveryDate">
								<g:message code="shipping.actualDeliveryDate.label"/>:
						...
						<g:if test="${shipmentInstance?.totalValue}">
							<span>
								<g:message code="shipping.totalValue.label"/>:
								<label>
						...
						<g:if test="${shipmentInstance?.totalWeightInPounds()}">
							<span>
								<g:message code="shipping.totalWeight.label"/>:
								<label>
									<g:formatNumber format="#,##0.00" number="${shipmentInstance?.totalWeightInPounds() ?: 0.00 }" /> <g:message code="default.lbs.label"/>
								</label>
							</span>
						</g:if>
