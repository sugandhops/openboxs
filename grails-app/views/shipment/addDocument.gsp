...
<head>
	...
	<title><g:message code="shipping.addDocument.label" /></title>
</head>
<body>
	...
	<div class="body">
		...
		<div class="box">
			<h2><g:message code="shipping.addDocument.label" /></h2>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="buttons left">
                                    ...
                                    <button type="submit" class="button">${documentInstance?.id ? g.message(code:'default.button.save.label') : g.message(code:'default.button.upload.label')}</button>
