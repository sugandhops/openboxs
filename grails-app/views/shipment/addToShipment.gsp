...
<head>
	...
	<g:set var="entityName" value="${g.message(code: 'shipmentItem.label', default: 'Shipment item')}" />
	<title><g:message code="default.add.label" args="[entityName]" /></title>
	<!-- Specify content to overload like global navigation links, page titles, etc. -->
	<content tag="pageTitle"><g:message code="shipping.addToShipments.label"/></content>
</head>
		...
		<div class="dialog" >
			<g:form action="addToShipmentPost">
					<table class="box">
						...
						<tr class="prop">
							<td class="name">
								<label>${g.message(code:'container.label') }</label>
							</td>
							<td class="value">
								<g:selectContainer name="shipmentContainerKey"
									noSelection="${['null':g.message(code:'shipping.selectContainer.label')]}"
									from="${shipments}"
						...
						<tr class="prop">
							<td class="name">
								<label>${g.message(code:'default.items.label') }</label>
							</td>
							<td class="value">
								...
								<table>
									<thead>
										<tr class="prop odd">
											<th nowrap="nowrap"><g:message code="product.label"/></th>
											<th nowrap="nowrap"><g:message code="product.lotNumber.label"/></th>
											<th nowrap="nowrap"><g:message code="default.expires.label"/></th>
											<th class="center"><g:message code="inventory.qtyShipping.label"/></th>
											<th class="center"><g:message code="inventory.qtyReceiving.label"/></th>
											<th class="center"><g:message code="inventory.qtyOnHand.label"/></th>
											<th class="center" style="border-left: 1px solid lightgrey;"><g:message code="inventory.qtyToShip.label"/></th>
										</tr>
									</thead>
											...
											<td colspan="7" style="border-top: 1px solid lightgrey;">
												<div class="center">
													<button type="submit" class="button icon add">
														<g:message code="shipping.addItems.label"/>
													</button>
													&nbsp;
													<g:link controller="inventory" action="browse" id="${shipmentInstance?.id}"><g:message code="default.button.cancel.label"/></g:link>
												</div>
											</td>
										</tr>
									</tfoot>
