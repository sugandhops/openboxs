...
<head>
	...
	<title><g:message code="shipping.receiveShipment.label"/></title>
    <style>
			...
			<g:form action="receiveShipment" method="POST">
                ...
                <div class="box">
                    <h2>
                        ...
                        <g:message code="receiving.label"/>
                    </h2>
                    ...
                    <table>
                        ...
                        <tr class="prop">
                            <td class="name middle">
                                <label><g:message code="shipping.shippedOn.label" /></label>
                            </td>
                            <td class="value">
                        ...
                        <tr class="prop">
                            <td valign="middle" class="name middle">
                                <label><g:message code="shipping.deliveredOn.label"/></label>
                            </td>
                            <td valign="top"
                        ...
                        <tr class="prop">
                            <td class="name middle">
                                <label><g:message code="shipping.recipient.label" /></label>
                            </td>
                            <td class="value">
                ...
                <div class="box ${hasErrors(bean: receiptInstance, field: 'receiptItem', 'errors')}">
                    <h2>
                        <g:message code="shipping.itemsToReceive.label" default="Items to be received"/>
                    </h2>
                    <g:if test="${shipmentInstance?.destination.isWarehouse()}">
                        <g:if test="${!receiptInstance.receiptItems}">
                            <div class="center empty">
                                <g:message code="shipping.noItemsToReceive.label" />
                            </div>
                        </g:if>
                        <g:else>
                                    ...
                                    <g:each var="shipmentItem" in="${shipmentInstance?.shipmentItems.sort() }" status="outerStatus">
                                        <g:each var="receiptItem" in="${shipmentItem?.receiptItems}" status="innerStatus">
                                            ...
                                            <tr class="prop ${(i % 2) == 0 ? 'odd' : 'even'} ${innerStatus==0?'border-top':'' }">
                                                ...
                                                <td class="middle center">
                                                    <a href="javascript:void(-1)" data-id="${receiptItem?.id}" data-index="${i}" class="btnCopyPutaway" title="${g.message(code:'receipt.copyBinLocation.message')}">
                                                        <img src="${resource(dir: 'images/icons/silk', file: 'page_copy.png')}" class="middle"/>
                                                    </a>
                                                </td>
                                                <td class="middle center">
                                                    <a href="javascript:void(-1)" data-id="${receiptItem?.id}" class="btnShowPutaways" title="${g.message(code:'default.button.zoom.label')}">
