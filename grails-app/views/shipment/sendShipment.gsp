...
<head>
	...
	<g:set var="entityName" value="${g.message(code: 'shipment.label', default: 'Shipment')}" />
	<title><g:message code="shipping.sendShipment.label" /></title>
	<!-- Specify content to overload like global navigation links, page titles, etc. -->
	<content tag="pageTitle">
		<g:message code="shipping.sendShipment.label" />
	</content>
</head>
						...
						<tbody>
							...
							<tr class="prop">
								<td valign="top" class="name">
									<label>
										<g:message code="shipping.shippingDate.label" />
									</label>
								</td>
								<td valign="top"
							...
							<tr class="prop">
	                            <td valign="top" class="name">
	                            	<label>
	                            		<g:message code="shipping.note.label"/>
	                            	</label>
	                            </td>
							...
							<tr class="prop">
								...
								<td valign="top" class="name"><label><g:message code="shipping.overview.label"/></label></td>
								<td valign="top" class="value">
									<p>
										<g:message code="shipping.sendShipment.message"
									...
									<ul class="prop">
										<li>
											...
											&nbsp;
											<g:message code="shipping.shipmentWillBeMarkedAsShipped.message"
										...
										<g:if test="${shipmentInstance?.origin.isWarehouse()}">
											<li>
												...
												&nbsp;
												<g:message code="shipping.itemsInShipmentWillBeDebited.message" args="[shipmentInstance?.shipmentItems?.size(),shipmentInstance?.origin?.name]"/>
											</li>
										</g:if>
										<li>
											<img src="${resource(dir:'images/icons/silk',file: 'email.png')}" style="vertical-align: middle"/>
											&nbsp;
											<g:message code="shipping.notificationEmailsWillBeSentOut.message"/>
										</li>
									</ul>
								</td>
							</tr>
							...
							<g:if test="${shipmentInstance?.origin.isWarehouse()}">
								<tr class="prop">
									<td valign="top" class="name">
										<label>
											<g:message code="default.items.label"/>
										</label>
									</td>
									<td valign="top" class="value">
										<g:message code="shipping.willBeDebited.message" args="[shipmentInstance?.origin?.name]"/>
										<g:if test="${shipmentInstance.shipmentItems.sort()}">
											<table style="display: inline" id="debitShipmentItems">
												<tr>
													<th></th>
													<th></th>
													<th><g:message code="default.item.label"/></th>
										...
										<g:else>
											<g:message code="shipping.noItemsToShip.message"/>
										</g:else>
									</td>
								</tr>
							</g:if>
							...
							<tr class="prop">
								<td valign="top" class="name"><label><g:message code="shipping.notifications.label"/></label></td>
								<td valign="top" class="value">
									<g:message code="shipping.notifications.message"/>
									<table style="display: inline" id="notifyRecipients">
										...
										<g:if test="${!shipmentWorkflow?.isExcluded('carrier') && shipmentInstance?.carrier}">
											<tr class="prop odd">
												...
												<td>
													<g:message code="shipping.traveler.label"/>
												</td>
												<td>
										...
										<g:if test="${!shipmentWorkflow?.isExcluded('recipient') && shipmentInstance?.recipient}">
											<tr class="prop even">
												...
												<td>
													<g:message code="shipping.recipient.label"/>
												</td>
												<td>
							...
							<tr class="prop">
								...
								<td valign="top" class="value">
									...
									<button type="submit" class="positive"><img
										...
										alt="save" /> <g:message code="shipping.sendShipment.label"/></button>
									&nbsp;
