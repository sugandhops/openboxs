...
<head>
	...
	<g:set var="entityName" value="${g.message(code: 'shipping.shipment.label', default: 'Shipment').toLowerCase()}" />
			...
			<div class="yui-gf">
                ...
                <div class="yui-u first">
					...
					<div id="details" class="box">
						<h2>
							...
							<label><g:message code="shipping.details.label"/></label>
						</h2>
						<table>
							<tbody>
							<tr class="prop">
							...
							<tr class="prop">
								<td valign="top" class="name">
									<g:if test="${shipmentInstance?.status.code in [org.pih.warehouse.shipping.ShipmentStatusCode.SHIPPED, org.pih.warehouse.shipping.ShipmentStatusCode.RECEIVED]}">
										<label><g:message code="shipping.departed.label" /></label>
									</g:if>
									<g:else>
										<label><g:message code="shipping.departing.label"/></label>
									</g:else>
								</td>
							...
							<tr class="prop">
								<td valign="top" class="name">
									...
									<g:else>
										<label><g:message code="shipping.arriving.label" /></label>
									</g:else>
								</td>
								<td valign="top" class="value">
							...
							<g:if test="${!shipmentWorkflow?.isExcluded('totalValue')||!shipmentWorkflow?.isExcluded('statedValue')}">
								<g:if test="${!shipmentWorkflow?.isExcluded('totalValue')}">
									<tr class="prop">
										<td valign="top" class="name">
											<label><g:message code="shipping.totalValue.label" /></label><br/>
										</td>
										<td valign="top" class="value">
							...
							<g:if test="${!shipmentWorkflow?.isExcluded('carrier') && shipmentInstance?.carrier}">
								<tr class="prop">
									<td valign="top" class="name">
										...
										<label><g:message code="shipping.traveler.label" /></label></td>
									<td valign="top" class="value">
							...
							<g:if test="${!shipmentWorkflow?.isExcluded('additionalInformation') && shipmentInstance?.additionalInformation}">
								<tr class="prop">
									<td valign="top" class="name">
										<label><g:message code="shipping.additionalInformation.label" default="Additional information" /></label><br/>
									</td>
									<td valign="top" class="value">
							...
							<g:if test="${shipmentWorkflow?.documentTemplate}">
								<tr class="prop">
									<td valign="top" class="name">
										<label><g:message code="shipping.templates.label" /></label><br/>
									</td>
									<td valign="top" class="value">
										<a href='${createLink(controller: "shipment", action: "generateDocuments", id: shipmentInstance.id)}">
											<g:message code="shipping.generateDocuments.label" args="[format.metadata(obj:shipmentWorkflow.shipmentType)]'/></a>
									</td>
								</tr>
							</g:if>
				...
				<div class="yui-u">
                    <div id="shipment-details-tabs" class="tabs">
                        <ul>
                            <li><a href="#details-tab"><g:message code="shipping.contents.label"/></a></li>
                            <li><a href="#receipt-tab"><g:message code="receipt.label" default="Receipt"/></a></li>
                            <li><a href="#documents-tab"><g:message code="documents.label" default="Documents"/></a></li>
                            <li><a href="#comments-tab"><g:message code="comments.label" default="Comments"/></a></li>
                            <li><a href="#events-tab"><g:message code="events.label" default="Comments"/></a></li>
                            <li>
                                <a href="${request.contextPath}/shipment/showTransactions/${shipmentInstance?.id}">
                                    <g:message code="transactions.label" default="Transactions"/>
                                </a>
                            </li>
                            <li>
                                <a href="${request.contextPath}/shipment/showTracking/${shipmentInstance?.id}">
                                    <g:message code="shipping.tracking.label" default="Tracking"/>
                                </a>
                            </li>
                        </ul>
                        <div id="details-tab">
                            ...
                            <div id="items" class="box">
                                <h2>
                                    ...
                                    <label><g:message code="shipping.contents.label"/></label>
                                </h2>
                                <table>
                                    <tr>
                                        <th><g:message code="shipping.container.label"/></th>
                                        <th><g:message code="product.productCode.label"/></th>
                                        <th><g:message code="product.label"/></th>
                                        <th class="left">
                                            <g:message code="receiptItem.binLocation.label" default="Bin Location"/>
                                            <g:if test="${shipmentInstance?.origin?.id == session.warehouse?.id}">
                                                <small><g:message code="location.picking.label"/></small>
                                            </g:if>
                                            <g:elseif test="${shipmentInstance?.destination?.id == session.warehouse?.id}">
                                                <small><g:message code="location.putaway.label"/></small>
                                            </g:elseif>
                                        </th>
                                        <th class="left"><g:message code="default.lotSerialNo.label"/></th>
                                        <th class="center"><g:message code="default.expires.label"/></th>
                                        <th class="center"><g:message code="shipping.shipped.label"/></th>
                                        <g:if test="${shipmentInstance?.wasReceived()}">
                                            <th class="center"><g:message code="shipmentItem.quantityReceived.label" default="Received"/></th>
                                            <th class="center"><g:message code="shipmentItem.quantityCanceled.label" default="Canceled"/></th>
                                        </g:if>
                                        <th><g:message code="product.uom.label"/></th>
                                        <th><g:message code="shipping.recipient.label"/></th>
                                        <th class="left"><g:message code="default.comment.label"/></th>
                                        <th><g:message code="shipmentItem.isFullyReceived.label" default="Received?"/></th>
                                    </tr>
                                    <g:if test="${shipmentInstance.shipmentItems}">
                                        ...
                                        <g:each var="shipmentItem" in="${shipmentInstance.sortShipmentItems()}" status="i">
                                            ...
                                            <tr class="${(count++ % 2 == 0)?'odd':'even'} ${newContainer?'new-container':''} shipmentItem">
                                                ...
                                                <td>
                                                    ${shipmentItem?.inventoryItem?.product?.unitOfMeasure?:g.message(code:'default.each.label')}
                                                </td>
                                    ...
                                    <g:else>
                                        <tr>
                                            <td colspan="9" class="middle center fade empty">
                                                <g:message code="shipment.noShipmentItems.message"/>
                                            </td>
                                        </tr>
                                    </g:else>
                        ...
                        <div id="receipt-tab">
                            <div id="receipt" class="box">
                                <h2>
                                    ...
                                    <label><g:message code="shipping.receipt.label"/></label>
                                </h2>
                                <table>
                                    <tr>
                                        <th><g:message code="product.productCode.label"/></th>
                        ...
                        <div id="documents-tab">
                            <div id="documents" class="box">
                                <h2>
                                    ...
                                    <label><g:message code="document.documents.label"/></label>
                                </h2>
                                            ...
                                            <td class="right">
                                                ...
                                                <g:else>
                                                    ...
                                                    <g:link class="button" action="deleteDocument" id="${document?.id}"
                                                            params="[shipmentId:shipmentInstance.id]" onclick="return confirm('${g.message(code:'shipping.confirm.deleteDocument.message')}')">
                                    ...
                                    <table>
                                        <tr class="prop">
                                            <td width="1%" class="name">
                                                <label><g:message code="document.documentType.label" default="Document type"/></label>
                                            </td>
                                            <td class="value">
                                        ...
                                        <tr class="prop">
                                            <td class="name">
                                                <label><g:message code="document.label" default="Document"/></label>
                                            </td>
                                            <td class="value">
                                                <input name="fileContents" type="file" />
                                                <button type="submit" class="button icon arrowup right">${documentInstance?.id ? g.message(code:'default.button.save.label') : g.message(code:'default.button.upload.label')}</button>
                                            </td>
                        ...
                        <div id="comments-tab">
                            <div id="comments" class="box">
                                <h2>
                                    ...
                                    <label>${g.message(code: 'comments.label') }</label>
                                </h2>
                                    ...
                                    <tr class="">
                                        <td colspan="3" class="left">
                                            <g:form action="saveComment">
                                                <g:hiddenField name="shipmentId" value="${shipmentInstance?.id}" />
                                                <div>
                                                    <label><g:message code="comment.label" default="Comments"/></label>
                                                </div>
                                                <div style="padding:1px;">
                                                    <g:textArea name="comment" rows="5" style="width:100%" placeholder="${g.message(code:'default.comment.message')}" class="text"/>
                                                </div>

                                                <div class="buttons">
                                                    <button type="submit" class="button icon add"><g:message code="default.button.add.label"/></button>
                                                </div>
                                            </g:form>
                                        </td>
                                    </tr>
                        ...
                        <div id="events-tab">
                            <div id="events" class="box">
                                <h2>
                                    ...
                                    <label><g:message code="shipping.tracking.label"/></label>
                                </h2>
                                <g:set var="i" value="${0 }"/>
                                <table>
                                    <thead>
                                    <tr>
                                        <th><g:message code="default.event.label"/></th>
                                    ...
                                    <tr class="${(i++ % 2) == 0 ? 'odd' : 'even'}">
                                        <td>
                                            <g:message code="default.created.label"/>
                                        </td>
                                        <td>
                            ...
                            <div class="box">
                                <h2>
                                    ...
                                    <label><g:message code="shipping.addEvent.label" default="Add Event"/></label>
                                </h2>
                                <g:form controller="shipment" action="saveEvent" method="POST">
                                    ...
                                    <table>
                                        ...
                                        <tr class="prop">
                                            <td valign="top" class="name"><label><g:message code="shipping.eventType.label"/></label></td>
                                            <td valign="top" class="value ${hasErrors(bean: eventInstance, field: 'eventType', 'errors')}">
                                                <g:if test="${!eventInstance?.eventType}">
                                                    <g:select id="eventType.id" name='eventType.id' noSelection="['':g.message(code:'default.selectOne.label')]"
                                        ...
                                        <tr class="prop">
                                            <td valign="top" class="name"><label><g:message code="location.label" /></label></td>
                                            <td valign="top" class="value ${hasErrors(bean: eventInstance, field: 'location', 'errors')}">
                                                <g:select id="eventLocation.id" name='eventLocation.id' noSelection="['':g.message(code:'default.selectOne.label')]"
                                        ...
                                        <tr class="prop">
                                            <td valign="top" class="name"><label><g:message code="shipping.eventDate.label" /></label></td>
