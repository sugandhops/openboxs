...
<head>
	...
	<content tag="pageTitle"><g:message code="shipping.packingList.label"/></content>
								...
								<table>		
									<tr>
										...
										<g:if test="${shipmentInstance?.wasReceived()}">
											<th class="center"><g:message code="shipping.received.label"/></th>
											<th class="center"><g:message code="shipping.totalReceived.label"/></th>
										</g:if>
											...
											<g:if test="${newContainer }">
												<td class="container top left" rowspan="${rowspan }">
													<label>
														...
														<g:else><g:message code="shipping.unpacked.label"/></g:else>
													</label>
													<br/>
													<span class="fade">
