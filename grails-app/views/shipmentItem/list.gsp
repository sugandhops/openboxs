            ...
            <div class="list">
				...
				<div>            	
	            	<span class="linkButton">
	            		<g:link class="new" action="create"><g:message code="default.add.label" args="['shipmentItem']"/></g:link>
	            	</span>
            	</div>
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="id" title="${g.message(code: 'shipmentItem.id.label', default: 'Id')}" />
                        
                            <th><g:message code="shipmentItem.container.label" default="Container" /></th>
                   	    
                            <th><g:message code="shipmentItem.product.label" default="Product" /></th>
                   	    
                            <g:sortableColumn property="lotNumber" title="${g.message(code: 'shipmentItem.lotNumber.label', default: 'Lot Number')}" />
                        
                            <g:sortableColumn property="expirationDate" title="${g.message(code: 'shipmentItem.expirationDate.label', default: 'Expiration Date')}" />
                        
                            <g:sortableColumn property="quantity" title="${g.message(code: 'shipmentItem.quantity.label', default: 'Quantity')}" />
