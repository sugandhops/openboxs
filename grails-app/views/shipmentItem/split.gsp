            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="quantity"><g:message code="shipmentItem.product.label" /></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="binLocation"><g:message code="shipmentItem.binLocation.label" /></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="lotNumber"><g:message code="inventoryItem.lotNumber.label" /></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="expirationDate"><g:message code="inventoryItem.expirationDate.label" /></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="quantity"><g:message code="shipmentItem.originalQuantity.label" default="Original Quantity"/></label>
                    </td>
                ...
                <td style="margin:0;padding:0">
                    <div class="dialog box">
                        ...
                        <table>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="quantity"><g:message code="shipmentItem.splitQuantity.label" default="Split Quantity" /></label>
                                </td>
                                <td valign="top" class="${hasErrors(bean: shipmentItemInstance, field: 'quantity', 'errors')}">
