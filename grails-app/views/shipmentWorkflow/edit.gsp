	                ...
	                <div class="box">
	                    ...
	                    <table>
	                        <tbody>
	                            ...
	                            <tr class="prop">
	                                <td valign="top" class="name">
	                                  <label for="referenceNumberTypes"><g:message code="shipmentWorkflow.referenceNumberTypes.label" default="Reference Number Types" /></label>
	                                </td>
	                            ...
	                            <tr class="prop">
	                                <td valign="top" class="name">
	                                  <label for="containerTypes"><g:message code="shipmentWorkflow.containerTypes.label" default="Container Types" /></label>
	                                </td>
	                            ...
	                            <tr class="prop">
	                                <td valign="top" class="name">
	                                  <label for="documentTemplates"><g:message code="shipmentWorkflow.documentTemplates.label" default="Document Templates" /></label>
	                                </td>
