        ...
        <div id="page-header" class="small">
            <table class="no-border-table no-padding w100">
                <tr class="w100">
                    ...
                    <td align="right" class="no-padding">${g.message(code: 'report.lastUpdated.label')}: <g:formatDate date="${stocklist?.requisition?.lastUpdated}" format="MMM d, yyyy"/></td>
                </tr>
                <tr>
                    <td colspan="2" class="w100 no-padding" align="left">${stocklist?.requisition?.replenishmentPeriod?:"0"} ${g.message(code: 'report.dayReplenishment.label')}</td>
                </tr>
            </table>
        </div>
    </div>
            ...
            <tr>
                    ...
                    <table class="no-border-table">
                        <tr>
                            ...
                            <td style="white-space: nowrap;">
                                <h3>${g.message(code: 'report.stockRequisition.label')}: ${stocklist?.requisition?.name} </h3>
                ...
                <td rowspan="2" align="center" class="b-0">
                    <table class="w100 no-wrap gray-background">
                        <tr>
                            <td colspan="2" align="center" class="b-b0">${g.message(code: 'report.forWarehouseUse.label')}:</td>
                        </tr>
                        <tr>
                            <td align="left" class="b-r0 b-b0">${g.message(code: 'deliveryNote.approvedBy.label')}:</td>
                            <td class="w100 b-b0"></td>
                        </tr>
                        <tr>
                            <td align="left" class="b-r0 b-b0">${g.message(code: 'default.signature.label')}:</td>
                            <td class="w100 b-b0"></td>
                        </tr>
                        <tr>
                            <td align="left" class="b-r0 b-b0">${g.message(code: 'default.date.label')}:</td>
                            <td class="w100 b-b0"></td>
                        </tr>
                        <tr>
                            <td align="left" class="b-r0 b-b0">${g.message(code: 'requisition.processedBy.label')}:</td>
                            <td class="w100 b-b0"></td>
                        </tr>
                        <tr>
                            <td align="left" class="b-r0 b-b0">${g.message(code: 'default.signature.label')}:</td>
                        ...
                        <tr>
                            <td align="left" class="b-r0">${g.message(code: 'requisition.requisitionNumber.label')}:</td>
                            <td class="w100"></td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td class="b-0">
                    <table class="w100 no-wrap">
                        <tr>
                            <td class="b-r0 b-b0">${g.message(code: 'default.date.label')}:</td>
                            <td class="w100 b-b0"></td>
                        </tr>
                        <tr>
                            <td class="b-r0 b-b0">${g.message(code: 'requisition.requestedBy.label')}:</td>
                            <td class="w100 b-b0"></td>
                        </tr>
                        <tr>
                            <td class="b-r0">${g.message(code: 'default.signature.label')}:</td>
                            <td class="w100"></td>
                        </tr>
                    </table>
                </td>
                ...
                <td class="b-0">
                    <table class="w100 no-wrap">
                        ...
                        <tr>
                            <td class="b-r0 b-b0">${g.message(code: 'deliveryNote.approvedBy.label')}:</td>
                            <td class="w100 b-b0"></td>
                        </tr>
                        <tr>
                            <td class="b-r0">${g.message(code: 'default.signature.label')}:</td>
