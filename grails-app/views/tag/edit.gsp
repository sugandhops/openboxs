                        ...
                        <g:form method="post">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr class="prop">
                                        <td valign="top" class="name">
                                            <label><g:message code="product.properties.label" default="Properties"/></label>
                                        </td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td></td>
                                        <td >
                                            <g:actionSubmit class="button icon accept" action="update" value="${g.message(code: 'default.button.update.label', default: 'Update')}" />
                                            <g:actionSubmit class="button icon trash" action="delete" value="${g.message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${g.message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
                                            <g:link class="button" controller="tag" action="list">${g.message(code: 'default.button.cancel.label', default: 'Cancel')}</g:link>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td width="1%">
                                            <button class="button">
                                                ...
                                                ${g.message(code:'tag.addToProducts.label', default: 'Add to products')}
                                            </button>
                                        </td>
                                    </tr>
                                </tbody>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td>
                                                <button class="button">
                                                    <img src="${resource(dir: 'images/icons/silk', file: 'delete.png')}" />&nbsp;
                                                    ${g.message(code:'tag.removeSelectedProducts.label', default: 'Remove selected products')}
                                                </button>
                                            </td>
                                        </tr>
                                    </tfoot>
