                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <g:sortableColumn property="id" title="${g.message(code: 'tag.id.label', default: 'Id')}" />

                                <g:sortableColumn property="tag" title="${g.message(code: 'tag.tag.label', default: 'Tag')}" />

                                <th><g:message code="tag.products.label" default="Products"/></th>

                                <th><g:message code="tag.isActive.label" default="Is active?"/></th>

                                <th><g:message code="tag.updatedBy.label" default="Updated By" /></th>

                                <th><g:message code="tag.createdBy.label" default="Created By" /></th>

                                <g:sortableColumn property="dateCreated" title="${g.message(code: 'tag.dateCreated.label', default: 'Date Created')}" />

                                <g:sortableColumn property="lastUpdated" title="${g.message(code: 'tag.lastUpdated.label', default: 'Last Updated')}" />
