            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tag.tag.label" default="Tag" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tag.updatedBy.label" default="Updated By" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tag.createdBy.label" default="Created By" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tag.products.label" default="Products" /></td>
