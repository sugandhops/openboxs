...
<span class="action-menu">
	...
	<div class="actions left">
		<g:if test="${params?.product?.id }">
			<div class="action-menu-item">
				<g:link controller="inventoryItem" action="showStockCard" params="['product.id':params?.product?.id]">
					...
					&nbsp;${g.message(code: 'transaction.backToStockCard.label')}
				</g:link>
			</div>
		</g:if>
		<div class="action-menu-item">
			<g:link controller="inventory" action="browse">
				...
				&nbsp;${g.message(code: 'transaction.backToInventory.label')}
			</g:link>
		</div>
		<div class="action-menu-item">
			<hr/>
		...
		<div class="action-menu-item">
			<g:link controller="inventory" action="deleteTransaction" id="${transactionInstance?.id }" onclick="return confirm('${g.message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');">
