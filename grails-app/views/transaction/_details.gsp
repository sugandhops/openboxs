<div class="box">
	...
	<table>
        ...
        <g:if test="${transactionInstance?.localTransfer }">
			<tr class="prop">
				<td class="name">
					<label><g:message code="localTransfer.destinationTransaction.label" default="Destination"/></label>
                </td>
                <td class="value">
			...
			<tr class="prop">
				<td class="name">
					<label><g:message code="localTransfer.sourceTransaction.label" default="Source"/></label>
                </td>
                <td class="value">
