    ...
    <div class="box">
        ...
        <table id="prodEntryTable">
            ...
            <tr class="odd">
                ...
                <th style="text-align: center"><g:message code="location.binLocation.label"/></th>
                <th style="text-align: center"><g:message code="product.lotNumber.label"/></th>
                <th style="text-align: center"><g:message code="product.expirationDate.label"/></th>
                <th style="text-align: center"><g:message code="default.qty.label"/></th>
            </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td colspan="4">
                        <div class="empty center">
                            <g:message code="transaction.noEntries.message"/>
                        </div>
                    </td>
                </tr>
            </g:else>
