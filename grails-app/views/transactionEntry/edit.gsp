<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'transactionEntry.label', default: 'Transaction entry')}" />
        <title><g:message code="${transactionEntry?.id ? 'default.edit.label' : 'default.create.label'}" args="[entityName]" /></title>
    </head>
    <body>
        <div class="body">
					...
					<div class="yui-u">
						<g:form method="post" >
			            	<div class="box">
                                ...
                                <h2>
                                    <g:message code="transactionEntry.label"/> &rsaquo;
				                        ...
				                        <tbody>
				                            <tr class="prop">
				                                <td valign="top" class="name">
				                                  <label for="transaction.id"><g:message code="transactionEntry.transaction.label" default="Transaction" /></label>
				                                </td>
                                            ...
                                            <tr class="prop">
                                                <td valign="top" class="name">
                                                    <label for="product"><g:message code="product.label" default="Product" /></label>
                                                </td>
											...
											<tr class="prop">
												<td valign="top" class="name">
													<label for="product"><g:message code="location.binLocation.label" default="Bin Location" /></label>
												</td>
												<td valign="top" class="value">
				                            ...
				                            <tr class="prop">
				                                <td valign="top" class="name">
				                                  <label for="inventoryItem.id"><g:message code="transactionEntry.inventoryItem.label" default="Inventory Item" /></label>
				                                </td>
											...
											<tr class="prop">
												<td valign="top" class="name">
													<label for="unitOfMeasure"><g:message code="product.unitOfMeasure.label" default="Unit of measure" /></label>
												</td>
												<td valign="top" class="value">
