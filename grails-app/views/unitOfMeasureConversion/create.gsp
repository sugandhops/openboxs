...
<html>
    <head>
        ...
        <g:set var="entityName" value="${g.message(code: 'unitOfMeasureConversion.label', default: 'Unit of Measure Conversion')}" />
        ...
        <div class="body box">
			...
			<div class="button-bar">
				<g:link class="button" action="list">
					...
					<g:message code="default.list.label" args="['Unit of Measure Conversion']"/>
				</g:link>
				<g:link class="button" action="create">
                	<img src="${resource(dir: 'images/icons/silk', file: 'add.png')}" />&nbsp;
					<g:message code="default.add.label" args="['Unit of Measure Conversion']"/>
				</g:link>
			</div>
						...
						<tbody>
							...
							<tr class="prop">
								<td valign="middle" class="name">
									<label for="fromUnitOfMeasure.id"><g:message code="unitOfMeasureConversion.fromUnitOfMeasure.label" default="From Unit Of Measure" /></label>
								</td>
							...
							<tr class="prop">
								<td valign="middle" class="name">
									<label for="toUnitOfMeasure.id"><g:message code="unitOfMeasureConversion.toUnitOfMeasure.label" default="To Unit Of Measure" /></label>
								</td>
								<td valign="middle" class="value">
							...
							<tr class="prop">
								<td valign="middle" class="name">
									<label for="conversionRate"><g:message code="unitOfMeasureConversion.conversionRate.label" default="Conversion Rate" /></label>
								</td>
