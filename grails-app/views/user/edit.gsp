...
<div class="errors">
    ...
    <div class="dialog">
        ...
        <div id="user-tabs" class="tabs">
            <ul>
                <li><a href="#details-tab"><g:message code="user.details.label" default="User Details"/>
                </a></li>
                <li><a href="#password-tab"><g:message code="user.changePassword.label" default="Change Password"/></a></li>
                <li><a href="#authorization-tab"><g:message code="user.authorization.label" default="Authorization"/></a></li>
            </ul>
            <div id="details-tab">
                <div class="box">
                <h2><g:message code="user.details.label" default="Details"/>Details</h2>
                ...
                <tbody>
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="active">
                                <g:message code="user.active.label"/>
                            </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="buttons left">
                                <g:actionSubmit class="button icon approve" action="update" value="Save" />
                                &nbsp;
                                <g:link class="cancel" action="show" id="${userInstance?.id }">${g.message(code: 'default.button.cancel.label', default: 'Cancel')}</g:link>
                            </div>
                        </td>
                    </tr>
                    </tfoot>
                ...
                <div class="box">
                <h2><g:message code="user.authorization.label" default="Authorization"/></h2>
                ...
                <g:hiddenField name="updateRoles" value="${true}" />
                    ...
                    <tbody>
                        <tr class="prop">
                            <td valign="top" class="name">
                                <label for="email"><g:message code="user.defaultLocation.label" />
                                </label>
                            </td>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'roles', 'errors')}">
                            <g:set var="noAccessLabel" value="${g.message(code: 'no.access.label')}" />
                            <g:select name="roles" from="${roles}" optionKey="id" value="${userInstance?.roles}" noSelection="${['null': noAccessLabel]}" multiple="true" class="chzn-select-deselect"/>
                    ...
                    <tr class="prop" id="locationRoles">
                        ...
                        <td valign="top" class="value" style="padding: 0px">
                            ...
                            <tr class="odd">
                                ...
                                <th><g:message code="location.locationGroup.label"/></th>
